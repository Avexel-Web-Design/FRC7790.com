...
// ../.wrangler/tmp/bundle-gDEgED/checked-fetch.js
...
var rateLimitMiddleware = createMiddleware(async (c, next) => {
  ...
  const maxRequests = isNotificationEndpoint ? 200 : 150;
  ...
  c.header("X-RateLimit-Reset", Math.ceil((clientData?.resetTime || now + windowMs) / 1e3).toString());
  await next();
});
...
// ../.wrangler/tmp/pages-akVEr7/functionsRoutes-0.010847034938497924.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-gDEgED/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-gDEgED/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5223070885474344.mjs.map
