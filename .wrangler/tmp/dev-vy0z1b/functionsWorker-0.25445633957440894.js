...
// .wrangler/tmp/bundle-AShg1p/checked-fetch.js
...
// .wrangler/tmp/pages-Yg1dbO/functionsWorker-0.25445633957440894.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var __export = /* @__PURE__ */ __name((target, all5) => {
  for (var name in all5)
    __defProp2(target, name, { get: all5[name], enumerable: true });
}, "__export");
var urls2 = /* @__PURE__ */ new Set();
function checkURL2(request2, init) {
  const url = request2 instanceof URL ? request2 : new URL(
    (typeof request2 === "string" ? new Request(request2, init) : request2).url
  );
  if (url.port && url.port !== "443" && url.protocol === "https:") {
...
globalThis.fetch = new Proxy(globalThis.fetch, {
  apply(target, thisArg, argArray) {
    const [request2, init] = argArray;
    checkURL2(request2, init);
    return Reflect.apply(target, thisArg, argArray);
  }
});
var compose = /* @__PURE__ */ __name2((middleware, onError3, onNotFound) => {
...
var parseBody = /* @__PURE__ */ __name2(async (request2, options = /* @__PURE__ */ Object.create(null)) => {
...
var getPath = /* @__PURE__ */ __name2((request2) => {
...
var getPathNoStrict = /* @__PURE__ */ __name2((request2) => {
...
var resolveCallback = /* @__PURE__ */ __name2(async (str, phase, preserveCallbacks, context5, buffer) => {
...
var Context = class {
  ...
  newResponse = /* @__PURE__ */ __name2((...args2) => this.#newResponse(...args2), "newResponse");
  /**
...
var Hono = class _Hono {
  ...
  */
    ...
    if (options) {
      if (typeof options === "function") {
        ...
        if (options.replaceRequest === false) {
          replaceRequest = /* @__PURE__ */ __name2((request2) => request2, "replaceRequest");
        } else {
   ...
   *
   */
  fetch = /* @__PURE__ */ __name2((request2, ...rest) => {
...
var isFunction = /* @__PURE__ */ __name2((input) => typeof input === "function", "isFunction");
var dual = /* @__PURE__ */ __name2(function(arity, body) {
...
var constant = /* @__PURE__ */ __name2((value) => () => value, "constant");
...
__name(pipe, "pipe");
__name2(pipe, "pipe");
var make = /* @__PURE__ */ __name2((isEquivalent) => (self, that) => self === that || isEquivalent(self, that), "make");
var mapInput = /* @__PURE__ */ dual(2, (self, f) => make((x, y) => self(f(x), f(y))));
var array = /* @__PURE__ */ __name2((item) => make((self, that) => {
...
var let_ = /* @__PURE__ */ __name2((map16) => dual(3, (self, name, f) => map16(self, (a) => ({
  ...a,
  [name]: f(a)
}))), "let_");
var bindTo = /* @__PURE__ */ __name2((map16) => dual(2, (self, name) => map16(self, (a) => ({
  [name]: a
}))), "bindTo");
var bind = /* @__PURE__ */ __name2((map16, flatMap14) => dual(3, (self, name, f) => flatMap14(self, (a) => map16(f(a), (b) => ({
  ...a,
  [name]: b
})))), "bind");
var globalStoreId = `effect/GlobalValue`;
var globalStore;
var globalValue = /* @__PURE__ */ __name2((id, compute) => {
  if (!globalStore) {
...
var isString = /* @__PURE__ */ __name2((input) => typeof input === "string", "isString");
var isNumber = /* @__PURE__ */ __name2((input) => typeof input === "number", "isNumber");
var isBigInt = /* @__PURE__ */ __name2((input) => typeof input === "bigint", "isBigInt");
var isFunction2 = isFunction;
var isRecordOrArray = /* @__PURE__ */ __name2((input) => typeof input === "object" && input !== null, "isRecordOrArray");
var isObject = /* @__PURE__ */ __name2((input) => isRecordOrArray(input) || isFunction2(input), "isObject");
var hasProperty = /* @__PURE__ */ dual(2, (self, property) => isObject(self) && property in self);
var isTagged = /* @__PURE__ */ dual(2, (self, tag) => hasProperty(self, "_tag") && self["_tag"] === tag);
var isNullable = /* @__PURE__ */ __name2((input) => input === null || input === void 0, "isNullable");
var isIterable = /* @__PURE__ */ __name2((input) => typeof input === "string" || hasProperty(input, Symbol.iterator), "isIterable");
var isPromiseLike = /* @__PURE__ */ __name2((input) => hasProperty(input, "then") && isFunction2(input.then), "isPromiseLike");
var getBugErrorMessage = /* @__PURE__ */ __name2((message) => `BUG: ${message} - please report an issue at https://github.com/Effect-TS/effect/issues`, "getBugErrorMessage");
...
var SingleShotGen = class _SingleShotGen {
  static {
    __name(this, "_SingleShotGen");
  }
  static {
    __name2(this, "SingleShotGen");
  }
  self;
  called = false;
  constructor(self) {
...
__name2(yieldWrapGet, "yieldWrapGet");
var structuralRegionState = /* @__PURE__ */ globalValue("effect/Utils/isStructuralRegion", () => ({
  enabled: false,
  tester: void 0
}));
var standard = {
  effect_internal_function: /* @__PURE__ */ __name2((body) => {
    return body();
...
var isGeneratorFunction = /* @__PURE__ */ __name2((u) => isObject(u) && u.constructor === genConstructor, "isGeneratorFunction");
var randomHashCache = /* @__PURE__ */ globalValue(/* @__PURE__ */ Symbol.for("effect/Hash/randomHashCache"), () => /* @__PURE__ */ new WeakMap());
var symbol = /* @__PURE__ */ Symbol.for("effect/Hash");
var hash = /* @__PURE__ */ __name2((self) => {
...
var random = /* @__PURE__ */ __name2((self) => {
  if (!randomHashCache.has(self)) {
    randomHashCache.set(self, number(Math.floor(Math.random() * Number.MAX_SAFE_INTEGER)));
  }
  return randomHashCache.get(self);
}, "random");
var combine = /* @__PURE__ */ __name2((b) => (self) => self * 53 ^ b, "combine");
var optimize = /* @__PURE__ */ __name2((n) => n & 3221225471 | n >>> 1 & 1073741824, "optimize");
var isHash = /* @__PURE__ */ __name2((u) => hasProperty(u, symbol), "isHash");
var number = /* @__PURE__ */ __name2((n) => {
  if (n !== n || n === Infinity) {
    return 0;
  }
  let h = n | 0;
...
var string = /* @__PURE__ */ __name2((str) => {
...
var structureKeys = /* @__PURE__ */ __name2((o, keys5) => {
  let h = 12289;
...
var structure = /* @__PURE__ */ __name2((o) => structureKeys(o, Object.keys(o)), "structure");
var array2 = /* @__PURE__ */ __name2((arr) => {
  let h = 6151;
...
var cached = /* @__PURE__ */ __name2(function() {
...
__name2(compareBoth, "compareBoth");
var isEqual = /* @__PURE__ */ __name2((u) => hasProperty(u, symbol2), "isEqual");
var equivalence = /* @__PURE__ */ __name2(() => equals, "equivalence");
var NodeInspectSymbol = /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom");
var toJSON = /* @__PURE__ */ __name2((x) => {
  try {
...
var format = /* @__PURE__ */ __name2((x) => JSON.stringify(x, null, 2), "format");
var BaseProto = {
  toJSON() {
    return toJSON(this);
  },
...
var toStringUnknown = /* @__PURE__ */ __name2((u, whitespace = 2) => {
  if (typeof u === "string") {
    return u;
  }
  try {
...
var stringifyCircular = /* @__PURE__ */ __name2((obj, whitespace) => {
  let cache = [];
...
var isRedactable = /* @__PURE__ */ __name2((u) => typeof u === "object" && u !== null && symbolRedactable in u, "isRedactable");
var redactableState = /* @__PURE__ */ globalValue("effect/Inspectable/redactableState", () => ({
  fiberRefs: void 0
}));
var withRedactableContext = /* @__PURE__ */ __name2((context5, f) => {
...
var redact = /* @__PURE__ */ __name2((u) => {
  if (isRedactable(u) && redactableState.fiberRefs !== void 0) {
    return u[symbolRedactable](redactableState.fiberRefs);
  }
  return u;
}, "redact");
var pipeArguments = /* @__PURE__ */ __name2((self, args2) => {
  switch (args2.length) {
    case 0:
      return self;
    case 1:
...
var getCurrentVersion = /* @__PURE__ */ __name2(() => moduleVersion, "getCurrentVersion");
...
var effectVariance = {
  /* c8 ignore next */
  _R: /* @__PURE__ */ __name2((_) => _, "_R"),
  /* c8 ignore next */
  _E: /* @__PURE__ */ __name2((_) => _, "_E"),
  /* c8 ignore next */
  _A: /* @__PURE__ */ __name2((_) => _, "_A"),
...
var sinkVariance = {
  ...
  _A: /* @__PURE__ */ __name2((_) => _, "_A"),
  /* c8 ignore next */
  _In: /* @__PURE__ */ __name2((_) => _, "_In"),
  /* c8 ignore next */
  _L: /* @__PURE__ */ __name2((_) => _, "_L"),
  /* c8 ignore next */
  _E: /* @__PURE__ */ __name2((_) => _, "_E"),
  /* c8 ignore next */
  _R: /* @__PURE__ */ __name2((_) => _, "_R")
...
var channelVariance = {
  /* c8 ignore next */
  _Env: /* @__PURE__ */ __name2((_) => _, "_Env"),
  /* c8 ignore next */
  _InErr: /* @__PURE__ */ __name2((_) => _, "_InErr"),
  /* c8 ignore next */
  _InElem: /* @__PURE__ */ __name2((_) => _, "_InElem"),
  /* c8 ignore next */
  _InDone: /* @__PURE__ */ __name2((_) => _, "_InDone"),
  /* c8 ignore next */
  _OutErr: /* @__PURE__ */ __name2((_) => _, "_OutErr"),
  /* c8 ignore next */
  _OutElem: /* @__PURE__ */ __name2((_) => _, "_OutElem"),
  /* c8 ignore next */
  _OutDone: /* @__PURE__ */ __name2((_) => _, "_OutDone")
};
var EffectPrototype = {
...
var isOption = /* @__PURE__ */ __name2((input) => hasProperty(input, TypeId), "isOption");
var isNone = /* @__PURE__ */ __name2((fa) => fa._tag === "None", "isNone");
var isSome = /* @__PURE__ */ __name2((fa) => fa._tag === "Some", "isSome");
var none = /* @__PURE__ */ Object.create(NoneProto);
var some = /* @__PURE__ */ __name2((value) => {
...
var isEither = /* @__PURE__ */ __name2((input) => hasProperty(input, TypeId2), "isEither");
var isLeft = /* @__PURE__ */ __name2((ma) => ma._tag === "Left", "isLeft");
var isRight = /* @__PURE__ */ __name2((ma) => ma._tag === "Right", "isRight");
var left = /* @__PURE__ */ __name2((left3) => {
  const a = Object.create(LeftProto);
  a.left = left3;
  return a;
}, "left");
var right = /* @__PURE__ */ __name2((right3) => {
...
var isNonEmptyArray = /* @__PURE__ */ __name2((self) => self.length > 0, "isNonEmptyArray");
var make2 = /* @__PURE__ */ __name2((compare) => (self, that) => self === that ? 0 : compare(self, that), "make");
var number2 = /* @__PURE__ */ make2((self, that) => self < that ? -1 : 1);
var mapInput2 = /* @__PURE__ */ dual(2, (self, f) => make2((b1, b2) => self(f(b1), f(b2))));
var greaterThan = /* @__PURE__ */ __name2((O) => dual(2, (self, that) => O(self, that) === 1), "greaterThan");
var none2 = /* @__PURE__ */ __name2(() => none, "none");
var some2 = some;
var isNone2 = isNone;
var isSome2 = isSome;
...
var fromNullable = /* @__PURE__ */ __name2((nullableValue) => nullableValue == null ? none2() : some2(nullableValue), "fromNullable");
...
var containsWith = /* @__PURE__ */ __name2((isEquivalent) => dual(2, (self, a) => isNone2(self) ? false : isEquivalent(self.value, a)), "containsWith");
var _equivalence = /* @__PURE__ */ equivalence();
var contains = /* @__PURE__ */ containsWith(_equivalence);
var mergeWith = /* @__PURE__ */ __name2((f) => (o1, o2) => {
  if (isNone2(o1)) {
    return o2;
  } else if (isNone2(o2)) {
    return o1;
...
var make3 = /* @__PURE__ */ __name2((...elements) => elements, "make");
var allocate = /* @__PURE__ */ __name2((n) => new Array(n), "allocate");
...
var fromIterable = /* @__PURE__ */ __name2((collection) => Array.isArray(collection) ? collection : Array.from(collection), "fromIterable");
var ensure = /* @__PURE__ */ __name2((self) => Array.isArray(self) ? self : [self], "ensure");
var prepend = /* @__PURE__ */ dual(2, (self, head5) => [head5, ...self]);
var append = /* @__PURE__ */ dual(2, (self, last3) => [...self, last3]);
var appendAll = /* @__PURE__ */ dual(2, (self, that) => fromIterable(self).concat(fromIterable(that)));
var isArray = Array.isArray;
var isEmptyArray = /* @__PURE__ */ __name2((self) => self.length === 0, "isEmptyArray");
var isEmptyReadonlyArray = isEmptyArray;
var isNonEmptyArray2 = isNonEmptyArray;
var isNonEmptyReadonlyArray = isNonEmptyArray;
var isOutOfBounds = /* @__PURE__ */ __name2((i, as7) => i < 0 || i >= as7.length, "isOutOfBounds");
var clamp = /* @__PURE__ */ __name2((i, as7) => Math.floor(Math.min(Math.max(0, i), as7.length)), "clamp");
...
var last = /* @__PURE__ */ __name2((self) => isNonEmptyReadonlyArray(self) ? some2(lastNonEmpty(self)) : none2(), "last");
var lastNonEmpty = /* @__PURE__ */ __name2((self) => self[self.length - 1], "lastNonEmpty");
var tailNonEmpty = /* @__PURE__ */ __name2((self) => self.slice(1), "tailNonEmpty");
var spanIndex = /* @__PURE__ */ __name2((self, predicate) => {
  let i = 0;
  for (const a of self) {
    if (!predicate(a, i)) {
      break;
...
var reverse = /* @__PURE__ */ __name2((self) => Array.from(self).reverse(), "reverse");
...
var copy = /* @__PURE__ */ __name2((self) => self.slice(), "copy");
...
var of = /* @__PURE__ */ __name2((a) => [a], "of");
...
var unfold = /* @__PURE__ */ __name2((b, f) => {
  const out = [];
  let next = b;
  let o;
...
var dedupe = /* @__PURE__ */ __name2((self) => dedupeWith(self, equivalence()), "dedupe");
var join = /* @__PURE__ */ dual(2, (self, sep) => fromIterable(self).join(sep));
var Order = number2;
var escape = /* @__PURE__ */ __name2((string2) => string2.replace(/[/\\^$*+?.()|[\]{}]/g, "\\$&"), "escape");
var not = /* @__PURE__ */ __name2((self) => !self, "not");
var Context_exports = {};
__export(Context_exports, {
  GenericTag: /* @__PURE__ */ __name(() => GenericTag, "GenericTag"),
  Reference: /* @__PURE__ */ __name(() => Reference2, "Reference"),
  ReferenceTypeId: /* @__PURE__ */ __name(() => ReferenceTypeId2, "ReferenceTypeId"),
  Tag: /* @__PURE__ */ __name(() => Tag2, "Tag"),
  TagTypeId: /* @__PURE__ */ __name(() => TagTypeId2, "TagTypeId"),
  add: /* @__PURE__ */ __name(() => add2, "add"),
  empty: /* @__PURE__ */ __name(() => empty3, "empty"),
  get: /* @__PURE__ */ __name(() => get3, "get"),
  getOption: /* @__PURE__ */ __name(() => getOption2, "getOption"),
  getOrElse: /* @__PURE__ */ __name(() => getOrElse3, "getOrElse"),
  isContext: /* @__PURE__ */ __name(() => isContext2, "isContext"),
  isReference: /* @__PURE__ */ __name(() => isReference2, "isReference"),
  isTag: /* @__PURE__ */ __name(() => isTag2, "isTag"),
  make: /* @__PURE__ */ __name(() => make5, "make"),
  merge: /* @__PURE__ */ __name(() => merge3, "merge"),
  mergeAll: /* @__PURE__ */ __name(() => mergeAll2, "mergeAll"),
  omit: /* @__PURE__ */ __name(() => omit2, "omit"),
  pick: /* @__PURE__ */ __name(() => pick2, "pick"),
  unsafeGet: /* @__PURE__ */ __name(() => unsafeGet3, "unsafeGet"),
  unsafeMake: /* @__PURE__ */ __name(() => unsafeMake, "unsafeMake")
});
...
var TagProto = {
  ...
  [TagTypeId]: {
    _Service: /* @__PURE__ */ __name2((_) => _, "_Service"),
    _Identifier: /* @__PURE__ */ __name2((_) => _, "_Identifier")
  },
  toString() {
    return format(this.toJSON());
  },
...
var makeGenericTag = /* @__PURE__ */ __name2((key) => {
...
var Reference = /* @__PURE__ */ __name2(() => (id, options) => {
  const limit = Error.stackTraceLimit;
  Error.stackTraceLimit = 2;
  const creationError = new Error();
  Error.stackTraceLimit = limit;
  ...
  __name2(ReferenceClass, "ReferenceClass");
...
var ContextProto = {
  [TypeId3]: {
    _Services: /* @__PURE__ */ __name2((_) => _, "_Services")
  },
  [symbol2](that) {
    if (isContext(that)) {
...
var makeContext = /* @__PURE__ */ __name2((unsafeMap) => {
  const context5 = Object.create(ContextProto);
  context5.unsafeMap = unsafeMap;
  return context5;
}, "makeContext");
var serviceNotFoundError = /* @__PURE__ */ __name2((tag) => {
...
var isContext = /* @__PURE__ */ __name2((u) => hasProperty(u, TypeId3), "isContext");
var isTag = /* @__PURE__ */ __name2((u) => hasProperty(u, TagTypeId), "isTag");
var isReference = /* @__PURE__ */ __name2((u) => hasProperty(u, ReferenceTypeId), "isReference");
var _empty = /* @__PURE__ */ makeContext(/* @__PURE__ */ new Map());
var empty2 = /* @__PURE__ */ __name2(() => _empty, "empty");
var make4 = /* @__PURE__ */ __name2((tag, service3) => makeContext(/* @__PURE__ */ new Map([[tag.key, service3]])), "make");
...
var getDefaultValue = /* @__PURE__ */ __name2((tag) => {
...
var unsafeGetReference = /* @__PURE__ */ __name2((self, tag) => {
...
var mergeAll = /* @__PURE__ */ __name2((...ctxs) => {
...
var pick = /* @__PURE__ */ __name2((...tags) => (self) => {
...
var omit = /* @__PURE__ */ __name2((...tags) => (self) => {
...
__name2(copy2, "copy");
var emptyArray = [];
var getEquivalence2 = /* @__PURE__ */ __name2((isEquivalent) => make((self, that) => self.length === that.length && toReadonlyArray(self).every((value, i) => isEquivalent(value, unsafeGet4(that, i)))), "getEquivalence");
...
var makeChunk = /* @__PURE__ */ __name2((backing) => {
...
var isChunk = /* @__PURE__ */ __name2((u) => hasProperty(u, TypeId4), "isChunk");
var _empty2 = /* @__PURE__ */ makeChunk({
  _tag: "IEmpty"
});
var empty4 = /* @__PURE__ */ __name2(() => _empty2, "empty");
var make6 = /* @__PURE__ */ __name2((...as7) => unsafeFromNonEmptyArray(as7), "make");
var of2 = /* @__PURE__ */ __name2((a) => makeChunk({
  _tag: "ISingleton",
  a
}), "of");
var fromIterable2 = /* @__PURE__ */ __name2((self) => isChunk(self) ? self : unsafeFromArray(fromIterable(self)), "fromIterable");
var copyToArray = /* @__PURE__ */ __name2((self, array4, initial) => {
...
var toReadonlyArray_ = /* @__PURE__ */ __name2((self) => {
  switch (self.backing._tag) {
    case "IEmpty": {
      return emptyArray;
    }
...
var reverseChunk = /* @__PURE__ */ __name2((self) => {
  switch (self.backing._tag) {
    case "IEmpty":
    case "ISingleton":
      return self;
...
var unsafeFromArray = /* @__PURE__ */ __name2((self) => self.length === 0 ? empty4() : self.length === 1 ? of2(self[0]) : makeChunk({
  _tag: "IArray",
  array: self
}), "unsafeFromArray");
var unsafeFromNonEmptyArray = /* @__PURE__ */ __name2((self) => unsafeFromArray(self), "unsafeFromNonEmptyArray");
...
var isEmpty = /* @__PURE__ */ __name2((self) => self.length === 0, "isEmpty");
var isNonEmpty = /* @__PURE__ */ __name2((self) => self.length > 0, "isNonEmpty");
var head2 = /* @__PURE__ */ get4(0);
var unsafeHead = /* @__PURE__ */ __name2((self) => unsafeGet4(self, 0), "unsafeHead");
var headNonEmpty2 = unsafeHead;
var tailNonEmpty2 = /* @__PURE__ */ __name2((self) => drop2(self, 1), "tailNonEmpty");
...
var decode3 = /* @__PURE__ */ __name2((input) => {
  if (isDuration(input)) {
    return input;
...
var make7 = /* @__PURE__ */ __name2((input) => {
...
var isDuration = /* @__PURE__ */ __name2((u) => hasProperty(u, TypeId5), "isDuration");
var isZero = /* @__PURE__ */ __name2((self) => {
...
var nanos = /* @__PURE__ */ __name2((nanos2) => make7(nanos2), "nanos");
var micros = /* @__PURE__ */ __name2((micros2) => make7(micros2 * bigint1e3), "micros");
var millis = /* @__PURE__ */ __name2((millis2) => make7(millis2), "millis");
var seconds = /* @__PURE__ */ __name2((seconds2) => make7(seconds2 * 1e3), "seconds");
var minutes = /* @__PURE__ */ __name2((minutes2) => make7(minutes2 * 6e4), "minutes");
var hours = /* @__PURE__ */ __name2((hours2) => make7(hours2 * 36e5), "hours");
var days = /* @__PURE__ */ __name2((days2) => make7(days2 * 864e5), "days");
var weeks = /* @__PURE__ */ __name2((weeks2) => make7(weeks2 * 6048e5), "weeks");
var toMillis = /* @__PURE__ */ __name2((self) => match4(self, {
  onMillis: /* @__PURE__ */ __name2((millis2) => millis2, "onMillis"),
  onNanos: /* @__PURE__ */ __name2((nanos2) => Number(nanos2) / 1e6, "onNanos")
}), "toMillis");
var unsafeToNanos = /* @__PURE__ */ __name2((self) => {
...
var toHrTime = /* @__PURE__ */ __name2((self) => {
  const _self = decode3(self);
  switch (_self.value._tag) {
    case "Infinity":
      return [Infinity, 0];
...
var Equivalence = /* @__PURE__ */ __name2((self, that) => matchWith(self, that, {
  onMillis: /* @__PURE__ */ __name2((self2, that2) => self2 === that2, "onMillis"),
  onNanos: /* @__PURE__ */ __name2((self2, that2) => self2 === that2, "onNanos")
}), "Equivalence");
...
var parts = /* @__PURE__ */ __name2((self) => {
...
var format2 = /* @__PURE__ */ __name2((self) => {
  const duration = decode3(self);
  if (duration.value._tag === "Infinity") {
    return "Infinity";
  }
...
__name2(popcount, "popcount");
function hashFragment(shift2, h) {
  return h >>> shift2 & MASK;
}
__name(hashFragment, "hashFragment");
__name2(hashFragment, "hashFragment");
function toBitmap(x) {
  return 1 << x;
}
__name(toBitmap, "toBitmap");
__name2(toBitmap, "toBitmap");
function fromBitmap(bitmap, bit) {
  return popcount(bitmap & bit - 1);
}
__name(fromBitmap, "fromBitmap");
__name2(fromBitmap, "fromBitmap");
var make8 = /* @__PURE__ */ __name2((value, previous) => ({
  value,
  previous
}), "make");
...
__name2(arrayUpdate, "arrayUpdate");
...
__name2(arraySpliceOut, "arraySpliceOut");
...
__name2(arraySpliceIn, "arraySpliceIn");
var EmptyNode = class _EmptyNode {
  static {
    __name(this, "_EmptyNode");
  }
  static {
    __name2(this, "EmptyNode");
  }
  _tag = "EmptyNode";
...
__name2(isEmptyNode, "isEmptyNode");
function isLeafNode(node) {
  return isEmptyNode(node) || node._tag === "LeafNode" || node._tag === "CollisionNode";
}
__name(isLeafNode, "isLeafNode");
__name2(isLeafNode, "isLeafNode");
function canEditNode(node, edit) {
  return isEmptyNode(node) ? false : edit === node.edit;
}
__name(canEditNode, "canEditNode");
__name2(canEditNode, "canEditNode");
var LeafNode = class _LeafNode {
  static {
    __name(this, "_LeafNode");
  }
  static {
    __name2(this, "LeafNode");
  }
  edit;
  hash;
  key;
...
var CollisionNode = class _CollisionNode {
  static {
    __name(this, "_CollisionNode");
  }
  static {
    __name2(this, "CollisionNode");
  }
  edit;
  hash;
  children;
...
var IndexedNode = class _IndexedNode {
  static {
    __name(this, "_IndexedNode");
  }
  static {
    __name2(this, "IndexedNode");
  }
  edit;
  mask;
  children;
...
var ArrayNode = class _ArrayNode {
  static {
    __name(this, "_ArrayNode");
  }
  static {
    __name2(this, "ArrayNode");
  }
  edit;
  size;
  children;
...
__name2(mergeLeavesInner, "mergeLeavesInner");
...
__name2(mergeLeaves, "mergeLeaves");
...
var makeImpl = /* @__PURE__ */ __name2((editable, edit, root, size11) => {
...
var HashMapIterator = class _HashMapIterator {
  static {
    __name(this, "_HashMapIterator");
  }
  static {
    __name2(this, "HashMapIterator");
  }
  map;
  f;
  v;
...
var applyCont = /* @__PURE__ */ __name2((cont) => cont ? visitLazyChildren(cont[0], cont[1], cont[2], cont[3], cont[4]) : none2(), "applyCont");
var visitLazy = /* @__PURE__ */ __name2((node, f, cont = void 0) => {
  switch (node._tag) {
    case "LeafNode": {
...
var visitLazyChildren = /* @__PURE__ */ __name2((len, children, i, f, cont) => {
  while (i < len) {
...
var empty5 = /* @__PURE__ */ __name2(() => _empty3, "empty");
var fromIterable3 = /* @__PURE__ */ __name2((entries2) => {
...
var isHashMap = /* @__PURE__ */ __name2((u) => hasProperty(u, HashMapTypeId), "isHashMap");
var isEmpty2 = /* @__PURE__ */ __name2((self) => self && isEmptyNode(self._root), "isEmpty");
...
var keys = /* @__PURE__ */ __name2((self) => new HashMapIterator(self, (key) => key), "keys");
var size = /* @__PURE__ */ __name2((self) => self._size, "size");
var beginMutation = /* @__PURE__ */ __name2((self) => makeImpl(true, self._edit + 1, self._root, self._size), "beginMutation");
var endMutation = /* @__PURE__ */ __name2((self) => {
  ;
...
var makeImpl2 = /* @__PURE__ */ __name2((keyMap) => {
  const set6 = Object.create(HashSetProto);
  set6._keyMap = keyMap;
  return set6;
}, "makeImpl");
var isHashSet = /* @__PURE__ */ __name2((u) => hasProperty(u, HashSetTypeId), "isHashSet");
var _empty4 = /* @__PURE__ */ makeImpl2(/* @__PURE__ */ empty5());
var empty6 = /* @__PURE__ */ __name2(() => _empty4, "empty");
var fromIterable4 = /* @__PURE__ */ __name2((elements) => {
...
var make9 = /* @__PURE__ */ __name2((...elements) => {
  const set6 = beginMutation2(empty6());
  for (const value of elements) {
    add3(set6, value);
  }
...
var size2 = /* @__PURE__ */ __name2((self) => size(self._keyMap), "size");
var beginMutation2 = /* @__PURE__ */ __name2((self) => makeImpl2(beginMutation(self._keyMap)), "beginMutation");
var endMutation2 = /* @__PURE__ */ __name2((self) => {
  ;
...
var make11 = /* @__PURE__ */ __name2((value) => {
...
var get6 = /* @__PURE__ */ __name2((self) => self.current, "get");
...
var isFiberId = /* @__PURE__ */ __name2((self) => hasProperty(self, FiberIdTypeId), "isFiberId");
...
var threadName = /* @__PURE__ */ __name2((self) => {
  const identifiers = Array.from(ids(self)).map((n) => `#${n}`).join(",");
  return identifiers;
}, "threadName");
var unsafeMake2 = /* @__PURE__ */ __name2(() => {
...
var toArray2 = /* @__PURE__ */ __name2((self) => fromIterable(self), "toArray");
var getEquivalence3 = /* @__PURE__ */ __name2((isEquivalent) => mapInput(getEquivalence(isEquivalent), toArray2), "getEquivalence");
...
var makeCons = /* @__PURE__ */ __name2((head5, tail) => {
...
var isList = /* @__PURE__ */ __name2((u) => hasProperty(u, TypeId7), "isList");
var isNil = /* @__PURE__ */ __name2((self) => self._tag === "Nil", "isNil");
var isCons = /* @__PURE__ */ __name2((self) => self._tag === "Cons", "isCons");
var nil = /* @__PURE__ */ __name2(() => _Nil, "nil");
var cons = /* @__PURE__ */ __name2((head5, tail) => makeCons(head5, tail), "cons");
var empty9 = nil;
var of3 = /* @__PURE__ */ __name2((value) => makeCons(value, _Nil), "of");
...
var reverse3 = /* @__PURE__ */ __name2((self) => {
  let result = empty9();
  let these = self;
  while (!isNil(these)) {
...
var Structural = /* @__PURE__ */ function() {
  ...
  __name(Structural3, "Structural3");
  __name2(Structural3, "Structural");
  Structural3.prototype = StructuralPrototype;
  return Structural3;
}();
var struct = /* @__PURE__ */ __name2((as7) => Object.assign(Object.create(StructuralPrototype), as7), "struct");
var ContextPatchTypeId = /* @__PURE__ */ Symbol.for("effect/DifferContextPatch");
function variance(a) {
  return a;
}
__name(variance, "variance");
__name2(variance, "variance");
var PatchProto = {
...
var empty10 = /* @__PURE__ */ __name2(() => _empty5, "empty");
var AndThenProto = /* @__PURE__ */ Object.assign(/* @__PURE__ */ Object.create(PatchProto), {
  _tag: "AndThen"
});
var makeAndThen = /* @__PURE__ */ __name2((first2, second) => {
...
var makeAddService = /* @__PURE__ */ __name2((key, service3) => {
...
var makeRemoveService = /* @__PURE__ */ __name2((key) => {
...
var makeUpdateService = /* @__PURE__ */ __name2((key, update5) => {
  const o = Object.create(UpdateServiceProto);
  o.key = key;
  o.update = update5;
  return o;
}, "makeUpdateService");
var diff = /* @__PURE__ */ __name2((oldValue, newValue) => {
...
__name(variance2, "variance2");
__name2(variance2, "variance");
var PatchProto2 = {
  ...Structural.prototype,
  [HashSetPatchTypeId]: {
    _Value: variance2,
...
var empty11 = /* @__PURE__ */ __name2(() => _empty6, "empty");
var AndThenProto2 = /* @__PURE__ */ Object.assign(/* @__PURE__ */ Object.create(PatchProto2), {
  _tag: "AndThen"
});
var makeAndThen2 = /* @__PURE__ */ __name2((first2, second) => {
...
var makeAdd = /* @__PURE__ */ __name2((value) => {
...
var makeRemove = /* @__PURE__ */ __name2((value) => {
  const o = Object.create(RemoveProto);
  o.value = value;
  return o;
}, "makeRemove");
var diff2 = /* @__PURE__ */ __name2((oldValue, newValue) => {
...
__name(variance3, "variance3");
__name2(variance3, "variance");
var PatchProto3 = {
  ...Structural.prototype,
...
var empty12 = /* @__PURE__ */ __name2(() => _empty7, "empty");
var AndThenProto3 = /* @__PURE__ */ Object.assign(/* @__PURE__ */ Object.create(PatchProto3), {
  _tag: "AndThen"
});
var makeAndThen3 = /* @__PURE__ */ __name2((first2, second) => {
...
var makeAppend = /* @__PURE__ */ __name2((values3) => {
...
var makeSlice = /* @__PURE__ */ __name2((from, until) => {
...
var makeUpdate = /* @__PURE__ */ __name2((index, patch9) => {
  const o = Object.create(UpdateProto);
  o.index = index;
  o.patch = patch9;
  return o;
}, "makeUpdate");
var diff3 = /* @__PURE__ */ __name2((options) => {
  let i = 0;
  let patch9 = empty12();
...
var make14 = /* @__PURE__ */ __name2((params) => {
...
var environment = /* @__PURE__ */ __name2(() => make14({
  empty: empty10(),
  combine: /* @__PURE__ */ __name2((first2, second) => combine4(second)(first2), "combine"),
  diff: /* @__PURE__ */ __name2((oldValue, newValue) => diff(oldValue, newValue), "diff"),
  patch: /* @__PURE__ */ __name2((patch9, oldValue) => patch(oldValue)(patch9), "patch")
}), "environment");
var hashSet = /* @__PURE__ */ __name2(() => make14({
  empty: empty11(),
  combine: /* @__PURE__ */ __name2((first2, second) => combine5(second)(first2), "combine"),
  diff: /* @__PURE__ */ __name2((oldValue, newValue) => diff2(oldValue, newValue), "diff"),
  patch: /* @__PURE__ */ __name2((patch9, oldValue) => patch2(oldValue)(patch9), "patch")
}), "hashSet");
var readonlyArray = /* @__PURE__ */ __name2((differ3) => make14({
  empty: empty12(),
  combine: /* @__PURE__ */ __name2((first2, second) => combine6(first2, second), "combine"),
  diff: /* @__PURE__ */ __name2((oldValue, newValue) => diff3({
    oldValue,
    newValue,
    differ: differ3
  }), "diff"),
  patch: /* @__PURE__ */ __name2((patch9, oldValue) => patch3(patch9, oldValue, differ3), "patch")
}), "readonlyArray");
var update = /* @__PURE__ */ __name2(() => updateWith((_, a) => a), "update");
var updateWith = /* @__PURE__ */ __name2((f) => make14({
  empty: identity,
  combine: /* @__PURE__ */ __name2((first2, second) => {
    if (first2 === identity) {
      return second;
    }
    if (second === identity) {
  ...
  diff: /* @__PURE__ */ __name2((oldValue, newValue) => {
    if (equals(oldValue, newValue)) {
      return identity;
    }
    return constant(newValue);
  }, "diff"),
  patch: /* @__PURE__ */ __name2((patch9, oldValue) => f(oldValue, patch9(oldValue)), "patch")
}), "updateWith");
var BIT_MASK = 255;
var BIT_SHIFT = 8;
var active = /* @__PURE__ */ __name2((patch9) => patch9 & BIT_MASK, "active");
var enabled = /* @__PURE__ */ __name2((patch9) => patch9 >> BIT_SHIFT & BIT_MASK, "enabled");
var make15 = /* @__PURE__ */ __name2((active2, enabled2) => (active2 & BIT_MASK) + ((enabled2 & active2 & BIT_MASK) << BIT_SHIFT), "make");
var empty13 = /* @__PURE__ */ make15(0, 0);
var enable = /* @__PURE__ */ __name2((flag) => make15(flag, flag), "enable");
var disable = /* @__PURE__ */ __name2((flag) => make15(flag, 0), "disable");
...
var invert = /* @__PURE__ */ __name2((n) => ~n >>> 0 & BIT_MASK, "invert");
var None2 = 0;
...
var cooperativeYielding = /* @__PURE__ */ __name2((self) => isEnabled(self, CooperativeYielding), "cooperativeYielding");
var disable2 = /* @__PURE__ */ dual(2, (self, flag) => self & ~flag);
var enable2 = /* @__PURE__ */ dual(2, (self, flag) => self | flag);
var interruptible = /* @__PURE__ */ __name2((self) => interruption(self) && !windDown(self), "interruptible");
var interruption = /* @__PURE__ */ __name2((self) => isEnabled(self, Interruption), "interruption");
var isEnabled = /* @__PURE__ */ dual(2, (self, flag) => (self & flag) !== 0);
var make16 = /* @__PURE__ */ __name2((...flags2) => flags2.reduce((a, b) => a | b, 0), "make");
var none5 = /* @__PURE__ */ make16(None2);
var runtimeMetrics = /* @__PURE__ */ __name2((self) => isEnabled(self, RuntimeMetrics), "runtimeMetrics");
var windDown = /* @__PURE__ */ __name2((self) => isEnabled(self, WindDown), "windDown");
...
var differ = /* @__PURE__ */ make14({
  empty: empty13,
  diff: /* @__PURE__ */ __name2((oldValue, newValue) => diff4(oldValue, newValue), "diff"),
  combine: /* @__PURE__ */ __name2((first2, second) => andThen(second)(first2), "combine"),
  patch: /* @__PURE__ */ __name2((_patch, oldValue) => patch4(oldValue, _patch), "patch")
});
var empty14 = empty13;
var enable3 = enable;
...
var par = /* @__PURE__ */ __name2((self, that) => ({
  _tag: "Par",
  left: self,
  right: that
}), "par");
var seq = /* @__PURE__ */ __name2((self, that) => ({
  _tag: "Seq",
  left: self,
  right: that
}), "seq");
var single = /* @__PURE__ */ __name2((dataSource, blockedRequest) => ({
  _tag: "Single",
  dataSource,
  blockedRequest
}), "single");
var flatten2 = /* @__PURE__ */ __name2((self) => {
...
var step = /* @__PURE__ */ __name2((requests) => {
...
var merge4 = /* @__PURE__ */ __name2((sequential5, parallel5) => {
  if (isNil(sequential5)) {
...
var makeEntry = /* @__PURE__ */ __name2((options) => new EntryImpl(options.request, options.result, options.listeners, options.ownerId, options.state), "makeEntry");
...
var parallelCollectionEmpty = /* @__PURE__ */ __name2(() => new ParallelImpl(empty8()), "parallelCollectionEmpty");
var parallelCollectionAdd = /* @__PURE__ */ __name2((self, blockedRequest) => new ParallelImpl(modifyAt2(self.map, blockedRequest.dataSource, (_) => orElseSome(map(_, append2(blockedRequest.blockedRequest)), () => of2(blockedRequest.blockedRequest)))), "parallelCollectionAdd");
var parallelCollectionCombine = /* @__PURE__ */ __name2((self, that) => new ParallelImpl(reduce5(self.map, that.map, (map16, value, key) => set3(map16, key, match3(get7(map16, key), {
  onNone: /* @__PURE__ */ __name2(() => value, "onNone"),
  onSome: /* @__PURE__ */ __name2((other) => appendAll2(value, other), "onSome")
})))), "parallelCollectionCombine");
var parallelCollectionIsEmpty = /* @__PURE__ */ __name2((self) => isEmpty3(self.map), "parallelCollectionIsEmpty");
var parallelCollectionKeys = /* @__PURE__ */ __name2((self) => Array.from(keys2(self.map)), "parallelCollectionKeys");
var parallelCollectionToSequentialCollection = /* @__PURE__ */ __name2((self) => sequentialCollectionMake(map6(self.map, (x) => of2(x))), "parallelCollectionToSequentialCollection");
...
var sequentialCollectionMake = /* @__PURE__ */ __name2((map16) => new SequentialImpl(map16), "sequentialCollectionMake");
var sequentialCollectionCombine = /* @__PURE__ */ __name2((self, that) => new SequentialImpl(reduce5(that.map, self.map, (map16, value, key) => set3(map16, key, match3(get7(map16, key), {
  onNone: /* @__PURE__ */ __name2(() => empty4(), "onNone"),
  onSome: /* @__PURE__ */ __name2((a) => appendAll2(a, value), "onSome")
})))), "sequentialCollectionCombine");
var sequentialCollectionKeys = /* @__PURE__ */ __name2((self) => Array.from(keys2(self.map)), "sequentialCollectionKeys");
var sequentialCollectionToChunk = /* @__PURE__ */ __name2((self) => Array.from(self.map), "sequentialCollectionToChunk");
var OP_DIE = "Die";
var OP_EMPTY = "Empty";
var OP_FAIL = "Fail";
...
var fail = /* @__PURE__ */ __name2((error) => {
  const o = Object.create(proto);
  o._tag = OP_FAIL;
  o.error = error;
  return o;
}, "fail");
var die = /* @__PURE__ */ __name2((defect) => {
  const o = Object.create(proto);
  o._tag = OP_DIE;
  o.defect = defect;
  return o;
}, "die");
var interrupt = /* @__PURE__ */ __name2((fiberId3) => {
  const o = Object.create(proto);
  o._tag = OP_INTERRUPT;
  o.fiberId = fiberId3;
  return o;
}, "interrupt");
var parallel = /* @__PURE__ */ __name2((left3, right3) => {
  const o = Object.create(proto);
  o._tag = OP_PARALLEL;
  o.left = left3;
  o.right = right3;
...
var sequential = /* @__PURE__ */ __name2((left3, right3) => {
  const o = Object.create(proto);
...
var isCause = /* @__PURE__ */ __name2((u) => hasProperty(u, CauseTypeId), "isCause");
var isEmptyType = /* @__PURE__ */ __name2((self) => self._tag === OP_EMPTY, "isEmptyType");
var isFailType = /* @__PURE__ */ __name2((self) => self._tag === OP_FAIL, "isFailType");
var isDieType = /* @__PURE__ */ __name2((self) => self._tag === OP_DIE, "isDieType");
var isInterruptType = /* @__PURE__ */ __name2((self) => self._tag === OP_INTERRUPT, "isInterruptType");
var isSequentialType = /* @__PURE__ */ __name2((self) => self._tag === OP_SEQUENTIAL, "isSequentialType");
var isParallelType = /* @__PURE__ */ __name2((self) => self._tag === OP_PARALLEL, "isParallelType");
var size4 = /* @__PURE__ */ __name2((self) => reduceWithContext(self, void 0, SizeCauseReducer), "size");
var isEmpty5 = /* @__PURE__ */ __name2((self) => {
...
var isFailure = /* @__PURE__ */ __name2((self) => isSome2(failureOption(self)), "isFailure");
var isDie = /* @__PURE__ */ __name2((self) => isSome2(dieOption(self)), "isDie");
var isInterrupted = /* @__PURE__ */ __name2((self) => isSome2(interruptOption(self)), "isInterrupted");
var isInterruptedOnly = /* @__PURE__ */ __name2((self) => reduceWithContext(void 0, IsInterruptedOnlyCauseReducer)(self), "isInterruptedOnly");
var failures = /* @__PURE__ */ __name2((self) => reverse2(reduce7(self, empty4(), (list, cause3) => cause3._tag === OP_FAIL ? some2(pipe(list, prepend2(cause3.error))) : none2())), "failures");
var defects = /* @__PURE__ */ __name2((self) => reverse2(reduce7(self, empty4(), (list, cause3) => cause3._tag === OP_DIE ? some2(pipe(list, prepend2(cause3.defect))) : none2())), "defects");
var interruptors = /* @__PURE__ */ __name2((self) => reduce7(self, empty7(), (set6, cause3) => cause3._tag === OP_INTERRUPT ? some2(pipe(set6, add4(cause3.fiberId))) : none2()), "interruptors");
var failureOption = /* @__PURE__ */ __name2((self) => find(self, (cause3) => cause3._tag === OP_FAIL ? some2(cause3.error) : none2()), "failureOption");
var failureOrCause = /* @__PURE__ */ __name2((self) => {
...
var dieOption = /* @__PURE__ */ __name2((self) => find(self, (cause3) => cause3._tag === OP_DIE ? some2(cause3.defect) : none2()), "dieOption");
var flipCauseOption = /* @__PURE__ */ __name2((self) => match5(self, {
  onEmpty: some2(empty16),
  onFail: map(fail),
  onDie: /* @__PURE__ */ __name2((defect) => some2(die(defect)), "onDie"),
  onInterrupt: /* @__PURE__ */ __name2((fiberId3) => some2(interrupt(fiberId3)), "onInterrupt"),
  onSequential: mergeWith(sequential),
  onParallel: mergeWith(parallel)
}), "flipCauseOption");
var interruptOption = /* @__PURE__ */ __name2((self) => find(self, (cause3) => cause3._tag === OP_INTERRUPT ? some2(cause3.fiberId) : none2()), "interruptOption");
var keepDefects = /* @__PURE__ */ __name2((self) => match5(self, {
  onEmpty: none2(),
  onFail: /* @__PURE__ */ __name2(() => none2(), "onFail"),
  onDie: /* @__PURE__ */ __name2((defect) => some2(die(defect)), "onDie"),
  onInterrupt: /* @__PURE__ */ __name2(() => none2(), "onInterrupt"),
  onSequential: mergeWith(sequential),
  onParallel: mergeWith(parallel)
}), "keepDefects");
var keepDefectsAndElectFailures = /* @__PURE__ */ __name2((self) => match5(self, {
  onEmpty: none2(),
  onFail: /* @__PURE__ */ __name2((failure) => some2(die(failure)), "onFail"),
  onDie: /* @__PURE__ */ __name2((defect) => some2(die(defect)), "onDie"),
  onInterrupt: /* @__PURE__ */ __name2(() => none2(), "onInterrupt"),
  onSequential: mergeWith(sequential),
  onParallel: mergeWith(parallel)
}), "keepDefectsAndElectFailures");
var linearize = /* @__PURE__ */ __name2((self) => match5(self, {
  onEmpty: empty7(),
  onFail: /* @__PURE__ */ __name2((error) => make10(fail(error)), "onFail"),
  onDie: /* @__PURE__ */ __name2((defect) => make10(die(defect)), "onDie"),
  onInterrupt: /* @__PURE__ */ __name2((fiberId3) => make10(interrupt(fiberId3)), "onInterrupt"),
  onSequential: /* @__PURE__ */ __name2((leftSet, rightSet) => flatMap4(leftSet, (leftCause) => map5(rightSet, (rightCause) => sequential(leftCause, rightCause))), "onSequential"),
  onParallel: /* @__PURE__ */ __name2((leftSet, rightSet) => flatMap4(leftSet, (leftCause) => map5(rightSet, (rightCause) => parallel(leftCause, rightCause))), "onParallel")
}), "linearize");
var stripFailures = /* @__PURE__ */ __name2((self) => match5(self, {
  onEmpty: empty16,
  onFail: /* @__PURE__ */ __name2(() => empty16, "onFail"),
  onDie: die,
  onInterrupt: interrupt,
  onSequential: sequential,
  onParallel: parallel
}), "stripFailures");
var electFailures = /* @__PURE__ */ __name2((self) => match5(self, {
  onEmpty: empty16,
  onFail: die,
  onDie: die,
  onInterrupt: interrupt,
...
var stripSomeDefects = /* @__PURE__ */ dual(2, (self, pf) => match5(self, {
  onEmpty: some2(empty16),
  onFail: /* @__PURE__ */ __name2((error) => some2(fail(error)), "onFail"),
  onDie: /* @__PURE__ */ __name2((defect) => {
...
var flatMap6 = /* @__PURE__ */ dual(2, (self, f) => match5(self, {
  onEmpty: empty16,
  onFail: /* @__PURE__ */ __name2((error) => f(error), "onFail"),
  onDie: /* @__PURE__ */ __name2((defect) => die(defect), "onDie"),
  onInterrupt: /* @__PURE__ */ __name2((fiberId3) => interrupt(fiberId3), "onInterrupt"),
  onSequential: /* @__PURE__ */ __name2((left3, right3) => sequential(left3, right3), "onSequential"),
  onParallel: /* @__PURE__ */ __name2((left3, right3) => parallel(left3, right3), "onParallel")
}));
var flatten3 = /* @__PURE__ */ __name2((self) => flatMap6(self, identity), "flatten");
...
var causeEquals = /* @__PURE__ */ __name2((left3, right3) => {
...
var flattenCause = /* @__PURE__ */ __name2((cause3) => {
  return flattenCauseLoop(of2(cause3), empty4());
}, "flattenCause");
var flattenCauseLoop = /* @__PURE__ */ __name2((causes, flattened) => {
  while (1) {
...
var evaluateCause = /* @__PURE__ */ __name2((self) => {
  let cause3 = self;
  const stack = [];
...
var SizeCauseReducer = {
  emptyCase: /* @__PURE__ */ __name2(() => 0, "emptyCase"),
  failCase: /* @__PURE__ */ __name2(() => 1, "failCase"),
  dieCase: /* @__PURE__ */ __name2(() => 1, "dieCase"),
  interruptCase: /* @__PURE__ */ __name2(() => 1, "interruptCase"),
  sequentialCase: /* @__PURE__ */ __name2((_, left3, right3) => left3 + right3, "sequentialCase"),
  parallelCase: /* @__PURE__ */ __name2((_, left3, right3) => left3 + right3, "parallelCase")
};
...
var FilterCauseReducer = /* @__PURE__ */ __name2((predicate) => ({
  emptyCase: /* @__PURE__ */ __name2(() => empty16, "emptyCase"),
  failCase: /* @__PURE__ */ __name2((_, error) => fail(error), "failCase"),
  dieCase: /* @__PURE__ */ __name2((_, defect) => die(defect), "dieCase"),
  interruptCase: /* @__PURE__ */ __name2((_, fiberId3) => interrupt(fiberId3), "interruptCase"),
  sequentialCase: /* @__PURE__ */ __name2((_, left3, right3) => {
    if (predicate(left3)) {
      if (predicate(right3)) {
  ...
  parallelCase: /* @__PURE__ */ __name2((_, left3, right3) => {
    if (predicate(left3)) {
      if (predicate(right3)) {
...
var match5 = /* @__PURE__ */ dual(2, (self, {
  ...
  return reduceWithContext(self, void 0, {
    emptyCase: /* @__PURE__ */ __name2(() => onEmpty, "emptyCase"),
    failCase: /* @__PURE__ */ __name2((_, error) => onFail(error), "failCase"),
    dieCase: /* @__PURE__ */ __name2((_, defect) => onDie(defect), "dieCase"),
    interruptCase: /* @__PURE__ */ __name2((_, fiberId3) => onInterrupt3(fiberId3), "interruptCase"),
    sequentialCase: /* @__PURE__ */ __name2((_, left3, right3) => onSequential(left3, right3), "sequentialCase"),
    parallelCase: /* @__PURE__ */ __name2((_, left3, right3) => onParallel(left3, right3), "parallelCase")
  });
});
...
var pretty = /* @__PURE__ */ __name2((cause3, options) => {
...
var renderErrorCause = /* @__PURE__ */ __name2((cause3, prefix) => {
...
var PrettyError = class _PrettyError extends globalThis.Error {
  static {
    __name(this, "_PrettyError");
  }
  static {
    __name2(this, "PrettyError");
  }
  span = void 0;
...
var prettyErrorMessage = /* @__PURE__ */ __name2((u) => {
  if (typeof u === "string") {
    return u;
  }
...
var prettyErrorStack = /* @__PURE__ */ __name2((message, stack, span4) => {
  const out = [message];
...
var prettyErrors = /* @__PURE__ */ __name2((cause3) => reduceWithContext(cause3, void 0, {
  emptyCase: /* @__PURE__ */ __name2(() => [], "emptyCase"),
  dieCase: /* @__PURE__ */ __name2((_, unknownError) => {
    return [new PrettyError(unknownError)];
  }, "dieCase"),
  failCase: /* @__PURE__ */ __name2((_, error) => {
    return [new PrettyError(error)];
  }, "failCase"),
  interruptCase: /* @__PURE__ */ __name2(() => [], "interruptCase"),
  parallelCase: /* @__PURE__ */ __name2((_, l, r) => [...l, ...r], "parallelCase"),
  sequentialCase: /* @__PURE__ */ __name2((_, l, r) => [...l, ...r], "sequentialCase")
}), "prettyErrors");
...
var pending = /* @__PURE__ */ __name2((joiners) => {
  return {
    _tag: OP_STATE_PENDING,
    joiners
  };
}, "pending");
var done = /* @__PURE__ */ __name2((effect2) => {
  return {
    _tag: OP_STATE_DONE,
    effect: effect2
  };
}, "done");
var SingleShotGen2 = class _SingleShotGen2 {
  static {
    __name(this, "_SingleShotGen");
  }
  static {
  ...
  [Symbol.iterator]() {
    return new _SingleShotGen2(this.self);
  }
};
var blocked = /* @__PURE__ */ __name2((blockedRequests, _continue3) => {
...
var runRequestBlock = /* @__PURE__ */ __name2((blockedRequests) => {
...
var EffectPrimitiveFailure = class {
  ...
  static {
    __name2(this, "EffectPrimitiveFailure");
  }
  _op;
  effect_instruction_i0 = void 0;
  effect_instruction_i1 = void 0;
...
var EffectPrimitiveSuccess = class {
  ...
  static {
    __name2(this, "EffectPrimitiveSuccess");
  }
  _op;
  effect_instruction_i0 = void 0;
  effect_instruction_i1 = void 0;
...
var isEffect = /* @__PURE__ */ __name2((u) => hasProperty(u, EffectTypeId2), "isEffect");
var withFiberRuntime = /* @__PURE__ */ __name2((withRuntime) => {
...
var acquireUseRelease = /* @__PURE__ */ dual(3, (acquire, use, release) => uninterruptibleMask((restore) => flatMap7(acquire, (a) => flatMap7(exit(suspend(() => restore(use(a)))), (exit4) => {
  return suspend(() => release(a, exit4)).pipe(matchCauseEffect({
    onFailure: /* @__PURE__ */ __name2((cause3) => {
      switch (exit4._tag) {
        case OP_FAILURE:
    ...
    onSuccess: /* @__PURE__ */ __name2(() => exit4, "onSuccess")
  }));
}))));
var as2 = /* @__PURE__ */ dual(2, (self, value) => flatMap7(self, () => succeed(value)));
var asVoid = /* @__PURE__ */ __name2((self) => as2(self, void 0), "asVoid");
var custom = /* @__PURE__ */ __name2(function() {
...
var unsafeAsync = /* @__PURE__ */ __name2((register2, blockingOn = none4) => {
...
var asyncInterrupt = /* @__PURE__ */ __name2((register2, blockingOn = none4) => suspend(() => unsafeAsync(register2, blockingOn)), "asyncInterrupt");
var async_ = /* @__PURE__ */ __name2((resume2, blockingOn = none4) => {
  return custom(resume2, function() {
    ...
    __name2(proxyResume, "proxyResume");
    const effect2 = new EffectPrimitive(OP_ASYNC);
...
var checkInterruptible = /* @__PURE__ */ __name2((f) => withFiberRuntime((_, status) => f(interruption(status.runtimeFlags))), "checkInterruptible");
var originalSymbol = /* @__PURE__ */ Symbol.for("effect/OriginalAnnotation");
var originalInstance = /* @__PURE__ */ __name2((obj) => {
  if (hasProperty(obj, originalSymbol)) {
    return obj[originalSymbol];
  }
  return obj;
}, "originalInstance");
var capture = /* @__PURE__ */ __name2((obj, span4) => {
  if (isSome2(span4)) {
...
var die2 = /* @__PURE__ */ __name2((defect) => isObject(defect) && !(spanSymbol in defect) ? withFiberRuntime((fiber) => failCause(die(capture(defect, currentSpanFromFiber(fiber))))) : failCause(die(defect)), "die");
var dieMessage = /* @__PURE__ */ __name2((message) => failCauseSync(() => die(new RuntimeException(message))), "dieMessage");
var dieSync = /* @__PURE__ */ __name2((evaluate2) => flatMap7(sync(evaluate2), die2), "dieSync");
var either2 = /* @__PURE__ */ __name2((self) => matchEffect(self, {
  onFailure: /* @__PURE__ */ __name2((e) => succeed(left2(e)), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((a) => succeed(right2(a)), "onSuccess")
}), "either");
var exit = /* @__PURE__ */ __name2((self) => matchCause(self, {
  onFailure: exitFailCause,
  onSuccess: exitSucceed
}), "exit");
var fail2 = /* @__PURE__ */ __name2((error) => isObject(error) && !(spanSymbol in error) ? withFiberRuntime((fiber) => failCause(fail(capture(error, currentSpanFromFiber(fiber))))) : failCause(fail(error)), "fail");
var failSync = /* @__PURE__ */ __name2((evaluate2) => flatMap7(sync(evaluate2), fail2), "failSync");
var failCause = /* @__PURE__ */ __name2((cause3) => {
  const effect2 = new EffectPrimitiveFailure(OP_FAILURE);
  effect2.effect_instruction_i0 = cause3;
  return effect2;
}, "failCause");
var failCauseSync = /* @__PURE__ */ __name2((evaluate2) => flatMap7(sync(evaluate2), failCause), "failCauseSync");
var fiberId = /* @__PURE__ */ withFiberRuntime((state) => succeed(state.id()));
var fiberIdWith = /* @__PURE__ */ __name2((f) => withFiberRuntime((state) => f(state.id())), "fiberIdWith");
...
var step2 = /* @__PURE__ */ __name2((self) => {
  const effect2 = new EffectPrimitive("OnStep");
  effect2.effect_instruction_i0 = self;
  return effect2;
}, "step");
var flatten4 = /* @__PURE__ */ __name2((self) => flatMap7(self, identity), "flatten");
var flip = /* @__PURE__ */ __name2((self) => matchEffect(self, {
  onFailure: succeed,
  onSuccess: fail2
}), "flip");
var matchCause = /* @__PURE__ */ dual(2, (self, options) => matchCauseEffect(self, {
  onFailure: /* @__PURE__ */ __name2((cause3) => succeed(options.onFailure(cause3)), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((a) => succeed(options.onSuccess(a)), "onSuccess")
}));
...
var forEachSequential = /* @__PURE__ */ dual(2, (self, f) => suspend(() => {
  ...
  return as2(whileLoop({
    while: /* @__PURE__ */ __name2(() => i < arr.length, "while"),
    body: /* @__PURE__ */ __name2(() => f(arr[i], i), "body"),
    step: /* @__PURE__ */ __name2((b) => {
      ret[i++] = b;
    }, "step")
  }), ret);
}));
...
var interruptWith = /* @__PURE__ */ __name2((fiberId3) => failCause(interrupt(fiberId3)), "interruptWith");
var interruptible2 = /* @__PURE__ */ __name2((self) => {
...
var interruptibleMask = /* @__PURE__ */ __name2((f) => custom(f, function() {
  const effect2 = new EffectPrimitive(OP_UPDATE_RUNTIME_FLAGS);
  effect2.effect_instruction_i0 = enable3(Interruption);
...
var mapBoth = /* @__PURE__ */ dual(2, (self, options) => matchEffect(self, {
  onFailure: /* @__PURE__ */ __name2((e) => failSync(() => options.onFailure(e)), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((a) => sync(() => options.onSuccess(a)), "onSuccess")
}));
...
var onExit = /* @__PURE__ */ dual(2, (self, cleanup) => uninterruptibleMask((restore) => matchCauseEffect(restore(self), {
  onFailure: /* @__PURE__ */ __name2((cause1) => {
    const result = exitFailCause(cause1);
    return matchCauseEffect(cleanup(result), {
      onFailure: /* @__PURE__ */ __name2((cause22) => exitFailCause(sequential(cause1, cause22)), "onFailure"),
      onSuccess: /* @__PURE__ */ __name2(() => result, "onSuccess")
    });
  }, "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((success) => {
    const result = exitSucceed(success);
    return zipRight(cleanup(result), result);
  }, "onSuccess")
})));
var onInterrupt = /* @__PURE__ */ dual(2, (self, cleanup) => onExit(self, exitMatch({
  onFailure: /* @__PURE__ */ __name2((cause3) => isInterruptedOnly(cause3) ? asVoid(cleanup(interruptors(cause3))) : void_, "onFailure"),
  onSuccess: /* @__PURE__ */ __name2(() => void_, "onSuccess")
})));
var orElse = /* @__PURE__ */ dual(2, (self, that) => attemptOrElse(self, that, succeed));
var orDie = /* @__PURE__ */ __name2((self) => orDieWith(self, identity), "orDie");
var orDieWith = /* @__PURE__ */ dual(2, (self, f) => matchEffect(self, {
  onFailure: /* @__PURE__ */ __name2((e) => die2(f(e)), "onFailure"),
  onSuccess: succeed
}));
var partitionMap2 = partitionMap;
var runtimeFlags = /* @__PURE__ */ withFiberRuntime((_, status) => succeed(status.runtimeFlags));
var succeed = /* @__PURE__ */ __name2((value) => {
  const effect2 = new EffectPrimitiveSuccess(OP_SUCCESS);
  effect2.effect_instruction_i0 = value;
  return effect2;
}, "succeed");
var suspend = /* @__PURE__ */ __name2((evaluate2) => {
  const effect2 = new EffectPrimitive(OP_COMMIT);
  effect2.commit = evaluate2;
  return effect2;
}, "suspend");
var sync = /* @__PURE__ */ __name2((thunk) => {
...
var transplant = /* @__PURE__ */ __name2((f) => withFiberRuntime((state) => {
...
var uninterruptible = /* @__PURE__ */ __name2((self) => {
  const effect2 = new EffectPrimitive(OP_UPDATE_RUNTIME_FLAGS);
  effect2.effect_instruction_i0 = disable3(Interruption);
  effect2.effect_instruction_i1 = () => self;
  return effect2;
}, "uninterruptible");
var uninterruptibleMask = /* @__PURE__ */ __name2((f) => custom(f, function() {
  const effect2 = new EffectPrimitive(OP_UPDATE_RUNTIME_FLAGS);
  effect2.effect_instruction_i0 = disable3(Interruption);
  effect2.effect_instruction_i1 = (oldFlags) => interruption(oldFlags) ? internalCall(() => this.effect_instruction_i0(interruptible2)) : internalCall(() => this.effect_instruction_i0(uninterruptible));
  return effect2;
...
var updateRuntimeFlags = /* @__PURE__ */ __name2((patch9) => {
  const effect2 = new EffectPrimitive(OP_UPDATE_RUNTIME_FLAGS);
...
var whileLoop = /* @__PURE__ */ __name2((options) => {
...
var fromIterator = /* @__PURE__ */ __name2((iterator) => suspend(() => {
  const effect2 = new EffectPrimitive(OP_ITERATOR);
  effect2.effect_instruction_i0 = iterator();
  return effect2;
}), "fromIterator");
var gen = /* @__PURE__ */ __name2(function() {
  const f = arguments.length === 1 ? arguments[0] : arguments[1].bind(arguments[0]);
  return fromIterator(() => f(pipe));
}, "gen");
var fnUntraced = /* @__PURE__ */ __name2((body, ...pipeables) => Object.defineProperty(pipeables.length === 0 ? function(...args2) {
...
var yieldNow = /* @__PURE__ */ __name2((options) => {
...
var interruptFiber = /* @__PURE__ */ __name2((self) => flatMap7(fiberId, (fiberId3) => pipe(self, interruptAsFiber(fiberId3))), "interruptFiber");
...
var fiberRefGet = /* @__PURE__ */ __name2((self) => withFiberRuntime((fiber) => exitSucceed(fiber.getFiberRef(self))), "fiberRefGet");
...
var RequestResolverImpl = class _RequestResolverImpl {
  static {
    __name(this, "_RequestResolverImpl");
  }
  static {
    __name2(this, "RequestResolverImpl");
  }
  runAll;
  target;
...
var isRequestResolver = /* @__PURE__ */ __name2((u) => hasProperty(u, RequestResolverTypeId), "isRequestResolver");
...
var fiberRefUnsafeMake = /* @__PURE__ */ __name2((initial, options) => fiberRefUnsafeMakePatch(initial, {
  differ: update(),
  fork: options?.fork ?? identity,
  join: options?.join
}), "fiberRefUnsafeMake");
var fiberRefUnsafeMakeHashSet = /* @__PURE__ */ __name2((initial) => {
...
var fiberRefUnsafeMakeReadonlyArray = /* @__PURE__ */ __name2((initial) => {
...
var fiberRefUnsafeMakeContext = /* @__PURE__ */ __name2((initial) => {
...
var fiberRefUnsafeMakePatch = /* @__PURE__ */ __name2((initial, options) => {
  const _fiberRef = {
    ...CommitPrototype,
    ...
    diff: /* @__PURE__ */ __name2((oldValue, newValue) => options.differ.diff(oldValue, newValue), "diff"),
    combine: /* @__PURE__ */ __name2((first2, second) => options.differ.combine(first2, second), "combine"),
    patch: /* @__PURE__ */ __name2((patch9) => (oldValue) => options.differ.patch(patch9, oldValue), "patch"),
    fork: options.fork,
    join: options.join ?? ((_, n) => n)
  };
  return _fiberRef;
}, "fiberRefUnsafeMakePatch");
var fiberRefUnsafeMakeRuntimeFlags = /* @__PURE__ */ __name2((initial) => fiberRefUnsafeMakePatch(initial, {
  differ,
  fork: differ.empty
...
var currentForkScopeOverride = /* @__PURE__ */ globalValue(/* @__PURE__ */ Symbol.for("effect/FiberRef/currentForkScopeOverride"), () => fiberRefUnsafeMake(none2(), {
  fork: /* @__PURE__ */ __name2(() => none2(), "fork"),
  join: /* @__PURE__ */ __name2((parent, _) => parent, "join")
}));
var currentInterruptedCause = /* @__PURE__ */ globalValue(/* @__PURE__ */ Symbol.for("effect/FiberRef/currentInterruptedCause"), () => fiberRefUnsafeMake(empty16, {
  fork: /* @__PURE__ */ __name2(() => empty16, "fork"),
  join: /* @__PURE__ */ __name2((parent, _) => parent, "join")
}));
...
var scopeAddFinalizer = /* @__PURE__ */ __name2((self, finalizer) => self.addFinalizer(() => asVoid(finalizer)), "scopeAddFinalizer");
var scopeAddFinalizerExit = /* @__PURE__ */ __name2((self, finalizer) => self.addFinalizer(finalizer), "scopeAddFinalizerExit");
var scopeClose = /* @__PURE__ */ __name2((self, exit4) => self.close(exit4), "scopeClose");
var scopeFork = /* @__PURE__ */ __name2((self, strategy) => self.fork(strategy), "scopeFork");
var causeSquash = /* @__PURE__ */ __name2((self) => {
...
var YieldableError = /* @__PURE__ */ function() {
  class YieldableError3 extends globalThis.Error {
    static {
      __name(this, "YieldableError3");
    }
    static {
      __name2(this, "YieldableError");
    }
    commit() {
      return fail2(this);
    }
...
var makeException = /* @__PURE__ */ __name2((proto4, tag) => {
...
var isRuntimeException = /* @__PURE__ */ __name2((u) => hasProperty(u, RuntimeExceptionTypeId), "isRuntimeException");
var InterruptedExceptionTypeId = /* @__PURE__ */ Symbol.for("effect/Cause/errors/InterruptedException");
var InterruptedException = /* @__PURE__ */ makeException({
  [InterruptedExceptionTypeId]: InterruptedExceptionTypeId
}, "InterruptedException");
var isInterruptedException = /* @__PURE__ */ __name2((u) => hasProperty(u, InterruptedExceptionTypeId), "isInterruptedException");
var IllegalArgumentExceptionTypeId = /* @__PURE__ */ Symbol.for("effect/Cause/errors/IllegalArgument");
var IllegalArgumentException = /* @__PURE__ */ makeException({
  [IllegalArgumentExceptionTypeId]: IllegalArgumentExceptionTypeId
}, "IllegalArgumentException");
var isIllegalArgumentException = /* @__PURE__ */ __name2((u) => hasProperty(u, IllegalArgumentExceptionTypeId), "isIllegalArgumentException");
var NoSuchElementExceptionTypeId = /* @__PURE__ */ Symbol.for("effect/Cause/errors/NoSuchElement");
var NoSuchElementException = /* @__PURE__ */ makeException({
  [NoSuchElementExceptionTypeId]: NoSuchElementExceptionTypeId
}, "NoSuchElementException");
var isNoSuchElementException = /* @__PURE__ */ __name2((u) => hasProperty(u, NoSuchElementExceptionTypeId), "isNoSuchElementException");
...
var isExceededCapacityException = /* @__PURE__ */ __name2((u) => hasProperty(u, ExceededCapacityExceptionTypeId), "isExceededCapacityException");
var TimeoutExceptionTypeId = /* @__PURE__ */ Symbol.for("effect/Cause/errors/Timeout");
var TimeoutException = /* @__PURE__ */ makeException({
  [TimeoutExceptionTypeId]: TimeoutExceptionTypeId
}, "TimeoutException");
var timeoutExceptionFromDuration = /* @__PURE__ */ __name2((duration) => new TimeoutException(`Operation timed out after '${format2(duration)}'`), "timeoutExceptionFromDuration");
var isTimeoutException = /* @__PURE__ */ __name2((u) => hasProperty(u, TimeoutExceptionTypeId), "isTimeoutException");
var UnknownExceptionTypeId = /* @__PURE__ */ Symbol.for("effect/Cause/errors/UnknownException");
var UnknownException = /* @__PURE__ */ function() {
  class UnknownException3 extends YieldableError {
    static {
      __name(this, "UnknownException3");
    }
    static {
      __name2(this, "UnknownException");
    }
...
var isUnknownException = /* @__PURE__ */ __name2((u) => hasProperty(u, UnknownExceptionTypeId), "isUnknownException");
var exitIsExit = /* @__PURE__ */ __name2((u) => isEffect(u) && "_tag" in u && (u._tag === "Success" || u._tag === "Failure"), "exitIsExit");
var exitIsFailure = /* @__PURE__ */ __name2((self) => self._tag === "Failure", "exitIsFailure");
var exitIsSuccess = /* @__PURE__ */ __name2((self) => self._tag === "Success", "exitIsSuccess");
var exitIsInterrupted = /* @__PURE__ */ __name2((self) => {
  switch (self._tag) {
    case OP_FAILURE:
...
var exitAsVoid = /* @__PURE__ */ __name2((self) => exitAs(self, void 0), "exitAsVoid");
var exitCauseOption = /* @__PURE__ */ __name2((self) => {
  switch (self._tag) {
    case OP_FAILURE:
...
var exitCollectAll = /* @__PURE__ */ __name2((exits, options) => exitCollectAllInternal(exits, options?.parallel ? parallel : sequential), "exitCollectAll");
var exitDie = /* @__PURE__ */ __name2((defect) => exitFailCause(die(defect)), "exitDie");
...
var exitFail = /* @__PURE__ */ __name2((error) => exitFailCause(fail(error)), "exitFail");
var exitFailCause = /* @__PURE__ */ __name2((cause3) => {
  const effect2 = new EffectPrimitiveFailure(OP_FAILURE);
  effect2.effect_instruction_i0 = cause3;
  return effect2;
}, "exitFailCause");
...
var exitFlatten = /* @__PURE__ */ __name2((self) => pipe(self, exitFlatMap(identity)), "exitFlatten");
...
var exitFromEither = /* @__PURE__ */ __name2((either4) => {
  switch (either4._tag) {
    case "Left":
...
var exitFromOption = /* @__PURE__ */ __name2((option3) => {
  switch (option3._tag) {
    case "None":
...
var exitInterrupt = /* @__PURE__ */ __name2((fiberId3) => exitFailCause(interrupt(fiberId3)), "exitInterrupt");
...
var exitSucceed = /* @__PURE__ */ __name2((value) => {
  const effect2 = new EffectPrimitiveSuccess(OP_SUCCESS);
  effect2.effect_instruction_i0 = value;
  return effect2;
}, "exitSucceed");
...
var exitZip = /* @__PURE__ */ dual(2, (self, that) => exitZipWith(self, that, {
  onSuccess: /* @__PURE__ */ __name2((a, a2) => [a, a2], "onSuccess"),
  onFailure: sequential
}));
var exitZipLeft = /* @__PURE__ */ dual(2, (self, that) => exitZipWith(self, that, {
  onSuccess: /* @__PURE__ */ __name2((a, _) => a, "onSuccess"),
  onFailure: sequential
}));
var exitZipRight = /* @__PURE__ */ dual(2, (self, that) => exitZipWith(self, that, {
  onSuccess: /* @__PURE__ */ __name2((_, a2) => a2, "onSuccess"),
  onFailure: sequential
}));
...
var exitCollectAllInternal = /* @__PURE__ */ __name2((exits, combineCauses) => {
  ...
  return pipe(tailNonEmpty2(list), reduce(pipe(headNonEmpty2(list), exitMap(of2)), (accumulator, current) => pipe(accumulator, exitZipWith(current, {
    onSuccess: /* @__PURE__ */ __name2((list2, value) => pipe(list2, prepend2(value)), "onSuccess"),
    onFailure: combineCauses
  }))), exitMap(reverse2), exitMap((chunk2) => toReadonlyArray(chunk2)), some2);
}, "exitCollectAllInternal");
var deferredUnsafeMake = /* @__PURE__ */ __name2((fiberId3) => {
  const _deferred = {
    ...CommitPrototype,
...
var deferredMake = /* @__PURE__ */ __name2(() => flatMap7(fiberId, (id) => deferredMakeAs(id)), "deferredMake");
var deferredMakeAs = /* @__PURE__ */ __name2((fiberId3) => sync(() => deferredUnsafeMake(fiberId3)), "deferredMakeAs");
var deferredAwait = /* @__PURE__ */ __name2((self) => asyncInterrupt((resume2) => {
...
var deferredInterrupt = /* @__PURE__ */ __name2((self) => flatMap7(fiberId, (fiberId3) => deferredCompleteWith(self, interruptWith(fiberId3))), "deferredInterrupt");
var deferredSucceed = /* @__PURE__ */ dual(2, (self, value) => deferredCompleteWith(self, succeed(value)));
var deferredUnsafeDone = /* @__PURE__ */ __name2((self, effect2) => {
  const state = get6(self.state);
...
var deferredInterruptJoiner = /* @__PURE__ */ __name2((self, joiner) => sync(() => {
  const state = get6(self.state);
  if (state._tag === OP_STATE_PENDING) {
...
var context = /* @__PURE__ */ __name2(() => constContext, "context");
var contextWithEffect = /* @__PURE__ */ __name2((f) => flatMap7(context(), f), "contextWithEffect");
...
var filterEffectOrFail = /* @__PURE__ */ dual(2, (self, options) => filterEffectOrElse(self, {
  ...
  orElse: /* @__PURE__ */ __name2((a) => fail2(options.orFailWith(a)), "orElse")
}));
var currentSpanFromFiber = /* @__PURE__ */ __name2((fiber) => {
...
var noopSpan = /* @__PURE__ */ __name2((options) => Object.assign(Object.create(NoopSpanProto), options), "noopSpan");
...
__export(Exit_exports, {
  all: /* @__PURE__ */ __name(() => all, "all"),
  as: /* @__PURE__ */ __name(() => as3, "as"),
  asVoid: /* @__PURE__ */ __name(() => asVoid2, "asVoid"),
  causeOption: /* @__PURE__ */ __name(() => causeOption, "causeOption"),
  die: /* @__PURE__ */ __name(() => die3, "die"),
  exists: /* @__PURE__ */ __name(() => exists, "exists"),
  fail: /* @__PURE__ */ __name(() => fail3, "fail"),
  failCause: /* @__PURE__ */ __name(() => failCause2, "failCause"),
  flatMap: /* @__PURE__ */ __name(() => flatMap8, "flatMap"),
  flatMapEffect: /* @__PURE__ */ __name(() => flatMapEffect, "flatMapEffect"),
  flatten: /* @__PURE__ */ __name(() => flatten5, "flatten"),
  forEachEffect: /* @__PURE__ */ __name(() => forEachEffect, "forEachEffect"),
  fromEither: /* @__PURE__ */ __name(() => fromEither, "fromEither"),
  fromOption: /* @__PURE__ */ __name(() => fromOption2, "fromOption"),
  getOrElse: /* @__PURE__ */ __name(() => getOrElse5, "getOrElse"),
  interrupt: /* @__PURE__ */ __name(() => interrupt4, "interrupt"),
  isExit: /* @__PURE__ */ __name(() => isExit, "isExit"),
  isFailure: /* @__PURE__ */ __name(() => isFailure2, "isFailure"),
  isInterrupted: /* @__PURE__ */ __name(() => isInterrupted2, "isInterrupted"),
  isSuccess: /* @__PURE__ */ __name(() => isSuccess, "isSuccess"),
  map: /* @__PURE__ */ __name(() => map9, "map"),
  mapBoth: /* @__PURE__ */ __name(() => mapBoth2, "mapBoth"),
  mapError: /* @__PURE__ */ __name(() => mapError2, "mapError"),
  mapErrorCause: /* @__PURE__ */ __name(() => mapErrorCause, "mapErrorCause"),
  match: /* @__PURE__ */ __name(() => match6, "match"),
  matchEffect: /* @__PURE__ */ __name(() => matchEffect2, "matchEffect"),
  succeed: /* @__PURE__ */ __name(() => succeed2, "succeed"),
  void: /* @__PURE__ */ __name(() => void_2, "void"),
  zip: /* @__PURE__ */ __name(() => zip3, "zip"),
  zipLeft: /* @__PURE__ */ __name(() => zipLeft2, "zipLeft"),
  zipPar: /* @__PURE__ */ __name(() => zipPar, "zipPar"),
  zipParLeft: /* @__PURE__ */ __name(() => zipParLeft, "zipParLeft"),
  zipParRight: /* @__PURE__ */ __name(() => zipParRight, "zipParRight"),
  zipRight: /* @__PURE__ */ __name(() => zipRight2, "zipRight"),
  zipWith: /* @__PURE__ */ __name(() => zipWith3, "zipWith")
});
...
var MutableHashMapIterator = class _MutableHashMapIterator {
  static {
    __name(this, "_MutableHashMapIterator");
  }
  static {
    __name2(this, "MutableHashMapIterator");
  }
  self;
  referentialIterator;
  bucketIterator;
...
var getFromBucket = /* @__PURE__ */ __name2((self, bucket, key, remove8 = false) => {
...
var removeFromBucket = /* @__PURE__ */ __name2((self, bucket, key) => {
  for (let i = 0, len = bucket.length; i < len; i++) {
    if (key[symbol2](bucket[i][0])) {
      bucket.splice(i, 1);
      self.bucketsSize--;
...
var size5 = /* @__PURE__ */ __name2((self) => {
...
var makeNode = /* @__PURE__ */ __name2((value) => ({
  value,
  removed: false,
  prev: void 0,
  next: void 0
}), "makeNode");
var empty18 = /* @__PURE__ */ __name2(() => {
...
var isEmpty6 = /* @__PURE__ */ __name2((self) => length(self) === 0, "isEmpty");
var length = /* @__PURE__ */ __name2((self) => self._length, "length");
...
var shift = /* @__PURE__ */ __name2((self) => {
...
var remove6 = /* @__PURE__ */ __name2((self, node) => {
  if (node.removed) {
    return;
  }
  node.removed = true;
...
var make18 = /* @__PURE__ */ __name2((capacity) => {
  const queue = Object.create(MutableQueueProto);
  queue.queue = empty18();
  queue.capacity = capacity;
  return queue;
}, "make");
var unbounded = /* @__PURE__ */ __name2(() => make18(void 0), "unbounded");
...
var make19 = /* @__PURE__ */ __name2(() => new ClockImpl(), "make");
var OP_AND = "And";
var OP_OR = "Or";
...
var And = /* @__PURE__ */ __name2((self, that) => {
...
var Or = /* @__PURE__ */ __name2((self, that) => {
  const error = Object.create(proto2);
  error._op = OP_OR;
  error.left = self;
  error.right = that;
...
var InvalidData = /* @__PURE__ */ __name2((path, message, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var MissingData = /* @__PURE__ */ __name2((path, message, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var SourceUnavailable = /* @__PURE__ */ __name2((path, message, cause3, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var Unsupported = /* @__PURE__ */ __name2((path, message, options = {
  pathDelim: "."
}) => {
  const error = Object.create(proto2);
...
var concat = /* @__PURE__ */ __name2((l, r) => [...l, ...r], "concat");
var ConfigProviderSymbolKey = "effect/ConfigProvider";
var ConfigProviderTypeId = /* @__PURE__ */ Symbol.for(ConfigProviderSymbolKey);
var configProviderTag = /* @__PURE__ */ GenericTag("effect/ConfigProvider");
var FlatConfigProviderSymbolKey = "effect/ConfigProviderFlat";
var FlatConfigProviderTypeId = /* @__PURE__ */ Symbol.for(FlatConfigProviderSymbolKey);
var make21 = /* @__PURE__ */ __name2((options) => ({
...
var makeFlat = /* @__PURE__ */ __name2((options) => ({
  [FlatConfigProviderTypeId]: FlatConfigProviderTypeId,
  patch: options.patch,
  load: /* @__PURE__ */ __name2((path, config, split = true) => options.load(path, config, split), "load"),
  enumerateChildren: options.enumerateChildren
}), "makeFlat");
var fromFlat = /* @__PURE__ */ __name2((flat) => make21({
  load: /* @__PURE__ */ __name2((config) => flatMap7(fromFlatLoop(flat, empty(), config, false), (chunk2) => match3(head(chunk2), {
    onNone: /* @__PURE__ */ __name2(() => fail2(MissingData(empty(), `Expected a single value having structure: ${config}`)), "onNone"),
    onSome: succeed
  })), "load"),
  flattened: flat
}), "fromFlat");
var fromEnv = /* @__PURE__ */ __name2((options) => {
  const {
    pathDelim,
    seqDelim
  } = Object.assign({}, {
  ...
  const makePathString = /* @__PURE__ */ __name2((path) => pipe(path, join(pathDelim)), "makePathString");
  const unmakePathString = /* @__PURE__ */ __name2((pathString) => pathString.split(pathDelim), "unmakePathString");
  const getEnv = /* @__PURE__ */ __name2(() => typeof process !== "undefined" && "env" in process && typeof process.env === "object" ? process.env : {}, "getEnv");
  const load = /* @__PURE__ */ __name2((path, primitive, split = true) => {
  ...
  const enumerateChildren = /* @__PURE__ */ __name2((path) => sync(() => {
    const current = getEnv();
...
var extend = /* @__PURE__ */ __name2((leftDef, rightDef, left3, right3) => {
...
var appendConfigPath = /* @__PURE__ */ __name2((path, config) => {
  let op = config;
  if (op._tag === "Nested") {
...
var fromFlatLoop = /* @__PURE__ */ __name2((flat, prefix, config, split) => {
  const op = config;
  switch (op._tag) {
    case OP_CONSTANT: {
...
var fromFlatLoopFail = /* @__PURE__ */ __name2((prefix, path) => (index) => left2(MissingData(prefix, `The element at index ${index} in a sequence at path "${path}" was missing`)), "fromFlatLoopFail");
var splitPathString = /* @__PURE__ */ __name2((text, delim) => {
  const split = text.split(new RegExp(`\\s*${escape(delim)}\\s*`));
  return split;
}, "splitPathString");
var parsePrimitive = /* @__PURE__ */ __name2((text, path, primitive, delimiter, split) => {
  if (!split) {
...
var transpose = /* @__PURE__ */ __name2((array4) => {
  return Object.keys(array4[0]).map((column) => array4.map((row) => row[column]));
}, "transpose");
var indicesFrom = /* @__PURE__ */ __name2((quotedIndices) => pipe(forEachSequential(quotedIndices, parseQuotedIndex), mapBoth({
  onFailure: /* @__PURE__ */ __name2(() => empty(), "onFailure"),
  onSuccess: sort(Order)
}), either2, map8(merge)), "indicesFrom");
var QUOTED_INDEX_REGEX = /^(\[(\d+)\])$/;
var parseQuotedIndex = /* @__PURE__ */ __name2((str) => {
...
var parseInteger = /* @__PURE__ */ __name2((str) => {
...
var shuffleWith = /* @__PURE__ */ __name2((elements, nextIntBounded) => {
...
var swap = /* @__PURE__ */ __name2((buffer, index1, index2) => {
  const tmp = buffer[index1];
  buffer[index1] = buffer[index2];
  buffer[index2] = tmp;
  return buffer;
}, "swap");
var make22 = /* @__PURE__ */ __name2((seed) => new RandomImpl(hash(seed)), "make");
var FixedRandomImpl = class {
  static {
    __name(this, "FixedRandomImpl");
  }
  static {
    __name2(this, "FixedRandomImpl");
  }
  values;
  [RandomTypeId] = RandomTypeId;
  index = 0;
...
var fixed = /* @__PURE__ */ __name2((values3) => new FixedRandomImpl(values3), "fixed");
var TracerTypeId = /* @__PURE__ */ Symbol.for("effect/Tracer");
var make23 = /* @__PURE__ */ __name2((options) => ({
...
var nativeTracer = /* @__PURE__ */ make23({
  span: /* @__PURE__ */ __name2((name, parent, context5, links, startTime, kind) => new NativeSpan(name, parent, context5, links, startTime, kind), "span"),
  context: /* @__PURE__ */ __name2((f) => f(), "context")
});
var addSpanStackTrace = /* @__PURE__ */ __name2((options) => {
  ...
  return {
    ...options,
    captureStackTrace: /* @__PURE__ */ __name2(() => {
      if (cache !== false) {
        return cache;
      }
...
var sleep = /* @__PURE__ */ __name2((duration) => {
  const decodedDuration = decode3(duration);
  return clockWith((clock3) => clock3.sleep(decodedDuration));
}, "sleep");
var defaultServicesWith = /* @__PURE__ */ __name2((f) => withFiberRuntime((fiber) => f(fiber.currentDefaultServices)), "defaultServicesWith");
var clockWith = /* @__PURE__ */ __name2((f) => defaultServicesWith((services) => f(services.unsafeMap.get(clockTag.key))), "clockWith");
...
var configProviderWith = /* @__PURE__ */ __name2((f) => defaultServicesWith((services) => f(services.unsafeMap.get(configProviderTag.key))), "configProviderWith");
var randomWith = /* @__PURE__ */ __name2((f) => defaultServicesWith((services) => f(services.unsafeMap.get(randomTag.key))), "randomWith");
var withRandom = /* @__PURE__ */ dual(2, (effect2, value) => fiberRefLocallyWith(currentServices, add2(randomTag, value))(effect2));
var tracerWith = /* @__PURE__ */ __name2((f) => defaultServicesWith((services) => f(services.unsafeMap.get(tracerTag.key))), "tracerWith");
...
__name(unsafeMake5, "unsafeMake5");
__name2(unsafeMake5, "unsafeMake");
function empty20() {
  return unsafeMake5(/* @__PURE__ */ new Map());
}
__name(empty20, "empty20");
__name2(empty20, "empty");
...
var findAncestor = /* @__PURE__ */ __name2((_ref, _parentStack, _childStack, _childModified = false) => {
  const ref = _ref;
...
var unsafeForkAs = /* @__PURE__ */ __name2((self, map16, fiberId3) => {
...
var fiberRefs = /* @__PURE__ */ __name2((self) => fromIterable5(self.locals.keys()), "fiberRefs");
var setAll = /* @__PURE__ */ __name2((self) => forEachSequentialDiscard(fiberRefs(self), (fiberRef) => fiberRefSet(fiberRef, getOrDefault(self, fiberRef))), "setAll");
...
var unsafeUpdateAs = /* @__PURE__ */ __name2((locals, fiberId3, fiberRef, value) => {
...
var fromLiteral = /* @__PURE__ */ __name2((literal) => {
  switch (literal) {
    case "All":
      return All;
    case "Debug":
...
var make24 = /* @__PURE__ */ __name2((label, startTime) => ({
  label,
  startTime
}), "make");
var formatLabel = /* @__PURE__ */ __name2((key) => key.replace(/[\s="]/g, "_"), "formatLabel");
var render = /* @__PURE__ */ __name2((now) => (self) => {
...
var unsafeMake6 = /* @__PURE__ */ __name2((value) => new RefImpl(make11(value)), "unsafeMake");
var make26 = /* @__PURE__ */ __name2((value) => sync(() => unsafeMake6(value)), "make");
var get11 = /* @__PURE__ */ __name2((self) => self.get, "get");
...
var diff5 = /* @__PURE__ */ __name2((oldValue, newValue) => {
...
var make28 = /* @__PURE__ */ __name2((key, value) => {
  return new MetricLabelImpl(key, value);
}, "make");
var isMetricLabel = /* @__PURE__ */ __name2((u) => hasProperty(u, MetricLabelTypeId), "isMetricLabel");
...
var asSome = /* @__PURE__ */ __name2((self) => map8(self, some2), "asSome");
var asSomeError = /* @__PURE__ */ __name2((self) => mapError(self, some2), "asSomeError");
var try_ = /* @__PURE__ */ __name2((arg) => {
  let evaluate2;
...
var cause = /* @__PURE__ */ __name2((self) => matchCause(self, {
  onFailure: identity,
  onSuccess: /* @__PURE__ */ __name2(() => empty16, "onSuccess")
}), "cause");
var clockWith3 = clockWith2;
var clock = /* @__PURE__ */ clockWith3(succeed);
var delay = /* @__PURE__ */ dual(2, (self, duration) => zipRight(sleep2(duration), self));
var descriptorWith = /* @__PURE__ */ __name2((f) => withFiberRuntime((state, status) => f({
  id: state.id(),
  status,
...
var diffFiberRefs = /* @__PURE__ */ __name2((self) => summarized(self, fiberRefs2, diff5), "diffFiberRefs");
var diffFiberRefsAndRuntimeFlags = /* @__PURE__ */ __name2((self) => summarized(self, zip2(fiberRefs2, runtimeFlags), ([refs, flags2], [refsNew, flagsNew]) => [diff5(refs, refsNew), diff4(flags2, flagsNew)]), "diffFiberRefsAndRuntimeFlags");
...
var contextWith = /* @__PURE__ */ __name2((f) => map8(context(), f), "contextWith");
var eventually = /* @__PURE__ */ __name2((self) => orElse(self, () => flatMap7(yieldNow(), () => eventually(self))), "eventually");
...
var findLoop = /* @__PURE__ */ __name2((iterator, index, f, value) => flatMap7(f(value, index), (result) => {
  if (result) {
...
var firstSuccessOf = /* @__PURE__ */ __name2((effects) => suspend(() => {
...
var head3 = /* @__PURE__ */ __name2((self) => flatMap7(self, (as7) => {
...
var ignore = /* @__PURE__ */ __name2((self) => match8(self, {
  onFailure: constVoid,
  onSuccess: constVoid
}), "ignore");
var ignoreLogged = /* @__PURE__ */ __name2((self) => matchCauseEffect(self, {
  onFailure: /* @__PURE__ */ __name2((cause3) => logDebug(cause3, "An error was silently ignored because it is not anticipated to be useful"), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2(() => void_, "onSuccess")
}), "ignoreLogged");
var inheritFiberRefs = /* @__PURE__ */ __name2((childFiberRefs) => updateFiberRefs((parentFiberId, parentFiberRefs) => joinAs2(parentFiberRefs, parentFiberId, childFiberRefs)), "inheritFiberRefs");
var isFailure3 = /* @__PURE__ */ __name2((self) => match8(self, {
  onFailure: constTrue,
  onSuccess: constFalse
}), "isFailure");
var isSuccess2 = /* @__PURE__ */ __name2((self) => match8(self, {
  onFailure: constFalse,
  onSuccess: constTrue
}), "isSuccess");
var iterate = /* @__PURE__ */ __name2((initial, options) => suspend(() => {
  if (options.while(initial)) {
    return flatMap7(options.body(initial), (z2) => iterate(z2, options));
  }
  return succeed(initial);
}), "iterate");
var logWithLevel = /* @__PURE__ */ __name2((level) => (...message) => {
...
var loop = /* @__PURE__ */ __name2((initial, options) => options.discard ? loopDiscard(initial, options.while, options.step, options.body) : map8(loopInternal(initial, options.while, options.step, options.body), fromIterable), "loop");
var loopInternal = /* @__PURE__ */ __name2((initial, cont, inc, body) => suspend(() => cont(initial) ? flatMap7(body(initial), (a) => map8(loopInternal(inc(initial), cont, inc, body), prepend3(a))) : sync(() => empty9())), "loopInternal");
var loopDiscard = /* @__PURE__ */ __name2((initial, cont, inc, body) => suspend(() => cont(initial) ? flatMap7(body(initial), () => loopDiscard(inc(initial), cont, inc, body)) : void_), "loopDiscard");
...
var mapErrorCause2 = /* @__PURE__ */ dual(2, (self, f) => matchCauseEffect(self, {
  onFailure: /* @__PURE__ */ __name2((c) => failCauseSync(() => f(c)), "onFailure"),
  onSuccess: succeed
}));
var memoize = /* @__PURE__ */ __name2((self) => pipe(deferredMake(), flatMap7((deferred) => pipe(diffFiberRefsAndRuntimeFlags(self), intoDeferred(deferred), once, map8((complete3) => zipRight(complete3, pipe(deferredAwait(deferred), flatMap7(([patch9, a]) => as2(zip2(patchFiberRefs(patch9[0]), updateRuntimeFlags(patch9[1])), a)))))))), "memoize");
var merge5 = /* @__PURE__ */ __name2((self) => matchEffect(self, {
  onFailure: /* @__PURE__ */ __name2((e) => succeed(e), "onFailure"),
  onSuccess: succeed
}), "merge");
var negate = /* @__PURE__ */ __name2((self) => map8(self, (b) => !b), "negate");
var none6 = /* @__PURE__ */ __name2((self) => flatMap7(self, (option3) => {
  switch (option3._tag) {
    case "None":
      return void_;
    case "Some":
...
var once = /* @__PURE__ */ __name2((self) => map8(make27(true), (ref) => asVoid(whenEffect(self, getAndSet2(ref, false)))), "once");
var option = /* @__PURE__ */ __name2((self) => matchEffect(self, {
  onFailure: /* @__PURE__ */ __name2(() => succeed(none2()), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((a) => succeed(some2(a)), "onSuccess")
}), "option");
...
var parallelErrors = /* @__PURE__ */ __name2((self) => matchCauseEffect(self, {
  onFailure: /* @__PURE__ */ __name2((cause3) => {
...
var patchFiberRefs = /* @__PURE__ */ __name2((patch9) => updateFiberRefs((fiberId3, fiberRefs3) => pipe(patch9, patch6(fiberId3, fiberRefs3))), "patchFiberRefs");
var promise = /* @__PURE__ */ __name2((evaluate2) => evaluate2.length >= 1 ? async_((resolve, signal) => {
  try {
...
var reduceWhileLoop = /* @__PURE__ */ __name2((iterator, index, state, predicate, f) => {
  const next = iterator.next();
...
var repeatNLoop = /* @__PURE__ */ __name2((self, n) => flatMap7(self, (a) => n <= 0 ? succeed(a) : zipRight(yieldNow(), repeatNLoop(self, n - 1))), "repeatNLoop");
var sandbox = /* @__PURE__ */ __name2((self) => matchCauseEffect(self, {
  onFailure: fail2,
  onSuccess: succeed
}), "sandbox");
var setFiberRefs = /* @__PURE__ */ __name2((fiberRefs3) => suspend(() => setAll2(fiberRefs3)), "setFiberRefs");
var sleep3 = sleep2;
var succeedNone = /* @__PURE__ */ succeed(/* @__PURE__ */ none2());
var succeedSome = /* @__PURE__ */ __name2((value) => succeed(some2(value)), "succeedSome");
...
var tapBoth = /* @__PURE__ */ dual(2, (self, {
  ...
  onSuccess: /* @__PURE__ */ __name2((a) => as2(onSuccess(a), a), "onSuccess")
}));
var tapDefect = /* @__PURE__ */ dual(2, (self, f) => catchAllCause(self, (cause3) => match3(keepDefects(cause3), {
  onNone: /* @__PURE__ */ __name2(() => failCause(cause3), "onNone"),
  onSome: /* @__PURE__ */ __name2((a) => zipRight(f(a), failCause(cause3)), "onSome")
})));
...
var tapErrorCause = /* @__PURE__ */ dual(2, (self, f) => matchCauseEffect(self, {
  onFailure: /* @__PURE__ */ __name2((cause3) => zipRight(f(cause3), failCause(cause3)), "onFailure"),
  onSuccess: succeed
}));
var timed = /* @__PURE__ */ __name2((self) => timedWith(self, currentTimeNanos2), "timed");
...
var tryPromise = /* @__PURE__ */ __name2((arg) => {
  let evaluate2;
  let catcher = void 0;
  if (typeof arg === "function") {
    evaluate2 = arg;
  ...
  const fail9 = /* @__PURE__ */ __name2((e) => catcher ? failSync(() => catcher(e)) : fail2(new UnknownException(e, "An unknown error occurred in Effect.tryPromise")), "fail");
...
var tryMap = /* @__PURE__ */ dual(2, (self, options) => flatMap7(self, (a) => try_({
  try: /* @__PURE__ */ __name2(() => options.try(a), "try"),
  catch: options.catch
})));
...
var unsandbox = /* @__PURE__ */ __name2((self) => mapErrorCause2(self, flatten3), "unsandbox");
var updateFiberRefs = /* @__PURE__ */ __name2((f) => withFiberRuntime((state) => {
...
var serviceFunctionEffect = /* @__PURE__ */ __name2((getService, f) => (...args2) => flatMap7(getService, (a) => f(a)(...args2)), "serviceFunctionEffect");
var serviceFunction = /* @__PURE__ */ __name2((getService, f) => (...args2) => map8(getService, (a) => f(a)(...args2)), "serviceFunction");
var serviceFunctions = /* @__PURE__ */ __name2((getService) => new Proxy({}, {
  get(_target, prop, _receiver) {
    return (...args2) => flatMap7(getService, (s) => s[prop](...args2));
  }
}), "serviceFunctions");
var serviceConstants = /* @__PURE__ */ __name2((getService) => new Proxy({}, {
  get(_target, prop, _receiver) {
    return flatMap7(getService, (s) => isEffect(s[prop]) ? s[prop] : succeed(s[prop]));
  }
}), "serviceConstants");
var serviceMembers = /* @__PURE__ */ __name2((getService) => ({
  functions: serviceFunctions(getService),
  constants: serviceConstants(getService)
}), "serviceMembers");
var serviceOption = /* @__PURE__ */ __name2((tag) => map8(context(), getOption2(tag)), "serviceOption");
var serviceOptional = /* @__PURE__ */ __name2((tag) => flatMap7(context(), getOption2(tag)), "serviceOptional");
var annotateCurrentSpan = /* @__PURE__ */ __name2(function() {
  const args2 = arguments;
...
var linkSpanCurrent = /* @__PURE__ */ __name2(function() {
  const args2 = arguments;
...
var unsafeMakeSpan = /* @__PURE__ */ __name2((fiber, name, options) => {
...
var makeSpan = /* @__PURE__ */ __name2((name, options) => {
...
var endSpan = /* @__PURE__ */ __name2((span4, exit4, clock3, timingEnabled) => sync(() => {
...
var useSpan = /* @__PURE__ */ __name2((name, ...args2) => {
...
var withSpan = /* @__PURE__ */ __name2(function() {
...
var functionWithSpan = /* @__PURE__ */ __name2((options) => function() {
...
var fromNullable2 = /* @__PURE__ */ __name2((value) => value == null ? fail2(new NoSuchElementException()) : succeed(value), "fromNullable");
var optionFromOptional = /* @__PURE__ */ __name2((self) => catchAll(map8(self, some2), (error) => isNoSuchElementException(error) ? succeedNone : fail2(error)), "optionFromOptional");
...
var parallelN = /* @__PURE__ */ __name2((parallelism) => ({
  _tag: OP_PARALLEL_N,
  parallelism
}), "parallelN");
var isSequential = /* @__PURE__ */ __name2((self) => self._tag === OP_SEQUENTIAL2, "isSequential");
var isParallel = /* @__PURE__ */ __name2((self) => self._tag === OP_PARALLEL2, "isParallel");
...
var running = /* @__PURE__ */ __name2((runtimeFlags2) => new Running(runtimeFlags2), "running");
var suspended = /* @__PURE__ */ __name2((runtimeFlags2, blockingOn) => new Suspended(runtimeFlags2, blockingOn), "suspended");
var isFiberStatus = /* @__PURE__ */ __name2((u) => hasProperty(u, FiberStatusTypeId), "isFiberStatus");
var isDone = /* @__PURE__ */ __name2((self) => self._tag === OP_DONE, "isDone");
var done4 = done3;
...
var causeDie = /* @__PURE__ */ __name2((defect, traces = []) => new Die(defect, traces), "causeDie");
var Interrupt = class extends MicroCauseImpl {
  static {
    __name(this, "Interrupt");
  }
  static {
    __name2(this, "Interrupt");
  }
  constructor(traces = []) {
    super("Interrupt", "interrupted", traces);
  }
};
var causeInterrupt = /* @__PURE__ */ __name2((traces = []) => new Interrupt(traces), "causeInterrupt");
var causeIsInterrupt = /* @__PURE__ */ __name2((self) => self._tag === "Interrupt", "causeIsInterrupt");
...
var fiberInterruptAll = /* @__PURE__ */ __name2((fibers) => suspend2(() => {
...
__name2(defaultEvaluate, "defaultEvaluate");
var makePrimitiveProto = /* @__PURE__ */ __name2((options) => ({
  ...MicroProto,
...
var makePrimitive = /* @__PURE__ */ __name2((options) => {
...
var makeExit = /* @__PURE__ */ __name2((options) => {
  const Proto2 = {
...
var async = /* @__PURE__ */ __name2((register2) => asyncOptions(register2, register2.length >= 2), "async");
var as4 = /* @__PURE__ */ dual(2, (self, value) => map10(self, (_) => value));
var exit2 = /* @__PURE__ */ __name2((self) => matchCause2(self, {
...
var isMicroExit = /* @__PURE__ */ __name2((u) => hasProperty(u, MicroExitTypeId), "isMicroExit");
var exitSucceed2 = succeed3;
var exitFailCause2 = failCause3;
var exitInterrupt2 = /* @__PURE__ */ exitFailCause2(/* @__PURE__ */ causeInterrupt());
var exitDie2 = /* @__PURE__ */ __name2((defect) => exitFailCause2(causeDie(defect)), "exitDie");
var exitVoid2 = /* @__PURE__ */ exitSucceed2(void 0);
var exitVoidAll = /* @__PURE__ */ __name2((exits) => {
...
var MicroSchedulerDefault = class {
  ...
  static {
    __name2(this, "MicroSchedulerDefault");
  }
  tasks = [];
  running = false;
  /**
   ...
   * @since 3.5.9
   */
  afterScheduled = /* @__PURE__ */ __name2(() => {
    this.running = false;
    this.runTasks();
  }, "afterScheduled");
  /**
...
var matchCause2 = /* @__PURE__ */ dual(2, (self, options) => matchCauseEffect2(self, {
  onFailure: /* @__PURE__ */ __name2((cause3) => sync2(() => options.onFailure(cause3)), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((value) => sync2(() => options.onSuccess(value)), "onSuccess")
}));
var MicroScopeTypeId = /* @__PURE__ */ Symbol.for("effect/Micro/MicroScope");
var MicroScopeImpl = class _MicroScopeImpl {
  static {
    __name(this, "_MicroScopeImpl");
  }
  static {
    __name2(this, "MicroScopeImpl");
  }
  [MicroScopeTypeId];
  state = {
    _tag: "Open",
...
var onExit2 = /* @__PURE__ */ dual(2, (self, f) => uninterruptibleMask2((restore) => matchCauseEffect2(restore(self), {
  onFailure: /* @__PURE__ */ __name2((cause3) => flatMap9(f(exitFailCause2(cause3)), () => failCause3(cause3)), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((a) => flatMap9(f(exitSucceed2(a)), () => succeed3(a)), "onSuccess")
})));
...
var interruptible3 = /* @__PURE__ */ __name2((self) => withMicroFiber((fiber) => {
...
var uninterruptibleMask2 = /* @__PURE__ */ __name2((f) => withMicroFiber((fiber) => {
...
var forEach4 = /* @__PURE__ */ __name2((iterable, f, options) => withMicroFiber((parent) => {
  ...
  if (concurrency === 1) {
    return as4(whileLoop2({
      while: /* @__PURE__ */ __name2(() => index < items.length, "while"),
      body: /* @__PURE__ */ __name2(() => f(items[index], index), "body"),
...
var unsafeFork = /* @__PURE__ */ __name2((parent, effect2, immediate = false, daemon = false) => {
...
var runFork = /* @__PURE__ */ __name2((effect2, options) => {
  ...
  if (options?.signal) {
    if (options.signal.aborted) {
      ...
      const abort = /* @__PURE__ */ __name2(() => fiber.unsafeInterrupt(), "abort");
...
var match10 = /* @__PURE__ */ __name2((concurrency, sequential5, unbounded2, bounded) => {
  switch (concurrency) {
    case void 0:
      return sequential5();
    case "unbounded":
...
var matchSimple = /* @__PURE__ */ __name2((concurrency, sequential5, concurrent) => {
  switch (concurrency) {
    case void 0:
      return sequential5();
    case "unbounded":
...
var interruptSignal = /* @__PURE__ */ __name2((cause3) => ({
  _tag: OP_INTERRUPT_SIGNAL,
  cause: cause3
}), "interruptSignal");
var stateful = /* @__PURE__ */ __name2((onFiber) => ({
  _tag: OP_STATEFUL,
  onFiber
}), "stateful");
var resume = /* @__PURE__ */ __name2((effect2) => ({
  _tag: OP_RESUME,
  effect: effect2
}), "resume");
var yieldNow3 = /* @__PURE__ */ __name2(() => ({
  _tag: OP_YIELD_NOW
}), "yieldNow");
...
var unsafeMake7 = /* @__PURE__ */ __name2((fiber) => {
...
var isRuntimeFiber = /* @__PURE__ */ __name2((self) => RuntimeFiberTypeId in self, "isRuntimeFiber");
var _await2 = /* @__PURE__ */ __name2((self) => self.await, "_await");
var inheritAll = /* @__PURE__ */ __name2((self) => self.inheritAll, "inheritAll");
...
var join2 = /* @__PURE__ */ __name2((self) => zipLeft(flatten4(self.await), self.inheritAll), "join");
var _never = {
  ...CommitPrototype,
  commit() {
    return join2(this);
  ...
  ...fiberProto,
  id: /* @__PURE__ */ __name2(() => none4, "id"),
  await: never,
  children: /* @__PURE__ */ succeed([]),
  inheritAll: never,
  poll: /* @__PURE__ */ succeed(/* @__PURE__ */ none2()),
  interruptAsFork: /* @__PURE__ */ __name2(() => never, "interruptAsFork")
};
...
var loggerVariance = {
  /* c8 ignore next */
  _Message: /* @__PURE__ */ __name2((_) => _, "_Message"),
  /* c8 ignore next */
  _Output: /* @__PURE__ */ __name2((_) => _, "_Output")
};
var makeLogger = /* @__PURE__ */ __name2((log3) => ({
...
var textOnly = /^[^\s"=]*$/;
var format3 = /* @__PURE__ */ __name2((quoteValue, whitespace) => ({
  annotations,
  cause: cause3,
  date,
  fiberId: fiberId3,
  ...
  const formatValue = /* @__PURE__ */ __name2((value) => value.match(textOnly) ? value : quoteValue(value), "formatValue");
  const format4 = /* @__PURE__ */ __name2((label, value) => `${formatLabel(label)}=${formatValue(value)}`, "format");
  const append4 = /* @__PURE__ */ __name2((label, value) => " " + format4(label, value), "append");
...
var escapeDoubleQuotes = /* @__PURE__ */ __name2((s) => `"${s.replace(/\\([\s\S])|(")/g, "\\$1$2")}"`, "escapeDoubleQuotes");
...
var MetricBoundariesImpl = class {
  ...
  static {
    __name2(this, "MetricBoundariesImpl");
  }
  values;
...
var isMetricBoundaries = /* @__PURE__ */ __name2((u) => hasProperty(u, MetricBoundariesTypeId), "isMetricBoundaries");
var fromIterable7 = /* @__PURE__ */ __name2((iterable) => {
  const values3 = pipe(iterable, appendAll(of2(Number.POSITIVE_INFINITY)), dedupe);
  return new MetricBoundariesImpl(values3);
}, "fromIterable");
var exponential = /* @__PURE__ */ __name2((options) => pipe(makeBy(options.count - 1, (i) => options.start * Math.pow(options.factor, i)), unsafeFromArray, fromIterable7), "exponential");
...
var metricKeyTypeVariance = {
  ...
  _In: /* @__PURE__ */ __name2((_) => _, "_In"),
  /* c8 ignore next */
  _Out: /* @__PURE__ */ __name2((_) => _, "_Out")
};
...
var counter = /* @__PURE__ */ __name2((options) => new CounterKeyType(options?.incremental ?? false, options?.bigint ?? false), "counter");
var histogram = /* @__PURE__ */ __name2((boundaries) => {
  return new HistogramKeyType(boundaries);
}, "histogram");
var isCounterKey = /* @__PURE__ */ __name2((u) => hasProperty(u, CounterKeyTypeTypeId), "isCounterKey");
var isFrequencyKey = /* @__PURE__ */ __name2((u) => hasProperty(u, FrequencyKeyTypeTypeId), "isFrequencyKey");
var isGaugeKey = /* @__PURE__ */ __name2((u) => hasProperty(u, GaugeKeyTypeTypeId), "isGaugeKey");
var isHistogramKey = /* @__PURE__ */ __name2((u) => hasProperty(u, HistogramKeyTypeTypeId), "isHistogramKey");
var isSummaryKey = /* @__PURE__ */ __name2((u) => hasProperty(u, SummaryKeyTypeTypeId), "isSummaryKey");
var MetricKeySymbolKey = "effect/MetricKey";
var MetricKeyTypeId = /* @__PURE__ */ Symbol.for(MetricKeySymbolKey);
var metricKeyVariance = {
  /* c8 ignore next */
  _Type: /* @__PURE__ */ __name2((_) => _, "_Type")
};
...
var isMetricKey = /* @__PURE__ */ __name2((u) => hasProperty(u, MetricKeyTypeId), "isMetricKey");
var counter2 = /* @__PURE__ */ __name2((name, options) => new MetricKeyImpl(name, counter(options), fromNullable(options?.description)), "counter");
var histogram2 = /* @__PURE__ */ __name2((name, boundaries, description) => new MetricKeyImpl(name, histogram(boundaries), fromNullable(description)), "histogram");
...
var counter3 = /* @__PURE__ */ __name2((count) => new CounterState(count), "counter");
var frequency2 = /* @__PURE__ */ __name2((occurrences) => {
  return new FrequencyState(occurrences);
}, "frequency");
var gauge2 = /* @__PURE__ */ __name2((count) => new GaugeState(count), "gauge");
var histogram3 = /* @__PURE__ */ __name2((options) => new HistogramState(options.buckets, options.count, options.min, options.max, options.sum), "histogram");
var summary2 = /* @__PURE__ */ __name2((options) => new SummaryState(options.error, options.quantiles, options.count, options.min, options.max, options.sum), "summary");
var isCounterState = /* @__PURE__ */ __name2((u) => hasProperty(u, CounterStateTypeId), "isCounterState");
var isFrequencyState = /* @__PURE__ */ __name2((u) => hasProperty(u, FrequencyStateTypeId), "isFrequencyState");
var isGaugeState = /* @__PURE__ */ __name2((u) => hasProperty(u, GaugeStateTypeId), "isGaugeState");
var isHistogramState = /* @__PURE__ */ __name2((u) => hasProperty(u, HistogramStateTypeId), "isHistogramState");
var isSummaryState = /* @__PURE__ */ __name2((u) => hasProperty(u, SummaryStateTypeId), "isSummaryState");
...
var make29 = /* @__PURE__ */ __name2((options) => ({
...
var counter4 = /* @__PURE__ */ __name2((key) => {
  ...
  const update5 = /* @__PURE__ */ __name2((value) => {
    if (canUpdate(value)) {
      sum2 = sum2 + value;
    }
  }, "update");
  return make29({
    get: /* @__PURE__ */ __name2(() => counter3(sum2), "get"),
    update: update5,
    modify: update5
  });
}, "counter");
var frequency3 = /* @__PURE__ */ __name2((key) => {
  const values3 = /* @__PURE__ */ new Map();
  for (const word of key.keyType.preregisteredWords) {
    values3.set(word, 0);
  }
  const update5 = /* @__PURE__ */ __name2((word) => {
    const slotCount = values3.get(word) ?? 0;
    values3.set(word, slotCount + 1);
  }, "update");
  return make29({
    get: /* @__PURE__ */ __name2(() => frequency2(values3), "get"),
    update: update5,
    modify: update5
  });
}, "frequency");
var gauge3 = /* @__PURE__ */ __name2((_key, startAt) => {
  let value = startAt;
  return make29({
    get: /* @__PURE__ */ __name2(() => gauge2(value), "get"),
    update: /* @__PURE__ */ __name2((v) => {
      value = v;
    }, "update"),
    modify: /* @__PURE__ */ __name2((v) => {
      value = value + v;
    }, "modify")
  });
}, "gauge");
var histogram4 = /* @__PURE__ */ __name2((key) => {
  ...
  const getBuckets = /* @__PURE__ */ __name2(() => {
  ...
  return make29({
    get: /* @__PURE__ */ __name2(() => histogram3({
      buckets: getBuckets(),
      count,
      min: min3,
      max: max5,
...
var summary3 = /* @__PURE__ */ __name2((key) => {
  const {
    error,
    maxAge,
    maxSize,
  ...
  let min3 = 0;
  let max5 = 0;
  const snapshot = /* @__PURE__ */ __name2((now) => {
    const builder = [];
    let i = 0;
    while (i !== maxSize - 1) {
  ...
  const observe = /* @__PURE__ */ __name2((value, timestamp) => {
    if (maxSize > 0) {
      head5 = head5 + 1;
  ...
  return make29({
    ...
    update: /* @__PURE__ */ __name2(([value, timestamp]) => observe(value, timestamp), "update"),
    modify: /* @__PURE__ */ __name2(([value, timestamp]) => observe(value, timestamp), "modify")
  });
}, "summary");
var calculateQuantiles = /* @__PURE__ */ __name2((error, sortedQuantiles, sortedSamples) => {
...
var resolveQuantile = /* @__PURE__ */ __name2((error, sampleCount, current, consumed, quantile, rest) => {
  let error_1 = error;
...
var unsafeMake8 = /* @__PURE__ */ __name2((metricKey, metricState) => {
  return {
...
var MetricRegistryImpl = class {
  ...
  static {
    __name2(this, "MetricRegistryImpl");
  }
...
var make31 = /* @__PURE__ */ __name2(function(keyType, unsafeUpdate, unsafeValue, unsafeModify) {
...
var counter5 = /* @__PURE__ */ __name2((name, options) => fromMetricKey(counter2(name, options)), "counter");
var fromMetricKey = /* @__PURE__ */ __name2((key) => {
  let untaggedHook;
  const hookCache = /* @__PURE__ */ new WeakMap();
  const hook = /* @__PURE__ */ __name2((extraTags) => {
...
var histogram5 = /* @__PURE__ */ __name2((name, boundaries, description) => fromMetricKey(histogram2(name, boundaries, description)), "histogram");
...
var isRequest = /* @__PURE__ */ __name2((u) => hasProperty(u, RequestTypeId), "isRequest");
...
var RedBlackTreeIterator = class _RedBlackTreeIterator {
  static {
    __name(this, "_RedBlackTreeIterator");
  }
  static {
    __name2(this, "RedBlackTreeIterator");
  }
  self;
  stack;
  direction;
...
var recount = /* @__PURE__ */ __name2((node) => {
...
var redBlackTreeVariance = {
  /* c8 ignore next */
  _Key: /* @__PURE__ */ __name2((_) => _, "_Key"),
  /* c8 ignore next */
  _Value: /* @__PURE__ */ __name2((_) => _, "_Value")
};
...
var makeImpl3 = /* @__PURE__ */ __name2((ord, root) => {
  const tree = Object.create(RedBlackTreeProto);
  tree._ord = ord;
  tree._root = root;
  return tree;
}, "makeImpl");
var isRedBlackTree = /* @__PURE__ */ __name2((u) => hasProperty(u, RedBlackTreeTypeId), "isRedBlackTree");
...
var keysForward = /* @__PURE__ */ __name2((self) => keys3(self, Direction.Forward), "keysForward");
var keys3 = /* @__PURE__ */ __name2((self, direction) => {
...
var fixDoubleBlack = /* @__PURE__ */ __name2((stack) => {
  let n, p, s, z;
...
var fromTree = /* @__PURE__ */ __name2((keyTree) => {
  const a = Object.create(SortedSetProto);
  a.keyTree = keyTree;
  return a;
}, "fromTree");
var isSortedSet = /* @__PURE__ */ __name2((u) => hasProperty(u, TypeId14), "isSortedSet");
...
var supervisorVariance = {
  /* c8 ignore next */
  _T: /* @__PURE__ */ __name2((_) => _, "_T")
};
var ProxySupervisor = class _ProxySupervisor {
  static {
    __name(this, "_ProxySupervisor");
  }
  static {
    __name2(this, "ProxySupervisor");
  }
  underlying;
  value0;
...
var isZip = /* @__PURE__ */ __name2((self) => hasProperty(self, SupervisorTypeId) && isTagged(self, "Zip"), "isZip");
var Track = class {
  static {
    __name(this, "Track");
  }
...
var unsafeTrack = /* @__PURE__ */ __name2(() => {
  return new Track();
}, "unsafeTrack");
var track = /* @__PURE__ */ sync(unsafeTrack);
var fromEffect = /* @__PURE__ */ __name2((effect2) => {
...
var combine8 = /* @__PURE__ */ __name2((self, that) => {
  return {
    _tag: OP_AND_THEN2,
    first: self,
    second: that
...
var patch8 = /* @__PURE__ */ __name2((self, supervisor) => {
  return patchLoop(supervisor, of2(self));
}, "patch");
var patchLoop = /* @__PURE__ */ __name2((_supervisor, _patches) => {
...
var removeSupervisor = /* @__PURE__ */ __name2((self, that) => {
  if (equals(self, that)) {
    return none8;
  } else {
    if (isZip(self)) {
...
var toSet2 = /* @__PURE__ */ __name2((self) => {
...
var diff7 = /* @__PURE__ */ __name2((oldValue, newValue) => {
  if (equals(oldValue, newValue)) {
    return empty25;
  }
...
var contOpSuccess = {
  ...
  ["OnStep"]: /* @__PURE__ */ __name2((_, _cont, value) => {
...
var runBlockedRequests = /* @__PURE__ */ __name2((self) => forEachSequentialDiscard(flatten2(self), (requestsByRequestResolver) => forEachConcurrentDiscard(sequentialCollectionToChunk(requestsByRequestResolver), ([dataSource, sequential5]) => {
  const map16 = /* @__PURE__ */ new Map();
  const arr = [];
...
var FiberRuntime = class extends Class2 {
  ...
  get await() {
    return async_((resume2) => {
      const cb = /* @__PURE__ */ __name2((exit4) => resume2(succeed(exit4)), "cb");
  ...
  interruptAllChildren() {
    if (this.sendInterruptSignalToAllChildren()) {
      ...
      return whileLoop({
        while: /* @__PURE__ */ __name2(() => !isDone5, "while"),
        body,
        step: /* @__PURE__ */ __name2(() => {
        }, "step")
      });
  ...
  initiateAsync(runtimeFlags2, asyncRegister) {
    ...
    const callback = /* @__PURE__ */ __name2((effect2) => {
      if (!alreadyCalled) {
        alreadyCalled = true;
        this.tell(resume(effect2));
      }
...
var loggerWithConsoleLog = /* @__PURE__ */ __name2((self) => makeLogger((opts) => {
...
var annotateLogsScoped = /* @__PURE__ */ __name2(function() {
...
var addFinalizer = /* @__PURE__ */ __name2((finalizer) => withFiberRuntime((runtime4) => {
...
var daemonChildren = /* @__PURE__ */ __name2((self) => {
...
var exists2 = /* @__PURE__ */ dual((args2) => isIterable(args2[0]) && !isEffect(args2[0]), (elements, predicate, options) => matchSimple(options?.concurrency, () => suspend(() => existsLoop(elements[Symbol.iterator](), 0, predicate)), () => matchEffect(forEach7(elements, (a, i) => if_(predicate(a, i), {
  onTrue: /* @__PURE__ */ __name2(() => fail2(_existsParFound), "onTrue"),
  onFalse: /* @__PURE__ */ __name2(() => void_, "onFalse")
}), options), {
  onFailure: /* @__PURE__ */ __name2((e) => e === _existsParFound ? succeed(true) : fail2(e), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2(() => succeed(false), "onSuccess")
})));
var existsLoop = /* @__PURE__ */ __name2((iterator, index, f) => {
  const next = iterator.next();
  if (next.done) {
...
var allResolveInput = /* @__PURE__ */ __name2((input) => {
...
var allValidate = /* @__PURE__ */ __name2((effects, reconcile, options) => {
  const eitherEffects = [];
...
var allEither = /* @__PURE__ */ __name2((effects, reconcile, options) => {
  const eitherEffects = [];
  for (const effect2 of effects) {
    eitherEffects.push(either2(effect2));
  }
...
var all3 = /* @__PURE__ */ __name2((arg, options) => {
...
var allWith = /* @__PURE__ */ __name2((options) => (arg) => all3(arg, options), "allWith");
var allSuccesses = /* @__PURE__ */ __name2((elements, options) => map8(all3(fromIterable(elements).map(exit), options), filterMap((exit4) => exitIsSuccess(exit4) ? some2(exit4.effect_instruction_i0) : none2())), "allSuccesses");
...
var forEachParUnbounded = /* @__PURE__ */ __name2((self, f, batching) => suspend(() => {
  const as7 = fromIterable(self);
  const array4 = new Array(as7.length);
  const fn2 = /* @__PURE__ */ __name2((a, i) => flatMap7(f(a, i), (b) => sync(() => array4[i] = b)), "fn");
  return zipRight(forEachConcurrentDiscard(as7, fn2, batching, false), succeed(array4));
}), "forEachParUnbounded");
var forEachConcurrentDiscard = /* @__PURE__ */ __name2((self, f, batching, processAll, n) => uninterruptibleMask((restore) => transplant((graft) => withFiberRuntime((parent) => {
  ...
  const interruptAll = /* @__PURE__ */ __name2(() => fibers.forEach((fiber) => {
  ...
  const collectExits = /* @__PURE__ */ __name2(() => {
  ...
  const runFiber = /* @__PURE__ */ __name2((eff, interruptImmediately = false) => {
  ...
  const onInterruptSignal = /* @__PURE__ */ __name2(() => {
    if (!processAll) {
      target -= todos.length;
      todos = [];
    }
  ...
  const processingFiber = runFiber(async_((resume2) => {
    const pushResult = /* @__PURE__ */ __name2((res, index) => {
      if (res._op === "Blocked") {
        residual.push(res);
      } else {
        results.push({
    ...
    const next = /* @__PURE__ */ __name2(() => {
      if (todos.length > 0) {
        const a = todos.pop();
        let index = counter6++;
        const returnNextElement = /* @__PURE__ */ __name2(() => {
          const a2 = todos.pop();
          index = counter6++;
          return flatMap7(yieldNow(), () => flatMap7(stepOrExit(restore(f(a2, index))), onRes));
        }, "returnNextElement");
        const onRes = /* @__PURE__ */ __name2((res) => {
          if (todos.length > 0) {
  ...
  return asVoid(onExit(flatten4(restore(join2(processingFiber))), exitMatch({
    onFailure: /* @__PURE__ */ __name2((cause3) => {
      ...
      return async_((cb) => {
        ...
        let count = 0;
        let index = 0;
        const check2 = /* @__PURE__ */ __name2((index2, hitNext) => (exit4) => {
          exits[index2] = exit4;
          count++;
          if (count === target2) {
    ...
    onSuccess: /* @__PURE__ */ __name2(() => forEachSequential(joinOrder, (f2) => f2.inheritAll), "onSuccess")
  })));
}))), "forEachConcurrentDiscard");
var forEachParN = /* @__PURE__ */ __name2((self, n, f, batching) => suspend(() => {
  const as7 = fromIterable(self);
  const array4 = new Array(as7.length);
  const fn2 = /* @__PURE__ */ __name2((a, i) => map8(f(a, i), (b) => array4[i] = b), "fn");
  return zipRight(forEachConcurrentDiscard(as7, fn2, batching, false, n), succeed(array4));
}), "forEachParN");
var fork = /* @__PURE__ */ __name2((self) => withFiberRuntime((state, status) => succeed(unsafeFork2(self, state, status.runtimeFlags))), "fork");
var forkDaemon = /* @__PURE__ */ __name2((self) => forkWithScopeOverride(self, globalScope), "forkDaemon");
...
var unsafeFork2 = /* @__PURE__ */ __name2((effect2, parentFiber, parentRuntimeFlags, overrideScope = null) => {
  const childFiber = unsafeMakeChildFiber(effect2, parentFiber, parentRuntimeFlags, overrideScope);
  childFiber.resume(effect2);
  return childFiber;
}, "unsafeFork");
var unsafeForkUnstarted = /* @__PURE__ */ __name2((effect2, parentFiber, parentRuntimeFlags, overrideScope = null) => {
  const childFiber = unsafeMakeChildFiber(effect2, parentFiber, parentRuntimeFlags, overrideScope);
  return childFiber;
}, "unsafeForkUnstarted");
var unsafeMakeChildFiber = /* @__PURE__ */ __name2((effect2, parentFiber, parentRuntimeFlags, overrideScope = null) => {
...
var forkWithScopeOverride = /* @__PURE__ */ __name2((self, scopeOverride) => withFiberRuntime((parentFiber, parentStatus) => succeed(unsafeFork2(self, parentFiber, parentStatus.runtimeFlags, scopeOverride))), "forkWithScopeOverride");
...
var raceAll = /* @__PURE__ */ __name2((all5) => withFiberRuntime((state, status) => async_((resume2) => {
  const fibers = /* @__PURE__ */ new Set();
  let winner;
  let failures3 = empty16;
  const interruptAll = /* @__PURE__ */ __name2(() => {
    for (const fiber of fibers) {
...
var parallelFinalizers = /* @__PURE__ */ __name2((self) => contextWithEffect((context5) => match3(getOption2(context5, scopeTag), {
  onNone: /* @__PURE__ */ __name2(() => self, "onNone"),
  onSome: /* @__PURE__ */ __name2((scope5) => {
...
var parallelNFinalizers = /* @__PURE__ */ __name2((parallelism) => (self) => contextWithEffect((context5) => match3(getOption2(context5, scopeTag), {
  onNone: /* @__PURE__ */ __name2(() => self, "onNone"),
  onSome: /* @__PURE__ */ __name2((scope5) => {
...
var finalizersMask = /* @__PURE__ */ __name2((strategy) => (self) => finalizersMaskInternal(strategy, true)(self), "finalizersMask");
var finalizersMaskInternal = /* @__PURE__ */ __name2((strategy, concurrentFinalizers) => (self) => contextWithEffect((context5) => match3(getOption2(context5, scopeTag), {
  onNone: /* @__PURE__ */ __name2(() => self(identity), "onNone"),
  onSome: /* @__PURE__ */ __name2((scope5) => {
...
var scopeWith = /* @__PURE__ */ __name2((f) => flatMap7(scopeTag, f), "scopeWith");
var scopedWith = /* @__PURE__ */ __name2((f) => flatMap7(scopeMake(), (scope5) => onExit(f(scope5), (exit4) => scope5.close(exit4))), "scopedWith");
var scopedEffect = /* @__PURE__ */ __name2((effect2) => flatMap7(scopeMake(), (scope5) => scopeUse(effect2, scope5)), "scopedEffect");
var sequentialFinalizers = /* @__PURE__ */ __name2((self) => contextWithEffect((context5) => match3(getOption2(context5, scopeTag), {
  onNone: /* @__PURE__ */ __name2(() => self, "onNone"),
  onSome: /* @__PURE__ */ __name2((scope5) => {
    switch (scope5.strategy._tag) {
      case "Sequential":
...
var tagMetricsScoped = /* @__PURE__ */ __name2((key, value) => labelMetricsScoped([make28(key, value)]), "tagMetricsScoped");
var labelMetricsScoped = /* @__PURE__ */ __name2((labels) => fiberRefLocallyScopedWith(currentMetricLabels, (old) => union(old, labels)), "labelMetricsScoped");
...
var validateWith = /* @__PURE__ */ dual((args2) => isEffect(args2[1]), (self, that, f, options) => flatten4(zipWithOptions(exit(self), exit(that), (ea, eb) => exitZipWith(ea, eb, {
  onSuccess: f,
  onFailure: /* @__PURE__ */ __name2((ca, cb) => options?.concurrent ? parallel(ca, cb) : sequential(ca, cb), "onFailure")
}), options)));
...
var withClockScoped = /* @__PURE__ */ __name2((c) => fiberRefLocallyScopedWith(currentServices, add2(clockTag, c)), "withClockScoped");
var withRandomScoped = /* @__PURE__ */ __name2((value) => fiberRefLocallyScopedWith(currentServices, add2(randomTag, value)), "withRandomScoped");
var withConfigProviderScoped = /* @__PURE__ */ __name2((provider) => fiberRefLocallyScopedWith(currentServices, add2(configProviderTag, provider)), "withConfigProviderScoped");
var withEarlyRelease = /* @__PURE__ */ __name2((self) => scopeWith((parent) => flatMap7(scopeFork(parent, sequential2), (child) => pipe(self, scopeExtend(child), map8((value) => [fiberIdWith((fiberId3) => scopeClose(child, exitInterrupt(fiberId3))), value])))), "withEarlyRelease");
...
var withRuntimeFlagsScoped = /* @__PURE__ */ __name2((update5) => {
  if (update5 === empty14) {
    return void_;
  }
...
var scope = scopeTag;
var scopeUnsafeAddFinalizer = /* @__PURE__ */ __name2((scope5, fin) => {
...
var ScopeImplProto = {
  ...
  fork(strategy) {
    return sync(() => {
      ...
      const key = {};
      const fin = /* @__PURE__ */ __name2((exit4) => newScope.close(exit4), "fin");
...
var scopeUnsafeMake = /* @__PURE__ */ __name2((strategy = sequential2) => {
...
var scopeMake = /* @__PURE__ */ __name2((strategy = sequential2) => sync(() => scopeUnsafeMake(strategy)), "scopeMake");
...
var fiberRefUnsafeMakeSupervisor = /* @__PURE__ */ __name2((initial) => fiberRefUnsafeMakePatch(initial, {
  differ: differ2,
  fork: empty25
...
var fiberAwaitAll = /* @__PURE__ */ __name2((fibers) => forEach7(fibers, _await2), "fiberAwaitAll");
var fiberAll = /* @__PURE__ */ __name2((fibers) => {
  const _fiberAll = {
    ...CommitPrototype2,
    commit() {
      return join2(this);
    ...
    [FiberTypeId]: fiberVariance2,
    id: /* @__PURE__ */ __name2(() => fromIterable(fibers).reduce((id, fiber) => combine3(id, fiber.id()), none4), "id"),
          ...
          switch (optionB._tag) {
            ...
            case "Some": {
              return some2(exitZipWith(optionA.value, optionB.value, {
                onSuccess: /* @__PURE__ */ __name2((a, chunk2) => [a, ...chunk2], "onSuccess"),
                onFailure: parallel
              }));
            }
          }
    ...
    interruptAsFork: /* @__PURE__ */ __name2((fiberId3) => forEachSequentialDiscard(fibers, (fiber) => fiber.interruptAsFork(fiberId3)), "interruptAsFork")
  };
  return _fiberAll;
}, "fiberAll");
var raceWith = /* @__PURE__ */ dual(3, (self, other, options) => raceFibersWith(self, other, {
  onSelfWin: /* @__PURE__ */ __name2((winner, loser) => flatMap7(winner.await, (exit4) => {
    switch (exit4._tag) {
      case OP_SUCCESS: {
  ...
  onOtherWin: /* @__PURE__ */ __name2((winner, loser) => flatMap7(winner.await, (exit4) => {
    switch (exit4._tag) {
      case OP_SUCCESS: {
...
var disconnect = /* @__PURE__ */ __name2((self) => uninterruptibleMask((restore) => fiberIdWith((fiberId3) => flatMap7(forkDaemon(restore(self)), (fiber) => pipe(restore(join2(fiber)), onInterrupt(() => pipe(fiber, interruptAsFork(fiberId3))))))), "disconnect");
var race = /* @__PURE__ */ dual(2, (self, that) => fiberIdWith((parentFiberId) => raceWith(self, that, {
  onSelfDone: /* @__PURE__ */ __name2((exit4, right3) => exitMatchEffect(exit4, {
    onFailure: /* @__PURE__ */ __name2((cause3) => pipe(join2(right3), mapErrorCause2((cause22) => parallel(cause3, cause22))), "onFailure"),
    onSuccess: /* @__PURE__ */ __name2((value) => pipe(right3, interruptAsFiber(parentFiberId), as2(value)), "onSuccess")
  }), "onSelfDone"),
  onOtherDone: /* @__PURE__ */ __name2((exit4, left3) => exitMatchEffect(exit4, {
    onFailure: /* @__PURE__ */ __name2((cause3) => pipe(join2(left3), mapErrorCause2((cause22) => parallel(cause22, cause3))), "onFailure"),
    onSuccess: /* @__PURE__ */ __name2((value) => pipe(left3, interruptAsFiber(parentFiberId), as2(value)), "onSuccess")
  }), "onOtherDone")
})));
...
var completeRace = /* @__PURE__ */ __name2((winner, loser, cont, ab, cb) => {
  if (compareAndSet(true, false)(ab)) {
    cb(cont(winner, loser));
  }
}, "completeRace");
var ensuring = /* @__PURE__ */ dual(2, (self, finalizer) => uninterruptibleMask((restore) => matchCauseEffect(restore(self), {
  onFailure: /* @__PURE__ */ __name2((cause1) => matchCauseEffect(finalizer, {
    onFailure: /* @__PURE__ */ __name2((cause22) => failCause(sequential(cause1, cause22)), "onFailure"),
    onSuccess: /* @__PURE__ */ __name2(() => failCause(cause1), "onSuccess")
  }), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((a) => as2(finalizer, a), "onSuccess")
})));
var invokeWithInterrupt = /* @__PURE__ */ __name2((self, entries2, onInterrupt3) => fiberIdWith((id) => flatMap7(flatMap7(forkDaemon(interruptible2(self)), (processing) => async_((cb) => {
  const counts = entries2.map((_) => _.listeners.count);
  const checkDone = /* @__PURE__ */ __name2(() => {
  ...
  const cleanup = entries2.map((r, i) => {
    const observer = /* @__PURE__ */ __name2((count) => {
      counts[i] = count;
      checkDone();
    }, "observer");
...
var makeSpanScoped = /* @__PURE__ */ __name2((name, options) => {
  options = addSpanStackTrace(options);
...
var withTracerScoped = /* @__PURE__ */ __name2((value) => fiberRefLocallyScopedWith(currentServices, add2(tracerTag, value)), "withTracerScoped");
var withSpanScoped = /* @__PURE__ */ __name2(function() {
  const dataFirst = typeof arguments[0] !== "string";
  const name = dataFirst ? arguments[1] : arguments[0];
  const options = addSpanStackTrace(dataFirst ? arguments[2] : arguments[1]);
  if (dataFirst) {
...
var complete2 = /* @__PURE__ */ __name2((key, exit4, entryStats, timeToLiveMillis) => struct({
  _tag: "Complete",
  key,
  exit: exit4,
  entryStats,
...
var pending2 = /* @__PURE__ */ __name2((key, deferred) => struct({
  _tag: "Pending",
  key,
  deferred
}), "pending");
var refreshing = /* @__PURE__ */ __name2((deferred, complete3) => struct({
  _tag: "Refreshing",
  deferred,
  complete: complete3
}), "refreshing");
...
var makeMapKey = /* @__PURE__ */ __name2((current) => new MapKeyImpl(current), "makeMapKey");
var isMapKey = /* @__PURE__ */ __name2((u) => hasProperty(u, MapKeyTypeId), "isMapKey");
var KeySetImpl = class {
  static {
    __name(this, "KeySetImpl");
  }
  static {
    __name2(this, "KeySetImpl");
  }
  head = void 0;
  tail = void 0;
  add(key) {
...
var makeKeySet = /* @__PURE__ */ __name2(() => new KeySetImpl(), "makeKeySet");
var makeCacheState = /* @__PURE__ */ __name2((map16, keys5, accesses, updating, hits, misses) => ({
  map: map16,
  keys: keys5,
  accesses,
  updating,
...
var initialCacheState = /* @__PURE__ */ __name2(() => makeCacheState(empty17(), makeKeySet(), unbounded(), make11(false), 0, 0), "initialCacheState");
...
var cacheVariance = {
  ...
  _Key: /* @__PURE__ */ __name2((_) => _, "_Key"),
  /* c8 ignore next */
  _Error: /* @__PURE__ */ __name2((_) => _, "_Error"),
  /* c8 ignore next */
  _Value: /* @__PURE__ */ __name2((_) => _, "_Value")
};
...
var makeCacheStats = /* @__PURE__ */ __name2((options) => options, "makeCacheStats");
var makeEntryStats = /* @__PURE__ */ __name2((loadedMillis) => ({
  loadedMillis
}), "makeEntryStats");
var CacheImpl = class {
  static {
  ...
  getOption(key) {
    return suspend(() => match3(get8(this.cacheState.map, key), {
      ...
      onSome: /* @__PURE__ */ __name2((value) => this.resolveMapValue(value), "onSome")
    }));
  }
  getOptionComplete(key) {
    return suspend(() => match3(get8(this.cacheState.map, key), {
      ...
      onSome: /* @__PURE__ */ __name2((value) => this.resolveMapValue(value, true), "onSome")
    }));
  }
  contains(key) {
    ...
    return suspend(() => {
      ...
      if (value === void 0) {
        ...
        return flatMap7(this.resolveMapValue(value), match3({
          onNone: /* @__PURE__ */ __name2(() => this.getEither(key), "onNone"),
          onSome: /* @__PURE__ */ __name2((value2) => succeed(left2(value2)), "onSome")
        }));
      }
    });
  }
...
var unsafeMakeWith = /* @__PURE__ */ __name2((capacity, lookup, timeToLive) => new CacheImpl(capacity, empty3(), none3, lookup, (exit4) => decode3(timeToLive(exit4))), "unsafeMakeWith");
var Cause_exports = {};
__export(Cause_exports, {
  CauseTypeId: /* @__PURE__ */ __name(() => CauseTypeId2, "CauseTypeId"),
  ExceededCapacityException: /* @__PURE__ */ __name(() => ExceededCapacityException2, "ExceededCapacityException"),
  ExceededCapacityExceptionTypeId: /* @__PURE__ */ __name(() => ExceededCapacityExceptionTypeId2, "ExceededCapacityExceptionTypeId"),
  IllegalArgumentException: /* @__PURE__ */ __name(() => IllegalArgumentException2, "IllegalArgumentException"),
  IllegalArgumentExceptionTypeId: /* @__PURE__ */ __name(() => IllegalArgumentExceptionTypeId2, "IllegalArgumentExceptionTypeId"),
  InterruptedException: /* @__PURE__ */ __name(() => InterruptedException2, "InterruptedException"),
  InterruptedExceptionTypeId: /* @__PURE__ */ __name(() => InterruptedExceptionTypeId2, "InterruptedExceptionTypeId"),
  InvalidPubSubCapacityExceptionTypeId: /* @__PURE__ */ __name(() => InvalidPubSubCapacityExceptionTypeId2, "InvalidPubSubCapacityExceptionTypeId"),
  NoSuchElementException: /* @__PURE__ */ __name(() => NoSuchElementException2, "NoSuchElementException"),
  NoSuchElementExceptionTypeId: /* @__PURE__ */ __name(() => NoSuchElementExceptionTypeId2, "NoSuchElementExceptionTypeId"),
  RuntimeException: /* @__PURE__ */ __name(() => RuntimeException2, "RuntimeException"),
  RuntimeExceptionTypeId: /* @__PURE__ */ __name(() => RuntimeExceptionTypeId2, "RuntimeExceptionTypeId"),
  TimeoutException: /* @__PURE__ */ __name(() => TimeoutException2, "TimeoutException"),
  TimeoutExceptionTypeId: /* @__PURE__ */ __name(() => TimeoutExceptionTypeId2, "TimeoutExceptionTypeId"),
  UnknownException: /* @__PURE__ */ __name(() => UnknownException2, "UnknownException"),
  UnknownExceptionTypeId: /* @__PURE__ */ __name(() => UnknownExceptionTypeId2, "UnknownExceptionTypeId"),
  YieldableError: /* @__PURE__ */ __name(() => YieldableError2, "YieldableError"),
  andThen: /* @__PURE__ */ __name(() => andThen4, "andThen"),
  as: /* @__PURE__ */ __name(() => as5, "as"),
  contains: /* @__PURE__ */ __name(() => contains4, "contains"),
  defects: /* @__PURE__ */ __name(() => defects2, "defects"),
  die: /* @__PURE__ */ __name(() => die4, "die"),
  dieOption: /* @__PURE__ */ __name(() => dieOption2, "dieOption"),
  empty: /* @__PURE__ */ __name(() => empty26, "empty"),
  fail: /* @__PURE__ */ __name(() => fail4, "fail"),
  failureOption: /* @__PURE__ */ __name(() => failureOption2, "failureOption"),
  failureOrCause: /* @__PURE__ */ __name(() => failureOrCause2, "failureOrCause"),
  failures: /* @__PURE__ */ __name(() => failures2, "failures"),
  filter: /* @__PURE__ */ __name(() => filter6, "filter"),
  find: /* @__PURE__ */ __name(() => find2, "find"),
  flatMap: /* @__PURE__ */ __name(() => flatMap10, "flatMap"),
  flatten: /* @__PURE__ */ __name(() => flatten6, "flatten"),
  flipCauseOption: /* @__PURE__ */ __name(() => flipCauseOption2, "flipCauseOption"),
  interrupt: /* @__PURE__ */ __name(() => interrupt5, "interrupt"),
  interruptOption: /* @__PURE__ */ __name(() => interruptOption2, "interruptOption"),
  interruptors: /* @__PURE__ */ __name(() => interruptors2, "interruptors"),
  isCause: /* @__PURE__ */ __name(() => isCause2, "isCause"),
  isDie: /* @__PURE__ */ __name(() => isDie2, "isDie"),
  isDieType: /* @__PURE__ */ __name(() => isDieType2, "isDieType"),
  isEmpty: /* @__PURE__ */ __name(() => isEmpty7, "isEmpty"),
  isEmptyType: /* @__PURE__ */ __name(() => isEmptyType2, "isEmptyType"),
  isExceededCapacityException: /* @__PURE__ */ __name(() => isExceededCapacityException2, "isExceededCapacityException"),
  isFailType: /* @__PURE__ */ __name(() => isFailType2, "isFailType"),
  isFailure: /* @__PURE__ */ __name(() => isFailure4, "isFailure"),
  isIllegalArgumentException: /* @__PURE__ */ __name(() => isIllegalArgumentException2, "isIllegalArgumentException"),
  isInterruptType: /* @__PURE__ */ __name(() => isInterruptType2, "isInterruptType"),
  isInterrupted: /* @__PURE__ */ __name(() => isInterrupted3, "isInterrupted"),
  isInterruptedException: /* @__PURE__ */ __name(() => isInterruptedException2, "isInterruptedException"),
  isInterruptedOnly: /* @__PURE__ */ __name(() => isInterruptedOnly2, "isInterruptedOnly"),
  isNoSuchElementException: /* @__PURE__ */ __name(() => isNoSuchElementException2, "isNoSuchElementException"),
  isParallelType: /* @__PURE__ */ __name(() => isParallelType2, "isParallelType"),
  isRuntimeException: /* @__PURE__ */ __name(() => isRuntimeException2, "isRuntimeException"),
  isSequentialType: /* @__PURE__ */ __name(() => isSequentialType2, "isSequentialType"),
  isTimeoutException: /* @__PURE__ */ __name(() => isTimeoutException2, "isTimeoutException"),
  isUnknownException: /* @__PURE__ */ __name(() => isUnknownException2, "isUnknownException"),
  keepDefects: /* @__PURE__ */ __name(() => keepDefects2, "keepDefects"),
  linearize: /* @__PURE__ */ __name(() => linearize2, "linearize"),
  map: /* @__PURE__ */ __name(() => map11, "map"),
  match: /* @__PURE__ */ __name(() => match11, "match"),
  originalError: /* @__PURE__ */ __name(() => originalError, "originalError"),
  parallel: /* @__PURE__ */ __name(() => parallel4, "parallel"),
  pretty: /* @__PURE__ */ __name(() => pretty2, "pretty"),
  prettyErrors: /* @__PURE__ */ __name(() => prettyErrors2, "prettyErrors"),
  reduce: /* @__PURE__ */ __name(() => reduce10, "reduce"),
  reduceWithContext: /* @__PURE__ */ __name(() => reduceWithContext2, "reduceWithContext"),
  sequential: /* @__PURE__ */ __name(() => sequential4, "sequential"),
  size: /* @__PURE__ */ __name(() => size8, "size"),
  squash: /* @__PURE__ */ __name(() => squash, "squash"),
  squashWith: /* @__PURE__ */ __name(() => squashWith, "squashWith"),
  stripFailures: /* @__PURE__ */ __name(() => stripFailures2, "stripFailures"),
  stripSomeDefects: /* @__PURE__ */ __name(() => stripSomeDefects2, "stripSomeDefects")
});
...
__export(Effect_exports, {
  Do: /* @__PURE__ */ __name(() => Do2, "Do"),
  EffectTypeId: /* @__PURE__ */ __name(() => EffectTypeId3, "EffectTypeId"),
  Service: /* @__PURE__ */ __name(() => Service, "Service"),
  Tag: /* @__PURE__ */ __name(() => Tag3, "Tag"),
  acquireRelease: /* @__PURE__ */ __name(() => acquireRelease2, "acquireRelease"),
  acquireReleaseInterruptible: /* @__PURE__ */ __name(() => acquireReleaseInterruptible2, "acquireReleaseInterruptible"),
  acquireUseRelease: /* @__PURE__ */ __name(() => acquireUseRelease2, "acquireUseRelease"),
  addFinalizer: /* @__PURE__ */ __name(() => addFinalizer2, "addFinalizer"),
  all: /* @__PURE__ */ __name(() => all4, "all"),
  allSuccesses: /* @__PURE__ */ __name(() => allSuccesses2, "allSuccesses"),
  allWith: /* @__PURE__ */ __name(() => allWith2, "allWith"),
  allowInterrupt: /* @__PURE__ */ __name(() => allowInterrupt2, "allowInterrupt"),
  andThen: /* @__PURE__ */ __name(() => andThen5, "andThen"),
  annotateCurrentSpan: /* @__PURE__ */ __name(() => annotateCurrentSpan2, "annotateCurrentSpan"),
  annotateLogs: /* @__PURE__ */ __name(() => annotateLogs3, "annotateLogs"),
  annotateLogsScoped: /* @__PURE__ */ __name(() => annotateLogsScoped2, "annotateLogsScoped"),
  annotateSpans: /* @__PURE__ */ __name(() => annotateSpans3, "annotateSpans"),
  ap: /* @__PURE__ */ __name(() => ap, "ap"),
  as: /* @__PURE__ */ __name(() => as6, "as"),
  asSome: /* @__PURE__ */ __name(() => asSome2, "asSome"),
  asSomeError: /* @__PURE__ */ __name(() => asSomeError2, "asSomeError"),
  asVoid: /* @__PURE__ */ __name(() => asVoid4, "asVoid"),
  async: /* @__PURE__ */ __name(() => async2, "async"),
  asyncEffect: /* @__PURE__ */ __name(() => asyncEffect2, "asyncEffect"),
  awaitAllChildren: /* @__PURE__ */ __name(() => awaitAllChildren2, "awaitAllChildren"),
  bind: /* @__PURE__ */ __name(() => bind3, "bind"),
  bindAll: /* @__PURE__ */ __name(() => bindAll2, "bindAll"),
  bindTo: /* @__PURE__ */ __name(() => bindTo3, "bindTo"),
  blocked: /* @__PURE__ */ __name(() => blocked2, "blocked"),
  cacheRequestResult: /* @__PURE__ */ __name(() => cacheRequestResult, "cacheRequestResult"),
  cached: /* @__PURE__ */ __name(() => cached3, "cached"),
  cachedFunction: /* @__PURE__ */ __name(() => cachedFunction2, "cachedFunction"),
  cachedInvalidateWithTTL: /* @__PURE__ */ __name(() => cachedInvalidateWithTTL2, "cachedInvalidateWithTTL"),
  cachedWithTTL: /* @__PURE__ */ __name(() => cachedWithTTL, "cachedWithTTL"),
  catch: /* @__PURE__ */ __name(() => _catch2, "catch"),
  catchAll: /* @__PURE__ */ __name(() => catchAll3, "catchAll"),
  catchAllCause: /* @__PURE__ */ __name(() => catchAllCause3, "catchAllCause"),
  catchAllDefect: /* @__PURE__ */ __name(() => catchAllDefect2, "catchAllDefect"),
  catchIf: /* @__PURE__ */ __name(() => catchIf2, "catchIf"),
  catchSome: /* @__PURE__ */ __name(() => catchSome2, "catchSome"),
  catchSomeCause: /* @__PURE__ */ __name(() => catchSomeCause2, "catchSomeCause"),
  catchSomeDefect: /* @__PURE__ */ __name(() => catchSomeDefect2, "catchSomeDefect"),
  catchTag: /* @__PURE__ */ __name(() => catchTag2, "catchTag"),
  catchTags: /* @__PURE__ */ __name(() => catchTags2, "catchTags"),
  cause: /* @__PURE__ */ __name(() => cause2, "cause"),
  checkInterruptible: /* @__PURE__ */ __name(() => checkInterruptible2, "checkInterruptible"),
  clock: /* @__PURE__ */ __name(() => clock2, "clock"),
  clockWith: /* @__PURE__ */ __name(() => clockWith4, "clockWith"),
  configProviderWith: /* @__PURE__ */ __name(() => configProviderWith2, "configProviderWith"),
  console: /* @__PURE__ */ __name(() => console3, "console"),
  consoleWith: /* @__PURE__ */ __name(() => consoleWith2, "consoleWith"),
  context: /* @__PURE__ */ __name(() => context3, "context"),
  contextWith: /* @__PURE__ */ __name(() => contextWith2, "contextWith"),
  contextWithEffect: /* @__PURE__ */ __name(() => contextWithEffect2, "contextWithEffect"),
  currentParentSpan: /* @__PURE__ */ __name(() => currentParentSpan2, "currentParentSpan"),
  currentSpan: /* @__PURE__ */ __name(() => currentSpan2, "currentSpan"),
  custom: /* @__PURE__ */ __name(() => custom2, "custom"),
  daemonChildren: /* @__PURE__ */ __name(() => daemonChildren2, "daemonChildren"),
  delay: /* @__PURE__ */ __name(() => delay2, "delay"),
  descriptor: /* @__PURE__ */ __name(() => descriptor2, "descriptor"),
  descriptorWith: /* @__PURE__ */ __name(() => descriptorWith2, "descriptorWith"),
  die: /* @__PURE__ */ __name(() => die6, "die"),
  dieMessage: /* @__PURE__ */ __name(() => dieMessage2, "dieMessage"),
  dieSync: /* @__PURE__ */ __name(() => dieSync3, "dieSync"),
  diffFiberRefs: /* @__PURE__ */ __name(() => diffFiberRefs2, "diffFiberRefs"),
  disconnect: /* @__PURE__ */ __name(() => disconnect2, "disconnect"),
  dropUntil: /* @__PURE__ */ __name(() => dropUntil2, "dropUntil"),
  dropWhile: /* @__PURE__ */ __name(() => dropWhile2, "dropWhile"),
  either: /* @__PURE__ */ __name(() => either3, "either"),
  ensureErrorType: /* @__PURE__ */ __name(() => ensureErrorType, "ensureErrorType"),
  ensureRequirementsType: /* @__PURE__ */ __name(() => ensureRequirementsType, "ensureRequirementsType"),
  ensureSuccessType: /* @__PURE__ */ __name(() => ensureSuccessType, "ensureSuccessType"),
  ensuring: /* @__PURE__ */ __name(() => ensuring2, "ensuring"),
  ensuringChild: /* @__PURE__ */ __name(() => ensuringChild2, "ensuringChild"),
  ensuringChildren: /* @__PURE__ */ __name(() => ensuringChildren2, "ensuringChildren"),
  eventually: /* @__PURE__ */ __name(() => eventually2, "eventually"),
  every: /* @__PURE__ */ __name(() => every5, "every"),
  exists: /* @__PURE__ */ __name(() => exists3, "exists"),
  exit: /* @__PURE__ */ __name(() => exit3, "exit"),
  fail: /* @__PURE__ */ __name(() => fail7, "fail"),
  failCause: /* @__PURE__ */ __name(() => failCause6, "failCause"),
  failCauseSync: /* @__PURE__ */ __name(() => failCauseSync3, "failCauseSync"),
  failSync: /* @__PURE__ */ __name(() => failSync3, "failSync"),
  fiberId: /* @__PURE__ */ __name(() => fiberId2, "fiberId"),
  fiberIdWith: /* @__PURE__ */ __name(() => fiberIdWith2, "fiberIdWith"),
  filter: /* @__PURE__ */ __name(() => filter7, "filter"),
  filterEffectOrElse: /* @__PURE__ */ __name(() => filterEffectOrElse2, "filterEffectOrElse"),
  filterEffectOrFail: /* @__PURE__ */ __name(() => filterEffectOrFail2, "filterEffectOrFail"),
  filterMap: /* @__PURE__ */ __name(() => filterMap4, "filterMap"),
  filterOrDie: /* @__PURE__ */ __name(() => filterOrDie2, "filterOrDie"),
  filterOrDieMessage: /* @__PURE__ */ __name(() => filterOrDieMessage2, "filterOrDieMessage"),
  filterOrElse: /* @__PURE__ */ __name(() => filterOrElse2, "filterOrElse"),
  filterOrFail: /* @__PURE__ */ __name(() => filterOrFail2, "filterOrFail"),
  finalizersMask: /* @__PURE__ */ __name(() => finalizersMask2, "finalizersMask"),
  findFirst: /* @__PURE__ */ __name(() => findFirst5, "findFirst"),
  firstSuccessOf: /* @__PURE__ */ __name(() => firstSuccessOf2, "firstSuccessOf"),
  flatMap: /* @__PURE__ */ __name(() => flatMap12, "flatMap"),
  flatten: /* @__PURE__ */ __name(() => flatten8, "flatten"),
  flip: /* @__PURE__ */ __name(() => flip2, "flip"),
  flipWith: /* @__PURE__ */ __name(() => flipWith2, "flipWith"),
  fn: /* @__PURE__ */ __name(() => fn, "fn"),
  fnUntraced: /* @__PURE__ */ __name(() => fnUntraced2, "fnUntraced"),
  forEach: /* @__PURE__ */ __name(() => forEach8, "forEach"),
  forever: /* @__PURE__ */ __name(() => forever3, "forever"),
  fork: /* @__PURE__ */ __name(() => fork3, "fork"),
  forkAll: /* @__PURE__ */ __name(() => forkAll2, "forkAll"),
  forkDaemon: /* @__PURE__ */ __name(() => forkDaemon2, "forkDaemon"),
  forkIn: /* @__PURE__ */ __name(() => forkIn2, "forkIn"),
  forkScoped: /* @__PURE__ */ __name(() => forkScoped2, "forkScoped"),
  forkWithErrorHandler: /* @__PURE__ */ __name(() => forkWithErrorHandler2, "forkWithErrorHandler"),
  fromFiber: /* @__PURE__ */ __name(() => fromFiber2, "fromFiber"),
  fromFiberEffect: /* @__PURE__ */ __name(() => fromFiberEffect2, "fromFiberEffect"),
  fromNullable: /* @__PURE__ */ __name(() => fromNullable3, "fromNullable"),
  functionWithSpan: /* @__PURE__ */ __name(() => functionWithSpan2, "functionWithSpan"),
  gen: /* @__PURE__ */ __name(() => gen2, "gen"),
  getFiberRefs: /* @__PURE__ */ __name(() => getFiberRefs, "getFiberRefs"),
  getRuntimeFlags: /* @__PURE__ */ __name(() => getRuntimeFlags, "getRuntimeFlags"),
  head: /* @__PURE__ */ __name(() => head4, "head"),
  if: /* @__PURE__ */ __name(() => if_2, "if"),
  ignore: /* @__PURE__ */ __name(() => ignore2, "ignore"),
  ignoreLogged: /* @__PURE__ */ __name(() => ignoreLogged2, "ignoreLogged"),
  inheritFiberRefs: /* @__PURE__ */ __name(() => inheritFiberRefs2, "inheritFiberRefs"),
  interrupt: /* @__PURE__ */ __name(() => interrupt6, "interrupt"),
  interruptWith: /* @__PURE__ */ __name(() => interruptWith2, "interruptWith"),
  interruptible: /* @__PURE__ */ __name(() => interruptible4, "interruptible"),
  interruptibleMask: /* @__PURE__ */ __name(() => interruptibleMask2, "interruptibleMask"),
  intoDeferred: /* @__PURE__ */ __name(() => intoDeferred2, "intoDeferred"),
  isEffect: /* @__PURE__ */ __name(() => isEffect2, "isEffect"),
  isFailure: /* @__PURE__ */ __name(() => isFailure5, "isFailure"),
  isSuccess: /* @__PURE__ */ __name(() => isSuccess3, "isSuccess"),
  iterate: /* @__PURE__ */ __name(() => iterate2, "iterate"),
  labelMetrics: /* @__PURE__ */ __name(() => labelMetrics2, "labelMetrics"),
  labelMetricsScoped: /* @__PURE__ */ __name(() => labelMetricsScoped2, "labelMetricsScoped"),
  let: /* @__PURE__ */ __name(() => let_3, "let"),
  liftPredicate: /* @__PURE__ */ __name(() => liftPredicate2, "liftPredicate"),
  linkSpanCurrent: /* @__PURE__ */ __name(() => linkSpanCurrent2, "linkSpanCurrent"),
  linkSpans: /* @__PURE__ */ __name(() => linkSpans2, "linkSpans"),
  locally: /* @__PURE__ */ __name(() => locally, "locally"),
  locallyScoped: /* @__PURE__ */ __name(() => locallyScoped, "locallyScoped"),
  locallyScopedWith: /* @__PURE__ */ __name(() => locallyScopedWith, "locallyScopedWith"),
  locallyWith: /* @__PURE__ */ __name(() => locallyWith, "locallyWith"),
  log: /* @__PURE__ */ __name(() => log2, "log"),
  logAnnotations: /* @__PURE__ */ __name(() => logAnnotations2, "logAnnotations"),
  logDebug: /* @__PURE__ */ __name(() => logDebug2, "logDebug"),
  logError: /* @__PURE__ */ __name(() => logError2, "logError"),
  logFatal: /* @__PURE__ */ __name(() => logFatal2, "logFatal"),
  logInfo: /* @__PURE__ */ __name(() => logInfo2, "logInfo"),
  logTrace: /* @__PURE__ */ __name(() => logTrace2, "logTrace"),
  logWarning: /* @__PURE__ */ __name(() => logWarning2, "logWarning"),
  logWithLevel: /* @__PURE__ */ __name(() => logWithLevel2, "logWithLevel"),
  loop: /* @__PURE__ */ __name(() => loop2, "loop"),
  makeLatch: /* @__PURE__ */ __name(() => makeLatch2, "makeLatch"),
  makeSemaphore: /* @__PURE__ */ __name(() => makeSemaphore2, "makeSemaphore"),
  makeSpan: /* @__PURE__ */ __name(() => makeSpan2, "makeSpan"),
  makeSpanScoped: /* @__PURE__ */ __name(() => makeSpanScoped2, "makeSpanScoped"),
  map: /* @__PURE__ */ __name(() => map14, "map"),
  mapAccum: /* @__PURE__ */ __name(() => mapAccum3, "mapAccum"),
  mapBoth: /* @__PURE__ */ __name(() => mapBoth3, "mapBoth"),
  mapError: /* @__PURE__ */ __name(() => mapError4, "mapError"),
  mapErrorCause: /* @__PURE__ */ __name(() => mapErrorCause3, "mapErrorCause"),
  mapInputContext: /* @__PURE__ */ __name(() => mapInputContext2, "mapInputContext"),
  match: /* @__PURE__ */ __name(() => match13, "match"),
  matchCause: /* @__PURE__ */ __name(() => matchCause4, "matchCause"),
  matchCauseEffect: /* @__PURE__ */ __name(() => matchCauseEffect3, "matchCauseEffect"),
  matchEffect: /* @__PURE__ */ __name(() => matchEffect3, "matchEffect"),
  merge: /* @__PURE__ */ __name(() => merge7, "merge"),
  mergeAll: /* @__PURE__ */ __name(() => mergeAll5, "mergeAll"),
  metricLabels: /* @__PURE__ */ __name(() => metricLabels2, "metricLabels"),
  negate: /* @__PURE__ */ __name(() => negate2, "negate"),
  never: /* @__PURE__ */ __name(() => never2, "never"),
  none: /* @__PURE__ */ __name(() => none9, "none"),
  onError: /* @__PURE__ */ __name(() => onError2, "onError"),
  onExit: /* @__PURE__ */ __name(() => onExit3, "onExit"),
  onInterrupt: /* @__PURE__ */ __name(() => onInterrupt2, "onInterrupt"),
  once: /* @__PURE__ */ __name(() => once3, "once"),
  option: /* @__PURE__ */ __name(() => option2, "option"),
  optionFromOptional: /* @__PURE__ */ __name(() => optionFromOptional2, "optionFromOptional"),
  orDie: /* @__PURE__ */ __name(() => orDie3, "orDie"),
  orDieWith: /* @__PURE__ */ __name(() => orDieWith2, "orDieWith"),
  orElse: /* @__PURE__ */ __name(() => orElse3, "orElse"),
  orElseFail: /* @__PURE__ */ __name(() => orElseFail2, "orElseFail"),
  orElseSucceed: /* @__PURE__ */ __name(() => orElseSucceed2, "orElseSucceed"),
  parallelErrors: /* @__PURE__ */ __name(() => parallelErrors2, "parallelErrors"),
  parallelFinalizers: /* @__PURE__ */ __name(() => parallelFinalizers2, "parallelFinalizers"),
  partition: /* @__PURE__ */ __name(() => partition4, "partition"),
  patchFiberRefs: /* @__PURE__ */ __name(() => patchFiberRefs2, "patchFiberRefs"),
  patchRuntimeFlags: /* @__PURE__ */ __name(() => patchRuntimeFlags, "patchRuntimeFlags"),
  promise: /* @__PURE__ */ __name(() => promise2, "promise"),
  provide: /* @__PURE__ */ __name(() => provide2, "provide"),
  provideService: /* @__PURE__ */ __name(() => provideService2, "provideService"),
  provideServiceEffect: /* @__PURE__ */ __name(() => provideServiceEffect2, "provideServiceEffect"),
  race: /* @__PURE__ */ __name(() => race2, "race"),
  raceAll: /* @__PURE__ */ __name(() => raceAll2, "raceAll"),
  raceFirst: /* @__PURE__ */ __name(() => raceFirst2, "raceFirst"),
  raceWith: /* @__PURE__ */ __name(() => raceWith2, "raceWith"),
  random: /* @__PURE__ */ __name(() => random3, "random"),
  randomWith: /* @__PURE__ */ __name(() => randomWith2, "randomWith"),
  reduce: /* @__PURE__ */ __name(() => reduce11, "reduce"),
  reduceEffect: /* @__PURE__ */ __name(() => reduceEffect2, "reduceEffect"),
  reduceRight: /* @__PURE__ */ __name(() => reduceRight3, "reduceRight"),
  reduceWhile: /* @__PURE__ */ __name(() => reduceWhile2, "reduceWhile"),
  repeat: /* @__PURE__ */ __name(() => repeat, "repeat"),
  repeatN: /* @__PURE__ */ __name(() => repeatN2, "repeatN"),
  repeatOrElse: /* @__PURE__ */ __name(() => repeatOrElse, "repeatOrElse"),
  replicate: /* @__PURE__ */ __name(() => replicate2, "replicate"),
  replicateEffect: /* @__PURE__ */ __name(() => replicateEffect2, "replicateEffect"),
  request: /* @__PURE__ */ __name(() => request, "request"),
  retry: /* @__PURE__ */ __name(() => retry2, "retry"),
  retryOrElse: /* @__PURE__ */ __name(() => retryOrElse, "retryOrElse"),
  runCallback: /* @__PURE__ */ __name(() => runCallback, "runCallback"),
  runFork: /* @__PURE__ */ __name(() => runFork2, "runFork"),
  runPromise: /* @__PURE__ */ __name(() => runPromise, "runPromise"),
  runPromiseExit: /* @__PURE__ */ __name(() => runPromiseExit, "runPromiseExit"),
  runRequestBlock: /* @__PURE__ */ __name(() => runRequestBlock2, "runRequestBlock"),
  runSync: /* @__PURE__ */ __name(() => runSync, "runSync"),
  runSyncExit: /* @__PURE__ */ __name(() => runSyncExit, "runSyncExit"),
  runtime: /* @__PURE__ */ __name(() => runtime3, "runtime"),
  sandbox: /* @__PURE__ */ __name(() => sandbox2, "sandbox"),
  schedule: /* @__PURE__ */ __name(() => schedule, "schedule"),
  scheduleForked: /* @__PURE__ */ __name(() => scheduleForked2, "scheduleForked"),
  scheduleFrom: /* @__PURE__ */ __name(() => scheduleFrom, "scheduleFrom"),
  scope: /* @__PURE__ */ __name(() => scope3, "scope"),
  scopeWith: /* @__PURE__ */ __name(() => scopeWith2, "scopeWith"),
  scoped: /* @__PURE__ */ __name(() => scoped2, "scoped"),
  scopedWith: /* @__PURE__ */ __name(() => scopedWith2, "scopedWith"),
  sequentialFinalizers: /* @__PURE__ */ __name(() => sequentialFinalizers2, "sequentialFinalizers"),
  serviceConstants: /* @__PURE__ */ __name(() => serviceConstants2, "serviceConstants"),
  serviceFunction: /* @__PURE__ */ __name(() => serviceFunction2, "serviceFunction"),
  serviceFunctionEffect: /* @__PURE__ */ __name(() => serviceFunctionEffect2, "serviceFunctionEffect"),
  serviceFunctions: /* @__PURE__ */ __name(() => serviceFunctions2, "serviceFunctions"),
  serviceMembers: /* @__PURE__ */ __name(() => serviceMembers2, "serviceMembers"),
  serviceOption: /* @__PURE__ */ __name(() => serviceOption2, "serviceOption"),
  serviceOptional: /* @__PURE__ */ __name(() => serviceOptional2, "serviceOptional"),
  setFiberRefs: /* @__PURE__ */ __name(() => setFiberRefs2, "setFiberRefs"),
  sleep: /* @__PURE__ */ __name(() => sleep4, "sleep"),
  spanAnnotations: /* @__PURE__ */ __name(() => spanAnnotations2, "spanAnnotations"),
  spanLinks: /* @__PURE__ */ __name(() => spanLinks2, "spanLinks"),
  step: /* @__PURE__ */ __name(() => step3, "step"),
  succeed: /* @__PURE__ */ __name(() => succeed6, "succeed"),
  succeedNone: /* @__PURE__ */ __name(() => succeedNone2, "succeedNone"),
  succeedSome: /* @__PURE__ */ __name(() => succeedSome2, "succeedSome"),
  summarized: /* @__PURE__ */ __name(() => summarized2, "summarized"),
  supervised: /* @__PURE__ */ __name(() => supervised2, "supervised"),
  suspend: /* @__PURE__ */ __name(() => suspend4, "suspend"),
  sync: /* @__PURE__ */ __name(() => sync4, "sync"),
  tagMetrics: /* @__PURE__ */ __name(() => tagMetrics2, "tagMetrics"),
  tagMetricsScoped: /* @__PURE__ */ __name(() => tagMetricsScoped2, "tagMetricsScoped"),
  takeUntil: /* @__PURE__ */ __name(() => takeUntil2, "takeUntil"),
  takeWhile: /* @__PURE__ */ __name(() => takeWhile2, "takeWhile"),
  tap: /* @__PURE__ */ __name(() => tap3, "tap"),
  tapBoth: /* @__PURE__ */ __name(() => tapBoth2, "tapBoth"),
  tapDefect: /* @__PURE__ */ __name(() => tapDefect2, "tapDefect"),
  tapError: /* @__PURE__ */ __name(() => tapError3, "tapError"),
  tapErrorCause: /* @__PURE__ */ __name(() => tapErrorCause3, "tapErrorCause"),
  tapErrorTag: /* @__PURE__ */ __name(() => tapErrorTag2, "tapErrorTag"),
  timed: /* @__PURE__ */ __name(() => timed2, "timed"),
  timedWith: /* @__PURE__ */ __name(() => timedWith2, "timedWith"),
  timeout: /* @__PURE__ */ __name(() => timeout2, "timeout"),
  timeoutFail: /* @__PURE__ */ __name(() => timeoutFail2, "timeoutFail"),
  timeoutFailCause: /* @__PURE__ */ __name(() => timeoutFailCause2, "timeoutFailCause"),
  timeoutOption: /* @__PURE__ */ __name(() => timeoutOption2, "timeoutOption"),
  timeoutTo: /* @__PURE__ */ __name(() => timeoutTo2, "timeoutTo"),
  tracer: /* @__PURE__ */ __name(() => tracer2, "tracer"),
  tracerWith: /* @__PURE__ */ __name(() => tracerWith4, "tracerWith"),
  transplant: /* @__PURE__ */ __name(() => transplant2, "transplant"),
  transposeMapOption: /* @__PURE__ */ __name(() => transposeMapOption, "transposeMapOption"),
  transposeOption: /* @__PURE__ */ __name(() => transposeOption, "transposeOption"),
  try: /* @__PURE__ */ __name(() => try_2, "try"),
  tryMap: /* @__PURE__ */ __name(() => tryMap2, "tryMap"),
  tryMapPromise: /* @__PURE__ */ __name(() => tryMapPromise2, "tryMapPromise"),
  tryPromise: /* @__PURE__ */ __name(() => tryPromise2, "tryPromise"),
  uninterruptible: /* @__PURE__ */ __name(() => uninterruptible2, "uninterruptible"),
  uninterruptibleMask: /* @__PURE__ */ __name(() => uninterruptibleMask3, "uninterruptibleMask"),
  unless: /* @__PURE__ */ __name(() => unless2, "unless"),
  unlessEffect: /* @__PURE__ */ __name(() => unlessEffect2, "unlessEffect"),
  unsafeMakeLatch: /* @__PURE__ */ __name(() => unsafeMakeLatch2, "unsafeMakeLatch"),
  unsafeMakeSemaphore: /* @__PURE__ */ __name(() => unsafeMakeSemaphore2, "unsafeMakeSemaphore"),
  unsandbox: /* @__PURE__ */ __name(() => unsandbox2, "unsandbox"),
  updateFiberRefs: /* @__PURE__ */ __name(() => updateFiberRefs2, "updateFiberRefs"),
  updateService: /* @__PURE__ */ __name(() => updateService2, "updateService"),
  useSpan: /* @__PURE__ */ __name(() => useSpan2, "useSpan"),
  using: /* @__PURE__ */ __name(() => using2, "using"),
  validate: /* @__PURE__ */ __name(() => validate2, "validate"),
  validateAll: /* @__PURE__ */ __name(() => validateAll2, "validateAll"),
  validateFirst: /* @__PURE__ */ __name(() => validateFirst2, "validateFirst"),
  validateWith: /* @__PURE__ */ __name(() => validateWith2, "validateWith"),
  void: /* @__PURE__ */ __name(() => _void, "void"),
  when: /* @__PURE__ */ __name(() => when2, "when"),
  whenEffect: /* @__PURE__ */ __name(() => whenEffect2, "whenEffect"),
  whenFiberRef: /* @__PURE__ */ __name(() => whenFiberRef2, "whenFiberRef"),
  whenLogLevel: /* @__PURE__ */ __name(() => whenLogLevel2, "whenLogLevel"),
  whenRef: /* @__PURE__ */ __name(() => whenRef2, "whenRef"),
  whileLoop: /* @__PURE__ */ __name(() => whileLoop3, "whileLoop"),
  withClock: /* @__PURE__ */ __name(() => withClock2, "withClock"),
  withClockScoped: /* @__PURE__ */ __name(() => withClockScoped2, "withClockScoped"),
  withConcurrency: /* @__PURE__ */ __name(() => withConcurrency2, "withConcurrency"),
  withConfigProvider: /* @__PURE__ */ __name(() => withConfigProvider2, "withConfigProvider"),
  withConfigProviderScoped: /* @__PURE__ */ __name(() => withConfigProviderScoped2, "withConfigProviderScoped"),
  withConsole: /* @__PURE__ */ __name(() => withConsole2, "withConsole"),
  withConsoleScoped: /* @__PURE__ */ __name(() => withConsoleScoped2, "withConsoleScoped"),
  withEarlyRelease: /* @__PURE__ */ __name(() => withEarlyRelease2, "withEarlyRelease"),
  withExecutionPlan: /* @__PURE__ */ __name(() => withExecutionPlan2, "withExecutionPlan"),
  withFiberRuntime: /* @__PURE__ */ __name(() => withFiberRuntime2, "withFiberRuntime"),
  withLogSpan: /* @__PURE__ */ __name(() => withLogSpan2, "withLogSpan"),
  withMaxOpsBeforeYield: /* @__PURE__ */ __name(() => withMaxOpsBeforeYield2, "withMaxOpsBeforeYield"),
  withMetric: /* @__PURE__ */ __name(() => withMetric2, "withMetric"),
  withParentSpan: /* @__PURE__ */ __name(() => withParentSpan3, "withParentSpan"),
  withRandom: /* @__PURE__ */ __name(() => withRandom2, "withRandom"),
  withRandomFixed: /* @__PURE__ */ __name(() => withRandomFixed, "withRandomFixed"),
  withRandomScoped: /* @__PURE__ */ __name(() => withRandomScoped2, "withRandomScoped"),
  withRequestBatching: /* @__PURE__ */ __name(() => withRequestBatching2, "withRequestBatching"),
  withRequestCache: /* @__PURE__ */ __name(() => withRequestCache2, "withRequestCache"),
  withRequestCaching: /* @__PURE__ */ __name(() => withRequestCaching2, "withRequestCaching"),
  withRuntimeFlagsPatch: /* @__PURE__ */ __name(() => withRuntimeFlagsPatch, "withRuntimeFlagsPatch"),
  withRuntimeFlagsPatchScoped: /* @__PURE__ */ __name(() => withRuntimeFlagsPatchScoped, "withRuntimeFlagsPatchScoped"),
  withScheduler: /* @__PURE__ */ __name(() => withScheduler2, "withScheduler"),
  withSchedulingPriority: /* @__PURE__ */ __name(() => withSchedulingPriority2, "withSchedulingPriority"),
  withSpan: /* @__PURE__ */ __name(() => withSpan3, "withSpan"),
  withSpanScoped: /* @__PURE__ */ __name(() => withSpanScoped2, "withSpanScoped"),
  withTracer: /* @__PURE__ */ __name(() => withTracer2, "withTracer"),
  withTracerEnabled: /* @__PURE__ */ __name(() => withTracerEnabled2, "withTracerEnabled"),
  withTracerScoped: /* @__PURE__ */ __name(() => withTracerScoped2, "withTracerScoped"),
  withTracerTiming: /* @__PURE__ */ __name(() => withTracerTiming2, "withTracerTiming"),
  withUnhandledErrorLogLevel: /* @__PURE__ */ __name(() => withUnhandledErrorLogLevel2, "withUnhandledErrorLogLevel"),
  yieldNow: /* @__PURE__ */ __name(() => yieldNow4, "yieldNow"),
  zip: /* @__PURE__ */ __name(() => zip5, "zip"),
  zipLeft: /* @__PURE__ */ __name(() => zipLeft3, "zipLeft"),
  zipRight: /* @__PURE__ */ __name(() => zipRight3, "zipRight"),
  zipWith: /* @__PURE__ */ __name(() => zipWith5, "zipWith")
});
...
var make34 = /* @__PURE__ */ __name2((startMillis, endMillis) => {
...
var isEmpty8 = /* @__PURE__ */ __name2((self) => {
...
var after = /* @__PURE__ */ __name2((startMilliseconds) => {
...
var make36 = /* @__PURE__ */ __name2((intervals) => {
  return {
...
var intersectLoop = /* @__PURE__ */ __name2((_left, _right, _acc) => {
  let left3 = _left;
  let right3 = _right;
  let acc = _acc;
...
var isNonEmpty3 = /* @__PURE__ */ __name2((self) => {
...
var OP_DONE2 = "Done";
var _continue = /* @__PURE__ */ __name2((intervals) => {
  return {
    _tag: OP_CONTINUE,
    intervals
  };
}, "_continue");
var continueWith = /* @__PURE__ */ __name2((interval) => {
  return {
    _tag: OP_CONTINUE,
...
var isContinue = /* @__PURE__ */ __name2((self) => {
  return self._tag === OP_CONTINUE;
}, "isContinue");
var isDone3 = /* @__PURE__ */ __name2((self) => {
...
var Semaphore = class {
  ...
  take = /* @__PURE__ */ __name2((n) => asyncInterrupt((resume2) => {
    if (this.free < n) {
      const observer = /* @__PURE__ */ __name2(() => {
        if (this.free < n) {
          return;
        }
  ...
  resize = /* @__PURE__ */ __name2((permits) => asVoid(withFiberRuntime((fiber) => {
    this.permits = permits;
    if (this.free < 0) {
      return void_;
    }
  ...
  release = /* @__PURE__ */ __name2((n) => this.updateTaken((taken) => taken - n), "release");
  releaseAll = /* @__PURE__ */ this.updateTaken((_) => 0);
  withPermits = /* @__PURE__ */ __name2((n) => (self) => uninterruptibleMask((restore) => flatMap7(restore(this.take(n)), (permits) => ensuring(restore(self), this.release(permits)))), "withPermits");
  withPermitsIfAvailable = /* @__PURE__ */ __name2((n) => (self) => uninterruptibleMask((restore) => suspend(() => {
    if (this.free < n) {
      return succeedNone;
    }
    this.taken += n;
...
var unsafeMakeSemaphore = /* @__PURE__ */ __name2((permits) => new Semaphore(permits), "unsafeMakeSemaphore");
var makeSemaphore = /* @__PURE__ */ __name2((permits) => sync(() => unsafeMakeSemaphore(permits)), "makeSemaphore");
var Latch = class extends Class2 {
  ...
  whenOpen = /* @__PURE__ */ __name2((self) => {
    return zipRight(this.await, self);
  }, "whenOpen");
};
var unsafeMakeLatch = /* @__PURE__ */ __name2((open) => new Latch(open ?? false), "unsafeMakeLatch");
var makeLatch = /* @__PURE__ */ __name2((open) => sync(() => unsafeMakeLatch(open)), "makeLatch");
var awaitAllChildren = /* @__PURE__ */ __name2((self) => ensuringChildren(self, fiberAwaitAll), "awaitAllChildren");
...
var computeCachedValue = /* @__PURE__ */ __name2((self, timeToLive, start3) => {
...
var getCachedValue = /* @__PURE__ */ __name2((self, timeToLive, cache) => uninterruptibleMask((restore) => pipe(clockWith3((clock3) => clock3.currentTimeMillis), flatMap7((time) => updateSomeAndGetEffectSynchronized(cache, (option3) => {
  switch (option3._tag) {
    case "None": {
...
var invalidateCache = /* @__PURE__ */ __name2((cache) => set5(cache, none2()), "invalidateCache");
...
var forkIn = /* @__PURE__ */ dual(2, (self, scope5) => withFiberRuntime((parent, parentStatus) => {
  ...
  if (scopeImpl.state._tag === "Open") {
    const finalizer = /* @__PURE__ */ __name2(() => fiberIdWith((fiberId3) => equals(fiberId3, fiber.id()) ? void_ : asVoid(interruptFiber(fiber))), "finalizer");
    const key = {};
...
var forkScoped = /* @__PURE__ */ __name2((self) => scopeWith((scope5) => forkIn(self, scope5)), "forkScoped");
var fromFiber = /* @__PURE__ */ __name2((fiber) => join2(fiber), "fromFiber");
var fromFiberEffect = /* @__PURE__ */ __name2((fiber) => suspend(() => flatMap7(fiber, join2)), "fromFiberEffect");
...
var cachedFunction = /* @__PURE__ */ __name2((f, eq) => {
...
var timeout = /* @__PURE__ */ dual(2, (self, duration) => timeoutFail(self, {
  onTimeout: /* @__PURE__ */ __name2(() => timeoutExceptionFromDuration(duration), "onTimeout"),
  duration
}));
var timeoutFail = /* @__PURE__ */ dual(2, (self, {
  ...
  onTimeout: /* @__PURE__ */ __name2(() => failSync(onTimeout), "onTimeout"),
  onSuccess: succeed,
  duration
})));
var timeoutFailCause = /* @__PURE__ */ dual(2, (self, {
  ...
  onTimeout: /* @__PURE__ */ __name2(() => failCauseSync(onTimeout), "onTimeout"),
  onSuccess: succeed,
  duration
})));
...
var makeSynchronized = /* @__PURE__ */ __name2((value) => sync(() => unsafeMakeSynchronized(value)), "makeSynchronized");
var unsafeMakeSynchronized = /* @__PURE__ */ __name2((value) => {
...
var makeDual = /* @__PURE__ */ __name2((f) => function() {
  if (arguments.length === 1) {
...
var AsyncFiberExceptionImpl = class extends Error {
  ...
  static {
    __name2(this, "AsyncFiberExceptionImpl");
  }
  fiber;
...
var asyncFiberException = /* @__PURE__ */ __name2((fiber) => {
  const limit = Error.stackTraceLimit;
...
var fiberFailure = /* @__PURE__ */ __name2((cause3) => {
  const limit = Error.stackTraceLimit;
  Error.stackTraceLimit = 0;
...
var fastPath = /* @__PURE__ */ __name2((effect2) => {
  const op = effect2;
  switch (op._op) {
    case "Failure":
    case "Success": {
...
var make38 = /* @__PURE__ */ __name2((options) => new RuntimeImpl(options.context, options.runtimeFlags, options.fiberRefs), "make");
var runtime2 = /* @__PURE__ */ __name2(() => withFiberRuntime((state, status) => succeed(new RuntimeImpl(state.getFiberRef(currentContext), status.runtimeFlags, state.getFiberRefs()))), "runtime");
...
var asyncEffect = /* @__PURE__ */ __name2((register2) => suspend(() => {
  let cleanup = void 0;
  return flatMap7(deferredMake(), (deferred) => flatMap7(runtime2(), (runtime4) => uninterruptibleMask((restore) => zipRight(fork(restore(matchCauseEffect(register2((cb) => unsafeRunCallback(runtime4)(intoDeferred(cb, deferred))), {
    onFailure: /* @__PURE__ */ __name2((cause3) => deferredFailCause(deferred, cause3), "onFailure"),
    onSuccess: /* @__PURE__ */ __name2((cleanup_) => {
      cleanup = cleanup_;
      return void_;
    }, "onSuccess")
...
var layerVariance = {
  /* c8 ignore next */
  _RIn: /* @__PURE__ */ __name2((_) => _, "_RIn"),
  /* c8 ignore next */
  _E: /* @__PURE__ */ __name2((_) => _, "_E"),
  /* c8 ignore next */
  _ROut: /* @__PURE__ */ __name2((_) => _, "_ROut")
};
var proto3 = {
...
var CurrentMemoMap = /* @__PURE__ */ Reference2()("effect/Layer/CurrentMemoMap", {
  defaultValue: /* @__PURE__ */ __name2(() => unsafeMakeMemoMap(), "defaultValue")
});
var isLayer = /* @__PURE__ */ __name2((u) => hasProperty(u, LayerTypeId), "isLayer");
var isFresh = /* @__PURE__ */ __name2((self) => {
    ...
    return pipe(modifyEffect(this.ref, (map16) => {
      ...
      if (inMap !== void 0) {
        ...
        const cached4 = pipe(acquire, flatMap7(([patch9, b]) => pipe(patchFiberRefs(patch9), as2(b))), onExit(exitMatch({
          onFailure: /* @__PURE__ */ __name2(() => void_, "onFailure"),
          onSuccess: /* @__PURE__ */ __name2(() => scopeAddFinalizerExit(scope5, release), "onSuccess")
        })));
      ...
      return pipe(make26(0), flatMap7((observers) => pipe(deferredMake(), flatMap7((deferred) => pipe(make26(() => void_), map8((finalizerRef) => {
        ...
        const memoized = [pipe(deferredAwait(deferred), onExit(exitMatchEffect({
          onFailure: /* @__PURE__ */ __name2(() => void_, "onFailure"),
          onSuccess: /* @__PURE__ */ __name2(() => update2(observers, (n) => n + 1), "onSuccess")
...
var unsafeMakeMemoMap = /* @__PURE__ */ __name2(() => new MemoMapImpl(unsafeMakeSynchronized(/* @__PURE__ */ new Map())), "unsafeMakeMemoMap");
var build = /* @__PURE__ */ __name2((self) => scopeWith((scope5) => buildWithScope(self, scope5)), "build");
...
var makeBuilder = /* @__PURE__ */ __name2((self, scope5, inMemoMap = false) => {
  const op = self;
  switch (op._op_layer) {
    case "Locally": {
    ...
    case "Fold": {
      return sync(() => (memoMap) => pipe(memoMap.getOrElseMemoize(op.layer, scope5), matchCauseEffect({
        onFailure: /* @__PURE__ */ __name2((cause3) => memoMap.getOrElseMemoize(op.failureK(cause3), scope5), "onFailure"),
        onSuccess: /* @__PURE__ */ __name2((value) => memoMap.getOrElseMemoize(op.successK(value), scope5), "onSuccess")
      })));
    }
    case "Fresh": {
...
var die5 = /* @__PURE__ */ __name2((defect) => failCause4(die4(defect)), "die");
var dieSync2 = /* @__PURE__ */ __name2((evaluate2) => failCauseSync2(() => die4(evaluate2())), "dieSync");
var discard = /* @__PURE__ */ __name2((self) => map12(self, () => empty3()), "discard");
var context2 = /* @__PURE__ */ __name2(() => fromEffectContext(context()), "context");
var extendScope = /* @__PURE__ */ __name2((self) => {
  const extendScope3 = Object.create(proto3);
  extendScope3._op_layer = OP_EXTEND_SCOPE;
  extendScope3.layer = self;
  return extendScope3;
}, "extendScope");
var fail5 = /* @__PURE__ */ __name2((error) => failCause4(fail4(error)), "fail");
var failSync2 = /* @__PURE__ */ __name2((evaluate2) => failCauseSync2(() => fail4(evaluate2())), "failSync");
var failCause4 = /* @__PURE__ */ __name2((cause3) => fromEffectContext(failCause(cause3)), "failCause");
var failCauseSync2 = /* @__PURE__ */ __name2((evaluate2) => fromEffectContext(failCauseSync(evaluate2)), "failCauseSync");
var flatMap11 = /* @__PURE__ */ dual(2, (self, f) => match12(self, {
  onFailure: fail5,
  onSuccess: f
}));
var flatten7 = /* @__PURE__ */ dual(2, (self, tag) => flatMap11(self, get3(tag)));
var fresh = /* @__PURE__ */ __name2((self) => {
...
var fromEffectDiscard = /* @__PURE__ */ __name2((effect2) => fromEffectContext(map8(effect2, () => empty3())), "fromEffectDiscard");
...
__name2(fromEffectContext, "fromEffectContext");
...
var fiberRefLocallyScoped2 = /* @__PURE__ */ __name2((self, value) => scopedDiscard(fiberRefLocallyScoped(self, value)), "fiberRefLocallyScoped");
var fiberRefLocallyScopedWith2 = /* @__PURE__ */ __name2((self, value) => scopedDiscard(fiberRefLocallyScopedWith(self, value)), "fiberRefLocallyScopedWith");
var fromFunction = /* @__PURE__ */ __name2((tagA, tagB, f) => fromEffectContext(map8(tagA, (a) => make5(tagB, f(a)))), "fromFunction");
var launch = /* @__PURE__ */ __name2((self) => scopedEffect(zipRight(scopeWith((scope5) => pipe(self, buildWithScope(scope5))), never)), "launch");
var mock = /* @__PURE__ */ __name2(function() {
  if (arguments.length === 1) {
    return (service3) => mockImpl(arguments[0], service3);
  }
  return mockImpl(arguments[0], arguments[1]);
}, "mock");
var mockImpl = /* @__PURE__ */ __name2((tag, service3) => succeed4(tag, new Proxy({
  ...service3
}, {
...
var makeUnimplemented = /* @__PURE__ */ __name2((error) => {
  const dead = die2(error);
  function unimplemented() {
    return dead;
  }
  __name(unimplemented, "unimplemented");
  __name2(unimplemented, "unimplemented");
...
var memoize2 = /* @__PURE__ */ __name2((self) => scopeWith((scope5) => map8(memoize(buildWithScope(self, scope5)), fromEffectContext)), "memoize");
var merge6 = /* @__PURE__ */ dual(2, (self, that) => zipWith4(self, that, (a, b) => merge3(a, b)));
var mergeAll4 = /* @__PURE__ */ __name2((...layers) => {
  const mergeAll7 = Object.create(proto3);
  mergeAll7._op_layer = OP_MERGE_ALL;
  mergeAll7.layers = layers;
  return mergeAll7;
}, "mergeAll");
var orDie2 = /* @__PURE__ */ __name2((self) => catchAll2(self, (defect) => die5(defect)), "orDie");
var orElse2 = /* @__PURE__ */ dual(2, (self, that) => catchAll2(self, that));
var passthrough = /* @__PURE__ */ __name2((self) => merge6(context2(), self), "passthrough");
...
var retryLoop = /* @__PURE__ */ __name2((self, schedule2, stateTag, state) => {
...
var retryUpdate = /* @__PURE__ */ __name2((schedule2, stateTag, error, state) => {
...
var scopedDiscard = /* @__PURE__ */ __name2((effect2) => scopedContext(pipe(effect2, as2(empty3()))), "scopedDiscard");
var scopedContext = /* @__PURE__ */ __name2((effect2) => {
...
var service = /* @__PURE__ */ __name2((tag) => fromEffect2(tag, tag), "service");
...
var syncContext = /* @__PURE__ */ __name2((evaluate2) => {
...
var toRuntime = /* @__PURE__ */ __name2((self) => pipe(scopeWith((scope5) => buildWithScope(self, scope5)), flatMap7((context5) => pipe(runtime2(), provideContext(context5)))), "toRuntime");
...
var provide = /* @__PURE__ */ dual(2, (self, that) => suspend3(() => {
  ...
  provideTo.first = Object.create(proto3, {
    ...
    zipK: {
      value: /* @__PURE__ */ __name2((a, b) => pipe(a, merge3(b)), "value")
    }
  });
...
var unwrapEffect = /* @__PURE__ */ __name2((self) => {
...
var unwrapScoped = /* @__PURE__ */ __name2((self) => {
...
var withSpan2 = /* @__PURE__ */ __name2(function() {
  const dataFirst = typeof arguments[0] !== "string";
  const name = dataFirst ? arguments[1] : arguments[0];
  const options = addSpanStackTrace(dataFirst ? arguments[2] : arguments[1]);
  if (dataFirst) {
...
var consoleWith = /* @__PURE__ */ __name2((f) => fiberRefGetWith(currentServices, (services) => f(get3(services, consoleTag))), "consoleWith");
var withConsole = /* @__PURE__ */ dual(2, (effect2, value) => fiberRefLocallyWith(effect2, currentServices, add2(consoleTag, value)));
var withConsoleScoped = /* @__PURE__ */ __name2((console4) => fiberRefLocallyScopedWith(currentServices, add2(consoleTag, console4)), "withConsoleScoped");
var Data_exports = {};
__export(Data_exports, {
  Class: /* @__PURE__ */ __name(() => Class3, "Class"),
  Error: /* @__PURE__ */ __name(() => Error3, "Error"),
  Structural: /* @__PURE__ */ __name(() => Structural2, "Structural"),
  TaggedClass: /* @__PURE__ */ __name(() => TaggedClass, "TaggedClass"),
  TaggedError: /* @__PURE__ */ __name(() => TaggedError, "TaggedError"),
  array: /* @__PURE__ */ __name(() => array3, "array"),
  case: /* @__PURE__ */ __name(() => _case, "case"),
  struct: /* @__PURE__ */ __name(() => struct2, "struct"),
  tagged: /* @__PURE__ */ __name(() => tagged2, "tagged"),
  taggedEnum: /* @__PURE__ */ __name(() => taggedEnum, "taggedEnum"),
  tuple: /* @__PURE__ */ __name(() => tuple, "tuple"),
  unsafeArray: /* @__PURE__ */ __name(() => unsafeArray, "unsafeArray"),
  unsafeStruct: /* @__PURE__ */ __name(() => unsafeStruct, "unsafeStruct")
});
var struct2 = struct;
var unsafeStruct = /* @__PURE__ */ __name2((as7) => Object.setPrototypeOf(as7, StructuralPrototype), "unsafeStruct");
var tuple = /* @__PURE__ */ __name2((...as7) => unsafeArray(as7), "tuple");
var array3 = /* @__PURE__ */ __name2((as7) => unsafeArray(as7.slice(0)), "array");
var unsafeArray = /* @__PURE__ */ __name2((as7) => Object.setPrototypeOf(as7, ArrayProto), "unsafeArray");
var _case = /* @__PURE__ */ __name2(() => (args2) => args2 === void 0 ? Object.create(StructuralPrototype) : struct2(args2), "_case");
var tagged2 = /* @__PURE__ */ __name2((tag) => (args2) => {
  const value = args2 === void 0 ? Object.create(StructuralPrototype) : struct2(args2);
  value._tag = tag;
  return value;
}, "tagged");
var Class3 = Structural;
var TaggedClass = /* @__PURE__ */ __name2((tag) => {
...
var taggedEnum = /* @__PURE__ */ __name2(() => new Proxy({}, {
...
__name2(taggedMatch, "taggedMatch");
...
var TaggedError = /* @__PURE__ */ __name2((tag) => {
  const O = {
...
var isSchedule = /* @__PURE__ */ __name2((u) => hasProperty(u, ScheduleTypeId), "isSchedule");
...
var CurrentIterationMetadata = /* @__PURE__ */ Reference2()("effect/Schedule/CurrentIterationMetadata", {
  defaultValue: /* @__PURE__ */ __name2(() => defaultIterationMetadata, "defaultValue")
});
...
var updateInfo = /* @__PURE__ */ __name2((iterationMetaRef, now, input, output) => update2(iterationMetaRef, (prev) => prev.recurrence === 0 ? {
  now,
  input,
  output,
...
var ScheduleDriverImpl = class {
  ...
  static {
    __name2(this, "ScheduleDriverImpl");
  }
  schedule;
  ref;
...
var makeWithState = /* @__PURE__ */ __name2((initial, step4) => new ScheduleImpl(initial, step4), "makeWithState");
var asVoid3 = /* @__PURE__ */ __name2((self) => map13(self, constVoid), "asVoid");
...
var driver = /* @__PURE__ */ __name2((self) => pipe(make26([none2(), self.initial]), map8((ref) => new ScheduleDriverImpl(self, ref))), "driver");
...
var intersectWithLoop = /* @__PURE__ */ __name2((self, that, input, lState, out, lInterval, rState, out2, rInterval, f) => {
...
var passthrough2 = /* @__PURE__ */ __name2((self) => makeWithState(self.initial, (now, input, state) => pipe(self.step(now, input, state), map8(([state2, _, decision]) => [state2, input, decision]))), "passthrough");
var recurs = /* @__PURE__ */ __name2((n) => whileOutput(forever2, (out) => out < n), "recurs");
var unfold2 = /* @__PURE__ */ __name2((initial, f) => makeWithState(initial, (now, _, state) => sync(() => [f(state), state, continueWith2(after2(now))])), "unfold");
...
var isScheduleDefect = /* @__PURE__ */ __name2((u) => hasProperty(u, ScheduleDefectTypeId), "isScheduleDefect");
var scheduleDefectWrap = /* @__PURE__ */ __name2((self) => catchAll(self, (e) => die2(new ScheduleDefect(e))), "scheduleDefectWrap");
var scheduleDefectRefailCause = /* @__PURE__ */ __name2((cause3) => match3(find(cause3, (_) => isDieType(_) && isScheduleDefect(_.defect) ? some2(_.defect) : none2()), {
  onNone: /* @__PURE__ */ __name2(() => cause3, "onNone"),
  onSome: /* @__PURE__ */ __name2((error) => fail(error.error), "onSome")
}), "scheduleDefectRefailCause");
var scheduleDefectRefail = /* @__PURE__ */ __name2((effect2) => catchAllCause(effect2, (cause3) => failCause(scheduleDefectRefailCause(cause3))), "scheduleDefectRefail");
...
var repeatOrElse_Effect = /* @__PURE__ */ dual(3, (self, schedule2, orElse5) => flatMap7(driver(schedule2), (driver2) => matchEffect(self, {
  onFailure: /* @__PURE__ */ __name2((error) => orElse5(error, none2()), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((value) => repeatOrElseEffectLoop(provideServiceEffect(self, CurrentIterationMetadata, get11(driver2.iterationMeta)), driver2, (error, option3) => provideServiceEffect(orElse5(error, option3), CurrentIterationMetadata, get11(driver2.iterationMeta)), value), "onSuccess")
})));
var repeatOrElseEffectLoop = /* @__PURE__ */ __name2((self, driver2, orElse5, value) => matchEffect(driver2.next(value), {
  onFailure: /* @__PURE__ */ __name2(() => orDie(driver2.last), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2((b) => matchEffect(self, {
    onFailure: /* @__PURE__ */ __name2((error) => orElse5(error, some2(b)), "onFailure"),
    onSuccess: /* @__PURE__ */ __name2((value2) => repeatOrElseEffectLoop(self, driver2, orElse5, value2), "onSuccess")
  }), "onSuccess")
...
var fromRetryOptions = /* @__PURE__ */ __name2((options) => {
...
var retryOrElse_EffectLoop = /* @__PURE__ */ __name2((self, driver2, orElse5) => {
  return catchAll(self, (e) => matchEffect(driver2.next(e), {
    onFailure: /* @__PURE__ */ __name2(() => pipe(driver2.last, orDie, flatMap7((out) => orElse5(e, out))), "onFailure"),
    onSuccess: /* @__PURE__ */ __name2(() => retryOrElse_EffectLoop(self, driver2, orElse5), "onSuccess")
  }));
...
var scheduleFrom_EffectLoop = /* @__PURE__ */ __name2((self, initial, driver2) => matchEffect(driver2.next(initial), {
  onFailure: /* @__PURE__ */ __name2(() => orDie(driver2.last), "onFailure"),
  onSuccess: /* @__PURE__ */ __name2(() => flatMap7(self, (a) => scheduleFrom_EffectLoop(self, a, driver2)), "onSuccess")
...
var withExecutionPlan = /* @__PURE__ */ dual(2, (effect2, plan) => suspend(() => {
  ...
  return flatMap7(whileLoop({
    while: /* @__PURE__ */ __name2(() => i < plan.steps.length && (result === void 0 || isLeft2(result)), "while"),
    body: /* @__PURE__ */ __name2(() => {
    ...
    step: /* @__PURE__ */ __name2((either4) => {
      result = either4;
      i++;
    }, "step")
  }), () => result);
}));
var scheduleFromStep = /* @__PURE__ */ __name2((step4, first2) => {
  if (!first2) {
...
var fromRequest = /* @__PURE__ */ __name2((request2, dataSource) => flatMap7(isEffect(dataSource) ? dataSource : succeed(dataSource), (ds) => fiberIdWith((id) => {
...
var cacheRequest = /* @__PURE__ */ __name2((request2, result) => {
  return fiberRefGetWith(currentCacheEnabled, (cacheEnabled) => {
    if (cacheEnabled) {
...
var log2 = log;
var logWithLevel2 = /* @__PURE__ */ __name2((level, ...message) => logWithLevel(level)(...message), "logWithLevel");
...
var transposeOption = /* @__PURE__ */ __name2((self) => {
...
var makeTagProxy = /* @__PURE__ */ __name2((TagClass) => {
  ...
  return new Proxy(TagClass, {
    get(target, prop, receiver) {
      ...
      const fn2 = /* @__PURE__ */ __name2((...args2) => andThen3(target, (s) => {
...
var Service = /* @__PURE__ */ __name2(function() {
  return function() {
    ...
    const TagClass = /* @__PURE__ */ __name2(function(service3) {
...
var fn = /* @__PURE__ */ __name2(function(nameOrBody, ...pipeables) {
  const limit = Error.stackTraceLimit;
  Error.stackTraceLimit = 2;
...
__name2(defineLength, "defineLength");
function fnApply(options) {
  ...
  let cache = false;
  const captureStackTrace = /* @__PURE__ */ __name2(() => {
    if (cache !== false) {
      return cache;
    }
...
__name2(fnApply, "fnApply");
var fnUntraced2 = fnUntraced;
var ensureSuccessType = /* @__PURE__ */ __name2(() => (effect2) => effect2, "ensureSuccessType");
var ensureErrorType = /* @__PURE__ */ __name2(() => (effect2) => effect2, "ensureErrorType");
var ensureRequirementsType = /* @__PURE__ */ __name2(() => (effect2) => effect2, "ensureRequirementsType");
var Layer_exports = {};
__export(Layer_exports, {
  CurrentMemoMap: /* @__PURE__ */ __name(() => CurrentMemoMap2, "CurrentMemoMap"),
  LayerTypeId: /* @__PURE__ */ __name(() => LayerTypeId2, "LayerTypeId"),
  MemoMapTypeId: /* @__PURE__ */ __name(() => MemoMapTypeId2, "MemoMapTypeId"),
  annotateLogs: /* @__PURE__ */ __name(() => annotateLogs4, "annotateLogs"),
  annotateSpans: /* @__PURE__ */ __name(() => annotateSpans4, "annotateSpans"),
  build: /* @__PURE__ */ __name(() => build2, "build"),
  buildWithMemoMap: /* @__PURE__ */ __name(() => buildWithMemoMap2, "buildWithMemoMap"),
  buildWithScope: /* @__PURE__ */ __name(() => buildWithScope2, "buildWithScope"),
  catchAll: /* @__PURE__ */ __name(() => catchAll4, "catchAll"),
  catchAllCause: /* @__PURE__ */ __name(() => catchAllCause4, "catchAllCause"),
  context: /* @__PURE__ */ __name(() => context4, "context"),
  die: /* @__PURE__ */ __name(() => die7, "die"),
  dieSync: /* @__PURE__ */ __name(() => dieSync4, "dieSync"),
  discard: /* @__PURE__ */ __name(() => discard2, "discard"),
  effect: /* @__PURE__ */ __name(() => effect, "effect"),
  effectContext: /* @__PURE__ */ __name(() => effectContext, "effectContext"),
  effectDiscard: /* @__PURE__ */ __name(() => effectDiscard, "effectDiscard"),
  empty: /* @__PURE__ */ __name(() => empty31, "empty"),
  extendScope: /* @__PURE__ */ __name(() => extendScope2, "extendScope"),
  fail: /* @__PURE__ */ __name(() => fail8, "fail"),
  failCause: /* @__PURE__ */ __name(() => failCause7, "failCause"),
  failCauseSync: /* @__PURE__ */ __name(() => failCauseSync4, "failCauseSync"),
  failSync: /* @__PURE__ */ __name(() => failSync4, "failSync"),
  fiberRefLocallyScopedWith: /* @__PURE__ */ __name(() => fiberRefLocallyScopedWith3, "fiberRefLocallyScopedWith"),
  flatMap: /* @__PURE__ */ __name(() => flatMap13, "flatMap"),
  flatten: /* @__PURE__ */ __name(() => flatten9, "flatten"),
  fresh: /* @__PURE__ */ __name(() => fresh2, "fresh"),
  function: /* @__PURE__ */ __name(() => fromFunction2, "function"),
  isFresh: /* @__PURE__ */ __name(() => isFresh2, "isFresh"),
  isLayer: /* @__PURE__ */ __name(() => isLayer2, "isLayer"),
  launch: /* @__PURE__ */ __name(() => launch2, "launch"),
  locally: /* @__PURE__ */ __name(() => locally2, "locally"),
  locallyEffect: /* @__PURE__ */ __name(() => locallyEffect2, "locallyEffect"),
  locallyScoped: /* @__PURE__ */ __name(() => locallyScoped2, "locallyScoped"),
  locallyWith: /* @__PURE__ */ __name(() => locallyWith2, "locallyWith"),
  makeMemoMap: /* @__PURE__ */ __name(() => makeMemoMap2, "makeMemoMap"),
  map: /* @__PURE__ */ __name(() => map15, "map"),
  mapError: /* @__PURE__ */ __name(() => mapError5, "mapError"),
  match: /* @__PURE__ */ __name(() => match14, "match"),
  matchCause: /* @__PURE__ */ __name(() => matchCause5, "matchCause"),
  memoize: /* @__PURE__ */ __name(() => memoize3, "memoize"),
  merge: /* @__PURE__ */ __name(() => merge8, "merge"),
  mergeAll: /* @__PURE__ */ __name(() => mergeAll6, "mergeAll"),
  mock: /* @__PURE__ */ __name(() => mock2, "mock"),
  orDie: /* @__PURE__ */ __name(() => orDie4, "orDie"),
  orElse: /* @__PURE__ */ __name(() => orElse4, "orElse"),
  parentSpan: /* @__PURE__ */ __name(() => parentSpan2, "parentSpan"),
  passthrough: /* @__PURE__ */ __name(() => passthrough3, "passthrough"),
  project: /* @__PURE__ */ __name(() => project2, "project"),
  provide: /* @__PURE__ */ __name(() => provide3, "provide"),
  provideMerge: /* @__PURE__ */ __name(() => provideMerge2, "provideMerge"),
  retry: /* @__PURE__ */ __name(() => retry3, "retry"),
  scope: /* @__PURE__ */ __name(() => scope4, "scope"),
  scoped: /* @__PURE__ */ __name(() => scoped3, "scoped"),
  scopedContext: /* @__PURE__ */ __name(() => scopedContext2, "scopedContext"),
  scopedDiscard: /* @__PURE__ */ __name(() => scopedDiscard2, "scopedDiscard"),
  service: /* @__PURE__ */ __name(() => service2, "service"),
  setClock: /* @__PURE__ */ __name(() => setClock, "setClock"),
  setConfigProvider: /* @__PURE__ */ __name(() => setConfigProvider2, "setConfigProvider"),
  setRandom: /* @__PURE__ */ __name(() => setRandom, "setRandom"),
  setRequestBatching: /* @__PURE__ */ __name(() => setRequestBatching, "setRequestBatching"),
  setRequestCache: /* @__PURE__ */ __name(() => setRequestCache, "setRequestCache"),
  setRequestCaching: /* @__PURE__ */ __name(() => setRequestCaching, "setRequestCaching"),
  setScheduler: /* @__PURE__ */ __name(() => setScheduler, "setScheduler"),
  setTracer: /* @__PURE__ */ __name(() => setTracer2, "setTracer"),
  setTracerEnabled: /* @__PURE__ */ __name(() => setTracerEnabled, "setTracerEnabled"),
  setTracerTiming: /* @__PURE__ */ __name(() => setTracerTiming, "setTracerTiming"),
  setUnhandledErrorLogLevel: /* @__PURE__ */ __name(() => setUnhandledErrorLogLevel, "setUnhandledErrorLogLevel"),
  setVersionMismatchErrorLogLevel: /* @__PURE__ */ __name(() => setVersionMismatchErrorLogLevel, "setVersionMismatchErrorLogLevel"),
  span: /* @__PURE__ */ __name(() => span3, "span"),
  succeed: /* @__PURE__ */ __name(() => succeed7, "succeed"),
  succeedContext: /* @__PURE__ */ __name(() => succeedContext2, "succeedContext"),
  suspend: /* @__PURE__ */ __name(() => suspend5, "suspend"),
  sync: /* @__PURE__ */ __name(() => sync5, "sync"),
  syncContext: /* @__PURE__ */ __name(() => syncContext2, "syncContext"),
  tap: /* @__PURE__ */ __name(() => tap4, "tap"),
  tapError: /* @__PURE__ */ __name(() => tapError4, "tapError"),
  tapErrorCause: /* @__PURE__ */ __name(() => tapErrorCause4, "tapErrorCause"),
  toRuntime: /* @__PURE__ */ __name(() => toRuntime2, "toRuntime"),
  toRuntimeWithMemoMap: /* @__PURE__ */ __name(() => toRuntimeWithMemoMap2, "toRuntimeWithMemoMap"),
  unwrapEffect: /* @__PURE__ */ __name(() => unwrapEffect2, "unwrapEffect"),
  unwrapScoped: /* @__PURE__ */ __name(() => unwrapScoped2, "unwrapScoped"),
  updateService: /* @__PURE__ */ __name(() => updateService3, "updateService"),
  withParentSpan: /* @__PURE__ */ __name(() => withParentSpan4, "withParentSpan"),
  withSpan: /* @__PURE__ */ __name(() => withSpan4, "withSpan"),
  zipWith: /* @__PURE__ */ __name(() => zipWith6, "zipWith")
});
var setConfigProvider = /* @__PURE__ */ __name2((configProvider) => scopedDiscard(withConfigProviderScoped(configProvider)), "setConfigProvider");
var parentSpan = /* @__PURE__ */ __name2((span4) => succeedContext(make5(spanTag, span4)), "parentSpan");
var span2 = /* @__PURE__ */ __name2((name, options) => {
  options = addSpanStackTrace(options);
...
var setTracer = /* @__PURE__ */ __name2((tracer3) => scopedDiscard(withTracerScoped(tracer3)), "setTracer");
...
var setClock = /* @__PURE__ */ __name2((clock3) => scopedDiscard2(fiberRefLocallyScopedWith(currentServices, add2(clockTag, clock3))), "setClock");
var setConfigProvider2 = setConfigProvider;
var parentSpan2 = parentSpan;
var setRandom = /* @__PURE__ */ __name2((random4) => scopedDiscard2(fiberRefLocallyScopedWith(currentServices, add2(randomTag, random4))), "setRandom");
var setRequestBatching = /* @__PURE__ */ __name2((requestBatching) => scopedDiscard2(fiberRefLocallyScoped(currentRequestBatching, requestBatching)), "setRequestBatching");
var setRequestCaching = /* @__PURE__ */ __name2((requestCaching) => scopedDiscard2(fiberRefLocallyScoped(currentCacheEnabled, requestCaching)), "setRequestCaching");
var setRequestCache = /* @__PURE__ */ __name2((cache) => scopedDiscard2(isEffect(cache) ? flatMap7(cache, (x) => fiberRefLocallyScoped(currentCache, x)) : fiberRefLocallyScoped(currentCache, cache)), "setRequestCache");
var setScheduler = /* @__PURE__ */ __name2((scheduler) => scopedDiscard2(fiberRefLocallyScoped(currentScheduler, scheduler)), "setScheduler");
var span3 = span2;
var setTracer2 = setTracer;
var setTracerEnabled = /* @__PURE__ */ __name2((enabled2) => scopedDiscard2(fiberRefLocallyScoped(currentTracerEnabled, enabled2)), "setTracerEnabled");
var setTracerTiming = /* @__PURE__ */ __name2((enabled2) => scopedDiscard2(fiberRefLocallyScoped(currentTracerTimingEnabled, enabled2)), "setTracerTiming");
var setUnhandledErrorLogLevel = /* @__PURE__ */ __name2((level) => scopedDiscard2(fiberRefLocallyScoped(currentUnhandledErrorLogLevel, level)), "setUnhandledErrorLogLevel");
var setVersionMismatchErrorLogLevel = /* @__PURE__ */ __name2((level) => scopedDiscard2(fiberRefLocallyScoped(currentVersionMismatchErrorLogLevel, level)), "setVersionMismatchErrorLogLevel");
...
var DbError = class _DbError extends Data_exports.TaggedError("DbError") {
  static {
    __name(this, "_DbError");
  }
  static {
    __name2(this, "DbError");
  }
...
var makeD1Service = /* @__PURE__ */ __name2((db) => ({
  query: /* @__PURE__ */ __name2((sql, ...params) => Effect_exports.tryPromise({
    try: /* @__PURE__ */ __name2(async () => {
      const stmt = params.length > 0 ? db.prepare(sql).bind(...params) : db.prepare(sql);
      const result = await stmt.all();
      return result.results || [];
    }, "try"),
    catch: /* @__PURE__ */ __name2((error) => DbError.fromUnknown(error, "query"), "catch")
  }), "query"),
  queryOne: /* @__PURE__ */ __name2((sql, ...params) => Effect_exports.tryPromise({
    try: /* @__PURE__ */ __name2(async () => {
      const stmt = params.length > 0 ? db.prepare(sql).bind(...params) : db.prepare(sql);
      return await stmt.first();
    }, "try"),
    catch: /* @__PURE__ */ __name2((error) => DbError.fromUnknown(error, "queryOne"), "catch")
  }), "queryOne"),
  execute: /* @__PURE__ */ __name2((sql, ...params) => Effect_exports.tryPromise({
    try: /* @__PURE__ */ __name2(async () => {
      const stmt = params.length > 0 ? db.prepare(sql).bind(...params) : db.prepare(sql);
    ...
    catch: /* @__PURE__ */ __name2((error) => DbError.fromUnknown(error, "execute"), "catch")
  }), "execute"),
  batch: /* @__PURE__ */ __name2((statements) => Effect_exports.tryPromise({
    try: /* @__PURE__ */ __name2(async () => {
    ...
    catch: /* @__PURE__ */ __name2((error) => DbError.fromUnknown(error, "batch"), "catch")
  }), "batch")
}), "makeD1Service");
var D1Live = /* @__PURE__ */ __name2((db) => Layer_exports.succeed(D1, makeD1Service(db)), "D1Live");
var query = /* @__PURE__ */ __name2((sql, ...params) => Effect_exports.gen(function* () {
  const db = yield* D1;
  return yield* db.query(sql, ...params);
}), "query");
var queryOne = /* @__PURE__ */ __name2((sql, ...params) => Effect_exports.gen(function* () {
  const db = yield* D1;
  return yield* db.queryOne(sql, ...params);
}), "queryOne");
var execute = /* @__PURE__ */ __name2((sql, ...params) => Effect_exports.gen(function* () {
  const db = yield* D1;
  return yield* db.execute(sql, ...params);
}), "execute");
var errorToStatus = /* @__PURE__ */ __name2((error) => {
  switch (error._tag) {
...
var errorToBody = /* @__PURE__ */ __name2((error) => {
  switch (error._tag) {
    case "ValidationError":
...
var effectHandler = /* @__PURE__ */ __name2((handler) => {
  return async (c) => {
    const db = c.env.DB;
...
var authEffectHandler = /* @__PURE__ */ __name2((handler) => {
  return async (c) => {
    const db = c.env.DB;
    const d1Layer = D1Live(db);
    const effect2 = pipe(
...
var parseBody2 = /* @__PURE__ */ __name2((c) => Effect_exports.tryPromise({
  try: /* @__PURE__ */ __name2(() => c.req.json(), "try"),
  catch: /* @__PURE__ */ __name2(() => ValidationError.single("Invalid JSON body"), "catch")
}), "parseBody");
var hashPassword = /* @__PURE__ */ __name2((password) => Effect_exports.promise(async () => {
...
var checkAdminAuthorization = /* @__PURE__ */ __name2((authHeader, requestedAdmin, jwtSecret) => Effect_exports.gen(function* () {
  if (!requestedAdmin) {
  ...
  const decoded = yield* Effect_exports.tryPromise({
    try: /* @__PURE__ */ __name2(() => verify2(token, jwtSecret, "HS256"), "try"),
    catch: /* @__PURE__ */ __name2(() => AuthError.invalidToken("Invalid authorization for admin user creation"), "catch")
  });
...
var validateInput = /* @__PURE__ */ __name2((body, userType) => Effect_exports.gen(function* () {
...
var registerEffect = /* @__PURE__ */ __name2((body, authHeader, jwtSecret) => Effect_exports.gen(function* () {
...
var verifyPassword = /* @__PURE__ */ __name2((password, hashedPassword) => Effect_exports.promise(async () => {
  const encoder = new TextEncoder();
  const data = encoder.encode(password);
  const hashBuffer = await crypto.subtle.digest("SHA-256", data);
  const hashArray = Array.from(new Uint8Array(hashBuffer));
...
var loginEffect = /* @__PURE__ */ __name2((body, jwtSecret) => Effect_exports.gen(function* () {
  const { username, password } = body;
  if (!username || !password) {
    return yield* Effect_exports.fail(ValidationError.single("Username and password are required"));
  }
...
var hashPassword2 = /* @__PURE__ */ __name2((password) => Effect_exports.promise(async () => {
  const encoder = new TextEncoder();
  const data = encoder.encode(password);
  const hashBuffer = await crypto.subtle.digest("SHA-256", data);
  const hashArray = Array.from(new Uint8Array(hashBuffer));
...
__name2(buildRecurrenceFields, "buildRecurrenceFields");
    ...
    if (startDate && endDate) {
      ...
      for (const event of results) {
        if (event.is_recurring) {
          const instances = generateRecurringInstances(event, start3, end3);
...
calendar.delete("/:id", effectHandler(
  (c) => Effect_exports.gen(function* () {
    ...
    const deleteBody = yield* Effect_exports.tryPromise({
      try: /* @__PURE__ */ __name2(() => c.req.json(), "try"),
      catch: /* @__PURE__ */ __name2(() => ValidationError.single("Invalid body"), "catch")
    }).pipe(
...
__name2(getUserDeviceTokens, "getUserDeviceTokens");
...
__name2(filterMutedUsers, "filterMutedUsers");
...
__name2(pemToArrayBuffer, "pemToArrayBuffer");
...
__name2(sendV1ToToken, "sendV1ToToken");
...
__name2(sendPushToUsers, "sendPushToUsers");
...
__name2(sendChannelMessagePush, "sendChannelMessagePush");
var tasks = new Hono2();
...
var hashPassword3 = /* @__PURE__ */ __name2((password) => Effect_exports.promise(async () => {
  const encoder = new TextEncoder();
  const data = encoder.encode(password);
  const hashBuffer = await crypto.subtle.digest("SHA-256", data);
  const hashArray = Array.from(new Uint8Array(hashBuffer));
...
var verifyPassword2 = /* @__PURE__ */ __name2((password, hashedPassword) => Effect_exports.promise(async () => {
  const encoder = new TextEncoder();
  const data = encoder.encode(password);
  const hashBuffer = await crypto.subtle.digest("SHA-256", data);
  const hashArray = Array.from(new Uint8Array(hashBuffer));
...
var fetchTba = /* @__PURE__ */ __name2(async (endpoint, authKey) => {
...
sync6.post("/tba", authEffectHandler(
  (c) => Effect_exports.gen(function* () {
    ...
    const event = yield* Effect_exports.promise(
      async () => fetchTba(
        `/event/${eventCode}`,
        authKey
      )
...
__name2(getMutedSettings, "getMutedSettings");
...
__name2(getPushConfig, "getPushConfig");
...
__name2(sendTestPush, "sendTestPush");
var chat = new Hono2();
...
__name2(humanCompLevel, "humanCompLevel");
...
__name2(classifyMargin, "classifyMargin");
...
function buildStats(match16) {
  ...
  const factorHints = [];
  const findField = /* @__PURE__ */ __name2((names) => factors.find((f) => names.includes(f.name)), "findField");
  ...
  const favorsWinner = /* @__PURE__ */ __name2((f) => {
...
var fetchMatchFromTBA = /* @__PURE__ */ __name2((matchKey, apiKey) => Effect_exports.tryPromise({
  try: /* @__PURE__ */ __name2(async () => {
  ...
  catch: /* @__PURE__ */ __name2((err) => new Error(String(err)), "catch")
}), "fetchMatchFromTBA");
var callOpenRouter = /* @__PURE__ */ __name2((apiKey, model, prompt, siteUrl, appName) => Effect_exports.promise(async () => {
  try {
...
var callAzureOpenAI = /* @__PURE__ */ __name2((endpoint, deployment, apiKey, prompt) => Effect_exports.promise(async () => {
  try {
...
var callOpenAI = /* @__PURE__ */ __name2((baseUrl, model, apiKey, prompt) => Effect_exports.promise(async () => {
  try {
...
var callGroq = /* @__PURE__ */ __name2((model, apiKey, prompt) => Effect_exports.promise(async () => {
  try {
...
__name(match15, "match15");
__name2(match15, "match");
...
var drainBody = /* @__PURE__ */ __name2(async (request2, env, _ctx, middlewareCtx) => {
  try {
...
var jsonError = /* @__PURE__ */ __name2(async (request2, env, _ctx, middlewareCtx) => {
  try {
    return await middlewareCtx.next(request2, env);
  } catch (e) {
...
function wrapExportedHandler(worker) {
  ...
  const fetchDispatcher = /* @__PURE__ */ __name2(function(request2, env, ctx) {
...
function wrapWorkerEntrypoint(klass) {
  ...
  return class extends klass {
    #fetchDispatcher = /* @__PURE__ */ __name2((request2, env, ctx) => {
      this.env = env;
      this.ctx = ctx;
...
var drainBody2 = /* @__PURE__ */ __name(async (request2, env, _ctx, middlewareCtx) => {
  try {
    return await middlewareCtx.next(request2, env);
  } finally {
    try {
...
var jsonError2 = /* @__PURE__ */ __name(async (request2, env, _ctx, middlewareCtx) => {
  try {
    return await middlewareCtx.next(request2, env);
  } catch (e) {
...
// .wrangler/tmp/bundle-AShg1p/middleware-insertion-facade.js
...
function __facade_register__2(...args2) {
  __facade_middleware__2.push(...args2.flat());
}
__name(__facade_register__2, "__facade_register__");
function __facade_invokeChain__2(request2, env, ctx, dispatch, middlewareChain) {
  const [head5, ...tail] = middlewareChain;
  const middlewareCtx = {
    dispatch,
    next(newRequest, newEnv) {
...
function __facade_invoke__2(request2, env, ctx, dispatch, finalMiddleware) {
  return __facade_invokeChain__2(request2, env, ctx, dispatch, [
...
// .wrangler/tmp/bundle-AShg1p/middleware-loader.entry.ts
...
function wrapExportedHandler2(worker) {
  ...
  return {
    ...
    fetch(request2, env, ctx) {
      ...
      return __facade_invoke__2(request2, env, ctx, dispatcher, fetchDispatcher);
    }
  };
}
...
//# sourceMappingURL=functionsWorker-0.25445633957440894.js.map
