...
// .wrangler/tmp/bundle-Uc5oIw/checked-fetch.js
...
// .wrangler/tmp/pages-ha5QhI/functionsWorker-0.6118294027059741.mjs
...
calendar.delete("/:id", async (c) => {
  try {
    ...
    const { success } = await c.env.DB.prepare("DELETE FROM calendar_events WHERE id = ?").bind(targetId).run();
    if (success) {
...
// .wrangler/tmp/bundle-Uc5oIw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Uc5oIw/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6118294027059741.js.map
